...
@CIRCE
      ...
      Usage: seal <paper> with <sealing device> and <wax>
      Usage: seal break <paper>
      This command will allow you to seal a letter or other paper 
      to prevent unwelcome eyes from reading it.  Once a paper is 
      sealed, the seal must be broken before it can be read.
