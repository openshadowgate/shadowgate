...
"/d/antioch/ruins/portal/", "/d/islands/dallyh/marsh/rooms/",\
...
#define FOURTYFIVE ({"/d/dagger/drow/rooms/", "/d/attaya/beach*", "/d/attaya/jungle/jun*", "/d/dagger/marsh/swamp/rooms/", "/d/attaya/cliff*", "/d/attaya/base/base*", "/d/attaya/base/wall*", "/d/dagger/derro/rooms/d*" })
