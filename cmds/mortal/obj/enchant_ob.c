...
#define restricted_skills ({ "craft, armorsmith", "craft, jeweller", "craft, leatherworker", "craft, weaponsmith", "craft, woodworker", "craft, tailor", "craft, leatherwork" })
...
varargs int calculate_cost(object tp, object item, string bonus, int amt, string special)
{
    ...
    return to_int(pow(total,2.1)); // will probably have to do some adjusting here
}
