...
void help() {
    write("Syntax: remember here|<object name> as <name>\n\n" +
          "\"here\" means the location you are in.  You can remember an "+
          "object or a location (here) as a name, whatever name you "+
          "want.  You can list which locations or objects you remember "+
          "by typing <recall locations> or <recall>, respectively."+
          "\nSee Also:  unremember, recall");
}
