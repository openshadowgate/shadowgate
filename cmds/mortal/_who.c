    ...
    if (max)
        for (i=0; i<max; i++)
        {
            ...
            else
            {
                ...
                if (ctime(time())[4..9]=="Dec 25") rabbit="%^BOLD%^%^GREEN%^elf";
                if (ctime(time())[4..9]=="Jan  1") rabbit="%^ORANGE%^rat"; //2020 edition
                if (ctime(time())[4..9]=="Jan  6") rabbit="%^BOLD%^%^GREEN%^elf";
                if (ctime(time())[4..9]=="Jan  7") rabbit="%^BOLD%^%^GREEN%^elf";
