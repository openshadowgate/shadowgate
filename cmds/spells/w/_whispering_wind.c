...
void create() {
    ...
    set_description("This spell will allow the caster to attempt to send a brief message on the winds from them to their "
"target.  The caster has no way of knowing if the target has heard their message.");
    set_verbal_comp();
    set_somatic_comp();
    set_arg_needed();
    set_helpful_spell(1);
