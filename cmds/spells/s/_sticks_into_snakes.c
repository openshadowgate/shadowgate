...
void create() {
    ...
    set_description("This spell allows the caster to create snakes from sticks in the surrounding area. There must be "
"sticks present for this spell to be successful.");
    set_verbal_comp();
    set_somatic_comp();
    set_helpful_spell(1);
}
...
//                  firstflag=1;
            ...
            if(objectp(mons[num])) mons[num]->remove();
        }
    }
    ::dest_effect();
