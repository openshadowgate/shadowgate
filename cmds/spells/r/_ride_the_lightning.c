...
void create() {
    ...
    set_description("This spell, when cast, transforms you into a mass of living lightning and propels you toward your foes.  A versatile arcanist can manipulate the base element of this spell.");
    set_verbal_comp();
    set_somatic_comp();
