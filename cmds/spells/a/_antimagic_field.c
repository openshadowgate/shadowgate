...
void create()
{
    ...
    set_description("An invisible barrier is placed in the area. Any spell or spell-like ability cast must be cast at a greater strength or it will fizzle out. Any ongoing spells will cause no damage if their power is lower than that of the caster. ");
}
...
void spell_effect()
{
    ...
    call_out("dest_effect",(clevel/12+1)*ROUND_LENGTH);
