...
spell_effect()
{
	...
	*oldattackers;
	...
	switch(chooser){
	    case(1):
		mon=new("/d/deku/monster/bugbear.c");
	    break;
	    case(2):
		mon=new("/d/deku/monster/cguard.c");
	    break;
	    case(3):
	mon=new("/d/tharis/caverns/mon/gscorpion.c");
	    break;
	    case(4):
		mon=new("/d/deku/monster/ogre.c");
	    break;
	    case(5):
		mon=new("/d/deku/monster/spider.c");
	    break;
	    case(6):
		mon=new("/d/deku/monster/gnome.c");
	    break;
	    case(7):
                mon=new("/d/tharis/monsters/eguard.c");
	    break;
	    case(8):
		mon=new("/d/tharis/monsters/snakes/gen_snake.c");
	    break;
	    case(9):
                mon=new("/d/antioch/mon/wolf.c");
	    break;
	    case(0):
		mon=new("/d/tharis/monsters/cguard.c");
	    break;
	}
	mons[num-1] = mon;
...
{
    int num, num2, timetowait, wherefound, num3;
...
int help()
{
    write(
@HELP
      Syntax: cast monster summoning iii

     This spell will summon up to four monsters total.  After
