...
spell_effect()
{
	...
	*oldattackers;
	...
	switch(chooser)
        {
	    case(1):
		mon=new("/d/shadow/mon/skeleton.c");
	    break;
	    case(2):
		mon=new("/d/shadow/mon/gnoll.c");
	    break;
	    case(3):
		mon=new("/d/shadow/mon/hobgoblincaptain.c");
	    break;
	    case(4):
		mon=new("/d/shadow/mon/orccaptain.c");
	    break;
	    case(5):
		mon=new("/d/shadow/mon/goblincaptain.c");
	    break;
	    case(6):
		mon=new("/d/shadow/mon/koboldcaptain.c");
	    break;
	    case(7):
                mon=new("/d/antioch/mon/eagle2.c");
	    break;
	    case(8):
                mon=new("/d/laerad/mon/spider.c");
	    break;
	    case(9):
                mon=new("/d/laerad/mon/wolf.c");
	    break;
	    case(0):
