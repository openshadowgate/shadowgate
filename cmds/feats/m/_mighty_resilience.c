...
void create() {
    ...
    feat_desc("The Stonelord's kinship with the earth grows, his or her body taking on more of its attributes. He will ignore 1d6 damage per level from thief backstabs.");
    permanent(1);
