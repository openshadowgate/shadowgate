...
void set_profile_stuff(string str, string what, object tp)
{
    ...
    if (!profile = (string)tp->query("relationship_profile")) {
        return;
    }

    restore_description_profile(tp);

    if (!mapp(profile_info[profile])) {
    ...
    case "description":
        ...
        if (!str) {
            map_delete(profile_info[profile], "description");
        }else {
            profile_info[profile]["description"] = str;
        }
        break;
    ...
    case "adjective":
        ...
        if (!str) {
            map_delete(profile_info[profile], "adjective");
        }else {
            profile_info[profile]["adjective"] = str;
        }
        break;
    ...
    case "speech string":
        ...
        if (!str) {
            map_delete(profile_info[profile], "speech string");
        }else {
            profile_info[profile]["speech string"] = str;
        }
    ...
    case "describe string":
        ...
        if (!str) {
            map_delete(profile_info[profile], "describe string");
        }else {
            profile_info[profile]["describe string"] = str;
        }
        break;
    ...
    case "message in":
        ...
        if (!str) {
            map_delete(profile_info[profile], "message in");
        }else {
            profile_info[profile]["message in"] = str;
        }
        break;
    ...
    case "message out":
        ...
        if (!str) {
            map_delete(profile_info[profile], "message out");
        }else {
            profile_info[profile]["message out"] = str;
        }
        break;
    }
...
int set_description(object tp, string profile)
{
    ...
    if (desc) {
        ...
        tp->set_description("You currently have no description set.  Please enter one as soon as possible.");
    }
...
int set_adjective(object tp, string profile)
{
    ...
    if (adj) {
        tp->setDescriptivePhrase(adj);
    }else {
        tp->setDescriptivePhrase("$R with no adjective set");
    }
    return 1;
}
...
int set_message_in(object tp, string profile)
{
    ...
    if (message_in) {
        tp->force_me("message in " + message_in);
    }else {
        tp->force_me("message in enters");
    }
    return 1;
}
...
int set_message_out(object tp, string profile)
{
    ...
    if (message_out) {
        tp->force_me("message out " + message_out);
    }else {
        tp->force_me("message out leaves");
    }
    return 1;
}
...
int initialize_profile(object tp)
{
    ...
    if (!profile) {
        return notify_fail("You don't seem to have a relationship profile set.");
    }
    profile_info[profile] = ([]);
    ...
    if (desc) {
        profile_info[profile]["description"] = desc;
    }
    if (speech_string) {
        profile_info[profile]["speech string"] = speech_string;
    }
    if (describe_string) {
        profile_info[profile]["describe string"] = describe_string;
    }
    if (adjective) {
        profile_info[profile]["adjective"] = adjective;
    }
    if (message_in) {
        profile_info[profile]["message in"] = message_in;
    }
    if (message_out) {
        profile_info[profile]["message out"] = message_out;
    }
...
{
    if (!mapp(profile_info)) {
        return 0;
    }
    if (!mapp(profile_info[str])) {
        return 0;
    }
    if (!sizeof(keys(profile_info[str]))) {
        return 0;
    }
    return 1;
}
...
int description_profile_exists(object tp, string str)
{
    ...
    if (!file_exists(DESC_DIR + folder + real_name + ".o")) {
        return 0;
    }
    return 1;
}
...
int restore_description_profile(object tp)
{
    ...
    true_name = (string)tp->query_true_name();
    folder = true_name[0..0] + "/";
    if (!description_profile_exists(tp, true_name)) {
        return 0;
    }
