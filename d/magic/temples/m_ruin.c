...
void create() {
     ...
     set_short("%^MAGENTA%^Ruined Gallery%^RESET%^");
     set_long(query_short()+"\n"
     "This might have once been an enchanting "+
     "looking hallway in the past but now it is"+
  ...
  set_smell("default","This place smells of decay.");
  set_listen("default","It is quiet except for some wind here and there.");
   set_items(([
...
"%^WHITE%^%^BOLD%^After the painting holds still for a while longer, it repaints itself, into the same swordsman kneeling before an altar with a large book on it.  A holy symbol of is around his neck now.%^RESET%^\n",
...
"%^WHITE%^%^BOLD%^Acolytes and other adventurers gather behind him, following his leadership.  His posture is good and he looks %^RESET%^%^RED%^proud %^WHITE%^%^BOLD%^to do what he does for his goddess.%^RESET%^\n",
...
"%^WHITE%^%^BOLD%^The canvas clears and the image of the dancer fades into view, swirling around the altar with a large book on it.  She dances on, and whisps of %^CYAN%^magic %^WHITE%^flit about her.%^RESET%^\n",
"%^WHITE%^%^BOLD%^The image reforms, showing a Talossian knight raining havoc about the countryside, destroying everything in sight.  Eventually he levels his lance at the temple and begins charging.%^RESET%^\n",
...
"%^WHITE%^%^BOLD%^The woman continues in the temple, dancing and standing up for the art to those in the city.%^RESET%^\n",
...
"%^WHITE%^%^BOLD%^It shows a close-up of her, as she walks out.  She looks distraught, as though she had committed a great sin against her goddess, and no longer sees herself fit to serve.%^RESET%^\n",
"%^WHITE%^%^BOLD%^The magic spent, the image settles and goes back to being a normal painting.%^RESET%^\n"});
 break;
 }
 case 4: //kirin & asalyr
 {painting = ({
"%^WHITE%^%^BOLD%^The painting begins with the two elves walking down a pathway, out of a gated human city towards the old temple.%^RESET%^\n",
"%^WHITE%^%^BOLD%^They make their way into the temple, hand and hand, approaching the altar with a large book upon it.%^RESET%^\n",
"%^WHITE%^%^BOLD%^A priest comes out and they recite vows together at the altar, dedicating themselves to the service of a goddess.  It is a very %^RESET%^%^RED%^romantic %^WHITE%^%^BOLD%^picture.%^RESET%^\n",
...
"%^WHITE%^%^BOLD%^The paint swirls away in a spiral and repaints the image of him with a %^RED%^red-haired %^WHITE%^female elf at night in a temple.%^RESET%^\n",
"%^WHITE%^%^BOLD%^She smiles and talks to him, showing him scrolls and giving him lessons.%^RESET%^\n",
"%^WHITE%^%^BOLD%^Again the painting reforms, pausing a little while to signify that time passes.  It shows the male elf staring in awe at the altar of a temple.  He looks surprised, as though he had just seen a ghost.%^RESET%^\n",
...
"%^WHITE%^%^BOLD%^The next painting shows the same %^BLACK%^black-haired %^WHITE%^elf with a seven starred cloak, looking quite regal and official in it.  He is standing in a temple looking like a great leader.%^RESET%^\n",
...
"%^WHITE%^%^BOLD%^Again the painting fades and reforms, showing the two going back to a temple, where a burnt book rests upon the altar.  The elf kneels down and dedicates himself to the cause of Mystra with the knight standing beside him.%^RESET%^\n",
...
"%^WHITE%^%^BOLD%^The pair frantically rush off down the road into the temple.%^RESET%^\n",  
...
"%^WHITE%^%^BOLD%^Together the group drags the unconscious pair though a portal, reappearing back in the temple.%^RESET%^\n",
