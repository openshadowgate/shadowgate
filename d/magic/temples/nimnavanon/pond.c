...
int pick_func(string str)
{
    ...
    default:
        ...
        if (berrycount < 1) {
            ...
            berrycount -= 1;
            new("/d/magic/temples/nimnavanon/salmonberries.c")->move(TP);
            if (berrycount < 1) {
