...
void create(){
    ::create();
    set_id(({"wolverine","dire wolverine","natures ally"}));
    set_short("%^BOLD%^%^BLACK%^fer%^RED%^a%^BLACK%^l dire wolverine%^RESET%^");
...
", oily brown fur darkens at the extremities nearly to black.  This particular specimen seems even more vicious than most"
