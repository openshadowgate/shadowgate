...
#define GEMS ({"%^BOLD%^%^WHITE%^sn%^BLACK%^o%^WHITE%^wfl%^BLACK%^a%^WHITE%^k%^BLACK%^e%^WHITE%^ obsidian%^RESET%^","%^RED%^garnet%^RESET%^","%^BOLD%^%^WHITE%^ivory%^RESET%^"})
...
void create(){
   ...
   set_id(({"holy symbol","symbol","loviatar_holy_symbol",jewelry,gem+" "+jewelry}));
...
"%^BOLD%^%^RED%^     * %^RESET%^ %   %    %    %\n"+
"     %   %  %    %   %  %%%%%%%\n"+
"%^BOLD%^%^RED%^  *  %^RESET%^%    %  % %^ORANGE%^  X%^RESET%^  % /%       %\n"+
"  %   %    % %^ORANGE%^ XX XX X%^RESET%^%/         %\n"+
"  %    %%   /%^ORANGE%^XX XXX((%^RESET%^/ %%%%%%   %^BOLD%^%^RED%^ *%^RESET%^\n"+
"  %       %%^ORANGE%^(XXXXXXXXX%^RESET%^%/      \%\n"+
"%^BOLD%^%^RED%^* %^RESET%^ %       /%^ORANGE%^(XXXXXXX( %^RESET%^         %\n"+
" \  %%%%%%/  %%/ /%^ORANGE%^X%^RESET%^/   %^BOLD%^%^RED%^        *%^RESET%^\n"+
"  %         %/   ^%^BOLD%^%^BLACK%^&&%^RESET%^\n"+
"   \%%%%%%%%    %^BOLD%^%^BLACK%^  &&\n"+
"                  &&\n"+
"                  &&\n"+
