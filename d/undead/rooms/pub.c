...
int read(string str) {
    ...
    message("Ninfo", "\tA glass of juice\t\t"+(int)ob->get_price("juice")+" gold\n", TP);
    message("Ninfo", "\tA glass of ale\t\t\t"+(int)ob->get_price("ale")+" gold\n", TP);
    message("Ninfo", "\tA mug of coffee\t\t\t"+(int)ob->get_price("coffee")+" gold\n", TP);
    message("Ninfo", "\tA Deathblow\t\t\t"+(int)ob->get_price("deathblow")+" gold\n", TP);
    message("Ninfo", "\tBowl of nuts\t\t\t"+(int)ob->get_price("nuts")+" gold\n", TP);
    message("Ninfo", "\tBowl of pretzels\t\t"+(int)ob->get_price("pretzels")+" gold\n", TP);
    message("Ninfo", "\tBaked potato\t\t\t"+(int)ob->get_price("potato")+" gold\n", TP);
    message("Ninfo", "\tPickled eggs\t\t\t"+(int)ob->get_price("eggs")+" gold\n", TP);
    message("Ninfo","%^RESET%^%^CYAN%^----------------------------------------------------------------\n%^RESET%^", TP);
