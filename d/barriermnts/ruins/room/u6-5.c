...
void create() {
    ...
    ::create();
    set_repop(30);
    set_long("%^ORANGE%^This hallway extends to the west and south, bordered by solid stone walls on "
...
"steps upon the tiled floor.  Within the walls to the north and east are regularly-spaced windows of "
