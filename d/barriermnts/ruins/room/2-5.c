...
"dirt and hard to see through.  It seems very %^BLUE%^lifeless%^ORANGE%^ here, though a heavy feeling "
"rests upon your shoulders, making you feel a little uneasy.%^RESET%^\n");
    set_exits(([
      "south" : ROOMS+"3-5",
      "west" : ROOMS+"2-4"
    ]));
