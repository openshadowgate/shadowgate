...
void create() {
    ...
    ::create();
    set_repop(30);
    set_long("%^ORANGE%^This hallway extends to the west and north, bordered by solid stone walls on "
...
"steps upon the tiled floor.  Within the walls to the south and east are regularly-spaced windows of "
