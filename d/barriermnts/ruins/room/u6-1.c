...
void create() {
    set_monsters(({MON+"cultspirit"}),({2}));
    ::create();
    set_repop(30);
    set_long("%^ORANGE%^This hallway extends to the east and south, bordered by solid stone walls on "
...
"steps upon the tiled floor.  Within the walls to the north and west are regularly-spaced windows of "
