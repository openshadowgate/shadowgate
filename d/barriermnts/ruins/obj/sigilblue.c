...
void create(){
        ::create();
        set_name("blue sigil");
        set_id(({"sigil","Sigil","Blue Sigil","blue sigil"}));
        set_short("%^BLUE%^%^BOLD%^glowing blue sigil%^RESET%^");
        set_long("%^BLACK%^%^BOLD%^This sigil is formed of stone, though strangely it seems to weigh "
"nearly nothing, and glows with its own inner %^BLUE%^blue %^BLACK%^light.  It is carved into an ornate "
