...
void create(){
   ::create();
   set_name("%^BOLD%^%^BLACK%^Cloak of the Great Wolf%^RESET%^");
   set_short("%^BOLD%^%^BLACK%^A dark fur cloak%^RESET%^");
...
" %^BOLD%^%^BLACK%^in this extremely large but comfortable looking cloak.  The"
...
" furs of many wolves were needed to create such a large piece of clothing.  Even"
" with a voadkyn wearing it, this cloak would easily reach the ground and provide"
