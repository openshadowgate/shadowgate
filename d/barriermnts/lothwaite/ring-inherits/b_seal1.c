...
void init(){
   ...
   write("%^GREEN%^Please choose the symbol you would like for your "+
      "ring from the list below.  Use ** to cancel your order.%^RESET%^\n");
...
CIRCE
   ...
   if(member_array(str,SYMBOLS) == -1){
      ...
      "You may choose any of the following.  Use ** to cancel your order.%^RESET%^\n\n");
      write("%^GREEN%^------------------------- %^YELLOW%^Symbols %^RESET%^%^GREEN%^-------------------------");
      write(
@CIRCE
   eagle       doe        rabbit      fox
...
CIRCE
   ...
   write("%^BOLD%^Please choose the weapon you would like for your "+
      "ring from the list below.  Use ** to cancel your order.\n");
...
void bgchoice(string str){
   ...
   if(member_array(str,BACKGROUNDS) == -1){
      ...
      write("%^BOLD%^Please choose a background from the following list.  Use "+
