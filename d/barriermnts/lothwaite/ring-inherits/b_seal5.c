...
CIRCE
   ...
   WF(MYWEAPON1(str));
   write("%^BOLD%^Please choose the second weapon you would like for your "+
...
CIRCE
   ...
   if(member_array(str,WEAPONS) == -1){
      write("%^BOLD%^%^RED%^That is not a valid weapon!\n");
      write("%^BOLD%^Please choose the second weapon you would like "+
      "to have featured on your "+
      "ring from the following list.  Use ** to cancel your order.%^RESET%^\n\n");
      write("%^GREEN%^------------------------- %^YELLOW%^Weapons %^RESET%^%^GREEN%^-------------------------");
      write(
@CIRCE
