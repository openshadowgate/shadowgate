...
void create(){
	...
	symbol1 = "a furtive %^BOLD%^%^BLACK%^spider%^RESET%^";
	symbol2 = "a tangle of %^BOLD%^silver spider webs%^RESET%^";
...
int query_seal(){ return "a finely detailed image of "+symbol1+" beside an intricate depiction of "+symbol2+"."; }
