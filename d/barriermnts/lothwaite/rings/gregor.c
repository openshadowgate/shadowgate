...
void create(){
	...
	symbol1 = "a pair of %^CYAN%^dice %^RESET%^with seven showing";
	initial1 = "a stylized %^CYAN%^G%^RESET%^";
	background = "lush, flat %^BOLD%^%^GREEN%^grasslands %^RESET%^with a single %^GREEN%^tree %^RESET%^in the distance";
