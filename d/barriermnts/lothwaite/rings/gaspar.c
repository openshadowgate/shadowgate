...
void create(){
	...
	initial1 = "a stylized %^CYAN%^E%^RESET%^";
	background = "a %^ORANGE%^ship %^RESET%^dancing upon the %^CYAN%^ocean%^RESET%^";
...
int query_seal(){ return "a backdrop of "+background+".  On top of the background is the finely detailed image of "+initial1+"."; }
