...
void create(){
	...
	symbol1 = "a wheeling %^RED%^hawk %^RESET%^gliding on the %^CYAN%^winds%^RESET%^";
	symbol2 = "a proud %^BOLD%^unicorn %^RESET%^with her %^BOLD%^mane %^RESET%^rippling in the %^CYAN%^breeze%^RESET%^";
