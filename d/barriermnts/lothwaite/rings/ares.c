...
void create(){
	...
	initial2 = "a stylized %^CYAN%^K%^RESET%^";
	background = "a serene, cascading %^CYAN%^waterfall%^RESET%^";
...
int query_initial2(){ return ""+initial2+"";}
int query_seal(){ return "a backdrop of "+background+".  On top of the background is the finely detailed image of "+initial1+" interlocked with the intricate depiction of "+initial2+"."; }
