...
void create(){
	...
	symbol1 = "a proud %^ORANGE%^griffon %^RESET%^with wings outspread";
	initial1 = "a stylized %^CYAN%^K%^RESET%^";
...
int query_seal(){ return "a finely detailed image of "+symbol1+", accented by "+initial1+"."; }
