...
void create_pants(object obj){
   ...
   COLOR = COLORS[i];
   obj->set_name("cotton breeches");
   obj->set_id(({"breeches","cotton breeches","pants","cotton pants"}));
   obj->set_short(""+COLOR+" cotton breeches%^RESET%^");
   obj->set_long("These fashionable cotton breeches are made of soft, "+
      "breathable fabric dyed "+COLOR+"%^RESET%^.  The material "+
      "falls to just below the ankle and may be worn either over "+
      "shoes or tucked into boots.  A discrete lacing front panel and "+
      "belt loops have been added to complete this versatile pair "+
      "of pants.");
