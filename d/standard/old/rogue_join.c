  ...
  ::create();
	...
	(["hideout" : "Rogues come here to plot wicked acts.",
	  ...
	  ({"rogue", "master", "grand master rogue"}) : "He initiates "
	    "new rogues."]) );
    set_exits( 
	      (["out" :	"/d/standard/outlands/hideout"]) );
}
...
int become(string str) {
    ...
    this_player()->setenv("start", "/d/standard/rogue_hall");
    return 1;
}
...
int go_down() {
    ...
    this_player()->move_player("/d/standard/rogue_hall", "through the light in the passage");
    return 1;
}
