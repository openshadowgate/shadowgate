...
void create() {
    ...
    set("short", "Praxis Commercial District");
    set("day long",
      "Centre Path leads south into the bustling Port of Praxis where it "
      "dead ends at Pier 1.  Business life hurries all about you to get "
      "things done before the end of the short Praxis day.  In the realty "
      "shop east, high mortals make transactions for real estate with "
    ...
    set("night long",
      ...
      "shy away from daylight.  The shadiest of characters arrive in Praxis "
      "at Pier 1 of the Port of Praxis south under cloak of night.  Fighters "
      "of all races, especially the nocturnal ones gather in the Hall of "
      "Fighters northwest.  Praxis centre is northeast.");
    set_exits( 
	      (["northwest" : "/d/standard/fighter_join",
		"northeast" : "/d/standard/s_centre3",
		"east" : "/d/standard/realty",
		"south" : "/d/standard/pier1"]) );
    set_items( 
