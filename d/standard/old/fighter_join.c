...
void create() {
    ...
    set_exits( 
	      (["southeast" : "/d/standard/s_centre4"]) );
...
int become(string str) {
    ...
    this_player()->setenv("start", "/d/standard/fighter_hall");
    return 1;
}
...
int go_up() {
    ...
    this_player()->move_player("/d/standard/fighter_hall", "through the light in the passage");
    return 1;
}
