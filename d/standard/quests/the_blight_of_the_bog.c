...
void create() {
  ...
  set("id", ({"blight", "quest_object", "the blight of the bog"}) );
  set("short", "%^GREEN%^%^BOLD%^The Blight of the Bog%^RESET%^");
  set("long", "Rumours have been floating about concerning a strange "
