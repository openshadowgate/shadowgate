...
set_long("%^ORANGE%^You leave the sea behind as you once more head in a northerly direction.  You trample through low bushes, back once again into stands of poplar.  To the east lies the undulating sand, this time movement is seen.  You see tendrils from low vines dip into the sand as if pulled by an unseen hand.");
...
"sand" : "The sand lays quietly, except for the occaisional slight movement, it does NOT look safe to walk on",
...
"vines" : "Thick green vines trail from the trees",
