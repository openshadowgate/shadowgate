...
set_long("%^ORANGE%^You are surrounded now by stands of poplar.  The sky is not visible nor the way clear.  To the east still lies the pool of sand, so wide it is almost impossible to make out the trees upon the other side.  You note once more, the many skeletons lying upon the sand as if polished by a gentle hand.  You notice a large bough, stripped of leaves and hardened by time, lying close to the sands edge.");
...
if(!present("bough"))
new("/realms/svaha/items/bough")->move(TO);
}
