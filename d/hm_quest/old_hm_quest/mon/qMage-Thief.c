...
void create() {
  ::create();
  set_name("Mage-Thief");
  set_id(({"mage-thief","Mage-Thief","quest mage-thief","hm_quest_mon"}));
  set_short("A powerful mage-thief");
  set_long("He is apparently a great mage-thief, very experienced and a worthy opponent.");
  set_class("mage");
  set_mlevel("mage",19);
...
void die(object ob){
  ...
  set_id(({"mage-thief","Mage-Thief","quest mage-thief"}));
  return;
}
