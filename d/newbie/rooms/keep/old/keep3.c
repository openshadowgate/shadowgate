...
void create()
{
   ...
   " the hallway continues and you can see there is a door just ahead. The"+
   " ceiling appears to have caved in the rest of the hallway not too much"+
   " further away. Hopefully the ceiling above you will last for a while longer."+
   " To the east the hallway continues as well, leading to the entrance of"+
   " the keep."
   );
