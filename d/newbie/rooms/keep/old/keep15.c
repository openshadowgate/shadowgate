...
void create()
{
   ...
   " hallway continues to the west and east, though just east of here is the"+
   " intersection with the main hallway of the keep."
   );
...
void init()
{
   ...
   switch(random(2)) {
      case 0:
         ...
         break;
      case 1:
         do_random_encounters(({MONS+"rat"}),40,3);
         break;
   }
}
