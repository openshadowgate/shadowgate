...
void create()
{
   ...
   " leaky ceiling. Obviously no one takes care of this place. To the east"+
   " the hallway continues for a short ways before the ceiling caves in and"+
   " blocks the passage, to the west is the entrance of the keep."
   );
