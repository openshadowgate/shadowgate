...
void create()
{
   ...
   " hallway continues to the west and east. Just ahead to the west the hallway"+
   " turns back to the south, it continues to the east to intersect with the"+
...
void init()
{
   ...
   switch(random(4)) {
      case 0:
         do_random_encounters(({MONS+"spider"}),50,1);
         break;
      case 1:
         do_random_encounters(({MONS+"rat"}),50,3);
         break;
      default:
	 break;
   }
