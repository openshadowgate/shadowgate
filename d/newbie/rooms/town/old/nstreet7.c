...
"%^CYAN%^traffic %^RESET%^at most hours of the day.  To the west lies an armory, its doors open to welcome customers.\n");
...
"styles give a unique appearance to the cosy town around you, where no two buildings are the same.  Nearby lies an "
"armory.%^RESET%^",
   ]));
   set_exits(([
      "north":MAINTOWN"nstreet6",
