...
A wooden palisade runs along this street. You see many people, both 
citizens and travelers, walking and riding to their destinations. 
NEWBIE
   );   
   ...
   set_exits(([
      "east":MAINTOWN"eroad5",
      "west":MAINTOWN"sstreet3",
   ]));
}
