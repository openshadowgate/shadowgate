...
"%^CYAN%^traffic %^RESET%^at most hours of the day.  To the north lies a scribe's shop, while south is a store full of "
"musical instruments.  Both have left their doors open to welcome customers.\n");
...
"scribe's shop and a store full of musical instruments.%^RESET%^",
   ]));
   set_exits(([
      "southeast":MAINTOWN"nstreet6",
      "west":MAINTOWN"nstreet4",
      "north":MAINTOWN"scribe",
      "south":MAINTOWN"instruments",
   ]));
}
