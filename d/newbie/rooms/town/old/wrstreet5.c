...
void create() {
   ...
   set_long(
@NEWBIE
You are at walking along Goldstone Way, along the eastern border
of the city. This road leads to and from a small residential area.
A wooden palisade runs along this street. Just to the north, the road
turns along the north edge of the city. This street is not as busy as 
...
NEWBIE
   ...
   set_exits(([
      "northeast":MAINTOWN"wrstreet6",
      "south":MAINTOWN"wrstreet2"
   ]));
}
