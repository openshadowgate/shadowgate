...
"You are standing on Sunset Way, which leads east back toward the Offestry town square, and turns south to Shale Street."
"  The cobblestone %^ORANGE%^streets %^RESET%^are smooth beneath your feet, granting passage to the light but steady "
"stream of %^CYAN%^traffic %^RESET%^that passes through the town on a daily basis.  The street is bordered on both sides "
"by a jumble of %^RED%^buildings%^RESET%^, the closest of which is the weapon shop to the north, with its doors open to "
"welcome customers.%^RESET%^\n");
...
"travellers.  Sunset Way curves east, back towards the square which serves as the heart of this town.  Further south, it leads towards the western town gate.%^RESET%^",
...
"weapon shop.%^RESET%^",
//		"tower":"The tower looks much sturdier than most buildings in the city and a slight hint of sulfur and parchment wafts from the archway."
   ]));
   set_exits(([
      "southwest":MAINTOWN"wstreet4",
