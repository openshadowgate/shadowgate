...
"You are standing on Sunrise Way, which leads east to the town gates, and west to a crossroads.  The cobblestone "
...
"jumble of %^RED%^buildings%^RESET%^, the closest of which is the bank, with its doors open to welcome customers.  A "
...
"trunks offer a view of the thick Offestry forest.%^RESET%^",
   ...
   set_exits(([
      "east":MAINTOWN"eroad3",
      "west":MAINTOWN"sstreet2",
      "north":MAINTOWN"bank"
   ]));
}
