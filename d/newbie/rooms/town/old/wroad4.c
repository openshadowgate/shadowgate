...
"You are standing on Sunrise Way, which leads west to the town gates, and east to a crossroads.  The cobblestone "
...
"jumble of %^RED%^buildings%^RESET%^, the closest of which is the general store, with its doors open to welcome "
"customers.  A simple wooden %^ORANGE%^palisade %^RESET%^runs along the southern side of the road, separating the town "
"from the wilderness beyond.%^RESET%^\n");
...
"trunks offer a view of the thick Offestry forest.%^RESET%^",
   ...
   set_exits(([
      "west":MAINTOWN"wroad3",
      "east":MAINTOWN"sstreet2",
      "north":MAINTOWN"general",
   ]));
}
