...
"%^CYAN%^traffic %^RESET%^at most hours of the day.  To the north lies a library, its doors open to welcome customers.\n");
...
"library.%^RESET%^",
   ...
   set_exits(([
      ...
      "southwest":MAINTOWN"nstreet2",
      "north":MAINTOWN"library"
   ]));
}
