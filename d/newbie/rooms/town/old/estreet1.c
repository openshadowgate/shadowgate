...
"north by a jumble of %^RED%^buildings%^RESET%^, the closest of which is the healer, with its doors open to welcome "
"customers.  Fenced %^GREEN%^paddocks %^RESET%^to the south offer room for a herd of horses to roam.%^RESET%^\n");
