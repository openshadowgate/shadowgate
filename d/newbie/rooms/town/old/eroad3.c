...
"jumble of %^RED%^buildings%^RESET%^, the closest of which are the bank to the west, and the stable to the east.  Both "
"have doors that open onto the streets just a few paces away.  A simple wooden %^ORANGE%^palisade %^RESET%^runs along "
"the southern side of the road, separating the town from the wilderness beyond.%^RESET%^\n");
...
"travellers.  To the east lies the eastern gate of town, while west is a crossroads.%^RESET%^",
