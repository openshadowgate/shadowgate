...
"%^CYAN%^traffic %^RESET%^at most hours of the day.  To the west lies a weapon shop, its doors open to welcome "
"customers.\n");
...
"styles give a unique appearance to the cosy town around you, where no two buildings are the same.  Nearby lies a weapon "
"shop.%^RESET%^",
   ]));
   set_exits(([
      "north":MAINTOWN"nstreet2",
      "south":MAINTOWN"wstreet2",
      "west":MAINTOWN"weapon",
   ]));
}
