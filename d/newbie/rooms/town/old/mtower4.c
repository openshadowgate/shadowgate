...
void create() {
   ...
   set_long(
@STYX
You are near the top of the imposing mage tower and definitely feel the magical energy of the weave in the air.  The beginning of the spiral staircase to the lower level is along the southern wall and glass globes hang along the walls to softly light the room.  The walls are covered with tapestries picturing mages studying, casting, and alchemists refining components.
STYX
    );
    ...
    set_items(([
        ...
        set_exits(([
        "east" : MAINTOWN"mtower5",
        "down" : MAINTOWN"mtower2"
        ]));
}
