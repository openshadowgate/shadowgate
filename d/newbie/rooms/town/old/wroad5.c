...
void create() {
   ...
   set_long(
@NEWBIE
You are walking along Shale Street, the southern border of the city.  A wooden palisade runs along this street. You see many people, both citizens and travelers, walking and riding to their destinations. 

A shop here has various types of clothing displayed in the windows.
NEWBIE
   );
