...
small tents scattered around the hills. To the east and south,
the hills appear uninhabited.
JAVAMAKER
   );
   ...
   set_exits(([
      "north":HILL"hill29",
      "northwest":HILL"hill23",
      "northeast":HILL"hill33",
      "west":HILL"hill24",
      "southwest":HILL"hill25",
   ]));
