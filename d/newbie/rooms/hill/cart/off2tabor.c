...
"tunnel starting to rush past your face.%^RESET%^\n");
      ...
      break;
      case(5):
      tell_object(targ,"\n%^ORANGE%^The wheels squeak as the cart slows even more, reaching the top of the incline and gliding toward a tunnel opening ahead of you.%^RESET%^\n");
      break;
      case(6):
      tell_object(targ,"\n%^BLUE%^The sky suddenly opens above you as you rattle to a stop outside the tunnel, just at the foot of the mountainside.  You find you finally have enough room to climb out of the cart.%^RESET%^\n");
