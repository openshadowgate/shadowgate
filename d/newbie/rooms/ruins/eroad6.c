...
the sides of the road where buildings used to be. To the southeast and
the northwest, you see paths leading through the rubble.
NEWBIE
    );
    ...
    set_exits(([
        "northwest":N_RUINS"eroad7",
        "north":N_RUINS"empty2",
        "southeast":N_RUINS"eroad5",
        "southwest":N_RUINS"armor",
    ]));
}
