...
the sides of the road where buildings used to be. To the southeast, you
see a path leading through the rubble.
NEWBIE
    );
    ...
    set_exits(([
        "northwest":N_RUINS"eroad6",
        "southeast":N_RUINS"empty1",
        "south":N_RUINS"eroad4",
    ]));
}
