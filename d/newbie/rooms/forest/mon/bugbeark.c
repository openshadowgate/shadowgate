...
create() {
	...
	new(CWEAP"club")->move(TO);
        ...
        add_money("silver",random(200)+150);
        add_money("copper",random(500));
	set_achats(5, ({"%^BOLD%^The bugbear lets out a blood-curdling scream and swings wildly at you.", "%^BOLD%^The bugbear snarls and beats on its shield savagely." }) ); 
}