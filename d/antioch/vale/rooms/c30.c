...
void create()
{
   ...
   set_long(
      ...
      " living here.  To the north, the entrance to one of the huts lays.\n"
   );
   set("night long",
      ...
      " are scattered about the %^CYAN%^clearing%^BLUE%^.  To the north,"+
      " the entrance to one of the huts lays.\n"
   );
   ...
   set_door("door",ROOMS+"hut5","north",0);
}
