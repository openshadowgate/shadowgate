...
void create()
{
   ...
   set_long(
      ...
      " living here.  The door to one of the huts is to the west.\n"
   );
   set("night long",
      ...
      " are scattered about the %^CYAN%^clearing%^BLUE%^.  The door to one of the huts is to the west.\n"
   );
   ...
   set_door("door",ROOMS+"hut6","west",0);
}
