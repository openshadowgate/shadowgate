...
void create()
{
   ...
   " %^BOLD%^%^CYAN%^Moonstone Vale%^RESET%^%^GREEN%^ into the"+
   " %^MAGENTA%^mountains%^GREEN%^ beyond, but it hasn't been used"+
   " by anyone in so many years that it doesn't get very far. The forest"+
   " has grown up to the west while the valley is open to the east and"+
   " south. You can see the trail end shortly to the north.\n"
   );
   ...
   set_items(([
   "grass" : "%^BOLD%^%^GREEN%^The grass is lush and green to the east and south.",
