#define SIZE 5
#define NUMDESCS 9
#define TERRAINPATH "/d/antioch/virtual/test/test.terrain"
#define DESCPATH "/d/antioch/virtual/test/test.desc"
#define EXITPATH "/d/antioch/virtual/test/test.exits"
