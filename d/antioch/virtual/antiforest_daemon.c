#define SIZE 40
#define NUMDESCS 6
#define TERRAINPATH "/d/antioch/virtual/antiforest/antiforest.terrain"
#define DESCPATH "/d/antioch/virtual/antiforest/antiforest.desc"
#define EXITPATH "/d/antioch/virtual/antiforest/antiforest.exits"
