#define SIZE 5
#define NUMDESCS 11
#define TERRAINPATH "/d/antioch/wild/forest/virtual/test/test.terrain"
#define DESCPATH "/d/antioch/wild/forest/virtual/test/test.desc"
#define EXITPATH "/d/antioch/wild/forest/virtual/test/test.exits"
