...
void create()
{
	...
	set_long(
	"This is a waterskin. It is handy for long journies to places where there"+
	" is not much water. You can %^BOLD%^refill waterskin%^RESET%^ either at"+
	" the shop you bought it from, or at a pond or such. You can %^BOLD%^check"+
