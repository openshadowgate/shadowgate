...
else if((string)TP->query_name() == "vethor" || (string)TP->query_name() == "spungold" ||
(string)TP->query_name() == "vezior" || (string)TP->query_name() == "zasaks" ||
(string)TP->query_name() == "destiny") {
