...
void create()
{
        ...
        set_id(({"guard","royal guard","guardian","guardian of Antioch","guardian of
antioch","Antioch guardian","antioch guardian","royal guardian","knight"}));
        set_long(
...
int summon_guards()
{
   ...
   new(MONS+"patrol_guard")->move(ETO);
   new(MONS+"patrol_guard")->move(ETO);
