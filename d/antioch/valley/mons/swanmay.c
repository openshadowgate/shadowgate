...
void receive_given_item(object obj){
   ...
   if((string)obj->query_name() == "%^MAGENTA%^orchid%^RESET%^"){
      ...
      force_me("emote throws the orchid on the floor and smashes it "
         "with her feet.");
      obj->remove();
      if(present("sunblade",TO)) force_me("give sunblade to "+TPQN);
      else if(present("crown",TO)) force_me("give crown to "+TPQN);
      else if(present("leggings",TO)) force_me("give leggings to "+TPQN);
      else if(present("tunic",TO)) force_me("give tunic to "+TPQN);
      else if(present("hide",TO)) force_me("give hide to "+TPQN);
      else if(present("sword",TO)) force_me("give sword to "+TPQN);
      else force_me("give "+query_money("electrum")+" electrum coins to "+TPQN);
