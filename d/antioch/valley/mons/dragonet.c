...
//			set_exp(1500);
			...
			set_property("magic resistance",16);
...
//			set_exp(2000);
			...
			set_property("magic restistance",24);
...
//			set_exp(2500);
			...
			set_property("magic resistance",32);
...
//			set_exp(3500);
			...
			set_property("magic resistance",48);
...
//			set_exp(4000);
			set_new_exp(15,"normal");
			set_property("magic resistance",56);
...
//			set_exp(4500);
			...
			set_property("magic resistance",64);
...
//			set_exp(5000);
			set_new_exp(20,"normal");
			set_property("magic resistance",72);
...
//			set_exp(6000);
			...
			set_property("magic resistance",88);
...
//			set_exp(6500);
			set_new_exp(21,"normal");
			set_property("magic resistance",96);
