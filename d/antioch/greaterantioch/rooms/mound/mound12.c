...
void create(){
   ...
   set_smell("default","%^BOLD%^%^BLACK%^You smell old sweat and the dirt around you.%^RESET%^");
...
int do_boss(int mystate) {
   ...
   switch(mystate) {
     ...
     break;
     case 1:
       tell_room(TO,"%^CYAN%^As your eyes grow accustomed to the %^BLACK%^darkness%^CYAN%^, you make out the form of a "
       "massive %^BOLD%^RED%^gnoll %^BOLD%^%^CYAN%^standing at the far end of the chamber.\n%^RESET%^");
     break;
     case 2:
       tell_room(TO,"%^CYAN%^The massive %^BOLD%^%^RED%^gnoll %^BOLD%^%^CYAN%^approaches with slowly as he slowly brings down his massive weapon from his shoulder to his hands.);
     break;
     case 3:
       tell_room(TO,"%^CYAN%^The %^BOLD%^%^RED%^gnoll %^BOLD%^%^CYAN%^stops suddenly, lifting a hand into the air. The gnolls around you"+
     ...
     break;
     case 4:
       tell_room(TO,"%^CYAN%^The %^BOLD%^%^RED%^gnolls %^BOLD%^%^CYAN%^laugh around you, filling the air.\n%^RESET%^");
     break;
     case 5:
       tell_room(TO,"%^CYAN%^The massive %^BOLD%^%^RED%^gnoll %^BOLD%^%^CYAN%^snarls angrily, then rushes forwards with a"+
