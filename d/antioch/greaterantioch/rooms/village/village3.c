...
void create()
{
    ...
    set_long("%^RESET%^%^ORANGE%^This small one story home has a thickly made %^BOLD%^%^YELLOW%^thatched roof"+
		" %^RESET%^%^ORANGE%^. The building is made out of thick wooden planks and has been painted a pale"+
		" %^BOLD%^%^CYAN%^blue%^RESET%^%^ORANGE%^. The windows are covered with wooden shades, protecting the"+
		" inside from the elements. The front door looks to be made of heavy oak and looks very strong."+
		" A small path is works its way from the road to the front door.");
    ...
    set_exits(([
        "door"  : HAMLET"house2",
		"west"	: HAMLET"village1",
		"north" : HAMLET"village5",
		"south" : HAMLET"village4",
		"east"  : HAMLET"village7",
	]));
