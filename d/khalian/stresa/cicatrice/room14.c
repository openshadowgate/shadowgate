...
set_listen("default", "%^CYAN%^Only the sound of the sand carressing sand
as time shifts the grains can be heard.");

set_exits(([
"north" : "/d/khalian/stresa/cicatrice/room7",
		"south" : "/d/khalian/stresa/cicatrice/room25",
		"west" : "/d/khalian/stresa/cicatrice/room13",
		"east" : "/d/khalian/stresa/cicatrice/room15",
		"northeast" : "/d/khalian/stresa/cicatrice/room8",
		"northwest" : "/d/khalian/stresa/cicatrice/room6",
		"southeast" : "/d/khalian/stresa/cicatrice/room26",
		"southwest" : "/d/khalian/stresa/cicatrice/room24"
]));
