...
void create (){
  ...
  set_property("magic",1);
   set_short("A fearsome bounty hunter from Shadow");
  set_property("bounty hunter",1);
  add_damage_bonus(7);
  set_long(
  "A muscular woman dressed in Shadow livery and armour. Everything she posesses is top quality and"
 +" immaculately well looked after. Her face is unreadable, her expression implacable but for a hint"
