...
void create(){
      ...
      ::create();
  	set_name("tsarvani archer");
  	set_id(({"archer","tsarvani","tsarvani archer","human",}));
  	set_short("%^CYAN%^Tsarvani archer");
  	set_long("%^ORANGE%^The archer is clothed in fine garments that" 
              +" mark him as a soldier of the Tsarven Empire's army. A"
