...
void create(){
	::create();
	set_name("^BOLD%^%^CYAN%^N%^BLACK%^o%^CYAN%^r%^BLUE%^e%^CYAN%^w%^BLACK%^'%^CYAN%^s Bo%^BLACK%^o%^CYAN%^t%^BLUE%^s%^CYAN%^ of W%^BLUE%^a%^CYAN%^n%^BLACK%^d%^CYAN%^e%^BLACK%^r%^CYAN%^l%^BLUE%^u%^BLACK%^s%^CYAN%^t%^RESET%^");
