...
void create(){
	...
	set_long(
@AVATAR
%^RESET%^%^CYAN%^The materials used to make this longsword are of the highest quality mithril.  Made by a master weaponsmith, the longsword is crafted to be a fierce weapon in the hands of its wielder during combat.  Stamped with the insignia of a set of balanced %^YELLOW%^scales %^RESET%^%^CYAN%^resting over a %^BOLD%^%^BLACK%^war hammer%^RESET%^%^CYAN%^, the holy symbol of Tyr, this weapon was clearly made for those who serve and protect Tyr's faith.
