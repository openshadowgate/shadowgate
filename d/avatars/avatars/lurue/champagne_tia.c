...
%^BOLD%^%^WHITE%^Congratulations on a wonderful plot!%^RESET%^
CIRCE
        );
        set_destroy();
        set_strength(25);
        set_my_mess("You raise your glass to toast Tiamat before "+
           "draining the heavenly champagne!");
        set_your_mess("raises the glass to toast Tiamat before drinking it down.");
        set_type("alcoholic");
        set_weight(1);
