...
"even as you look at them and giving you a seriously unsettled feeling.  Ahead, another widening of the tunnel suggests "
"a larger cavern just beyond.\n%^RESET%^");
   set_items( ([ 
...
"stone, suggesting that someone or something has travelled along here before.%^RESET%^",
   ...
   set_exits(([
     "cavern":"/d/avatars/nienne/dragonlair/lair",
     "south":"/d/avatars/nienne/dragonlair/tunnel2",
   ]));
}
