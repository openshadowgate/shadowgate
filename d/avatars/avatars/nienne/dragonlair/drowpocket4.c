...
"skulk menancingly across the sky, rumbling their displeasure at any mortal daring enough to pass below.  Just beyond the "
"next rocky outcropping, the cliff's summit is visible where a massive slab of earth the size of a planting field seems "
"to have been left, oddly out of place in this pit of the damned.%^RESET%^\n");
    ...
    set_exits(([
      "north" : "/d/avatars/nienne/dragonlair/drowpocket5",
      "southwest" : "/d/avatars/nienne/dragonlair/drowpocket3",
    ]));
}
