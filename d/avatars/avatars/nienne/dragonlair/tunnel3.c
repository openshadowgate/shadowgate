...
"and the underground fills the air.%^RESET%^");
   set_listen("default","%^GREEN%^The faint whistle of the %^RESET%^wi%^CYAN%^n%^RESET%^d %^GREEN%^distantly outside is "
"all that can be heard here.%^RESET%^");
...
"even as you look at them and giving you a seriously unsettled feeling.\n%^RESET%^");
   set_items( ([ 
...
"stone, suggesting that someone or something has travelled along here before.%^RESET%^",
   ...
   set_exits(([
     "north":"/d/avatars/nienne/dragonlair/tunnel2",
     "southwest":"/d/avatars/nienne/dragonlair/tunnel4",
   ]));
...
int GoThroughDoor() {
   ...
   tell_object(TP,"%^BOLD%^%^BLACK%^A shadow flickers past in the darkness ahead, and vanishes before you can make out "
"any details. A %^CYAN%^shi%^WHITE%^v%^CYAN%^er %^BLACK%^runs down your spine, as you get the sinking feeling that your "
"progress is being watched.%^RESET%^");
   return 1;
}
