...
void create(){
   ...
   set_long("%^BOLD%^%^BLACK%^This small oval shaped piece of cloth is the perfect size for covering a human eye"
   ". It is masterfully crafted from bla%^BLUE%^c%^BLACK%^k s%^YELLOW%^i%^BLACK%^lk with s%^RESET%^i%^BOLD%^%^BLACK%^lv"
   ...
   " a %^RESET%^%^RED%^e%^BOLD%^%^RED%^a%^RESET%^%^RED%^g%^BOLD%^%^RED%^l%^RESET%^%^RED%^e %^BOLD%^%^BLACK%^w%^YELLOW%^i"
   "%^BOLD%^%^BLACK%^ng.\n");
