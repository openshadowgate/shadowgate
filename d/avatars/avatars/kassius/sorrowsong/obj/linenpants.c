...
void create(){
    ...
    set_long("%^BOLD%^%^WHITE%^This is a fine set of pants made from white linen. They are crafted from good quality fabric and are %^BOLD%^%^CYAN%^soft%^WHITE%^ and" 
        ...
        " stripe travelling down the outer side of each pant leg. The stripe tapers at the end of the pants cuff, which is stitched together with" 
        " %^YELLOW%^golden%^WHITE%^ threads.\n");
    set_lore("These pants were supposedly crafted for a Fire Magi who was tired of travelling after his nemesis an Isthishian priestess in the open seas. She would always escape"
