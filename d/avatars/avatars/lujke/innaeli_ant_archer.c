...
#define TABOR "/d/shadow/room/city/"

#define YELL ({"It's Innaeli! Get her off the streets!",\
"There's the criminal! Make a fancy pin cushion out of her!",\
"Fall damn you, damn murderer!",\
"The light will not leave you comfort here! Crawl back under the rock you climbed out from!",\
"Begone from our city or die! Archers, shoot!",\
"Scum! Leave now or die!",\
"Antioch will tolerate your presence no longer! Begone!",\
" We will not stop until you fall!",\
"Leave now and we will spare your life!",\
"We don't like your kind around here!",\
"Light give us strength to protect our city!",\
...
void create(){
      ...
      ::create();
  	set_name("shadow archer");
  	set_id(({"archer","antioch archer","human",}));
  	set_short("%^BOLD%^%^BLUE%^Antioch archer%^RESET%^");
  	set_long("A lithe armored woman in the livery of %^BOLD%^%^YELLOW%^A%^BLUE%^ntioch"
  +" %^YELLOW%^c%^BLUE%^ity.%^RESET%^. Her expression shows"
  +"she is focussed intently upon her job, to the exclusion of all else.  She"
  +"is clad in light armor to allow her to move quickly at need, and carries a"
  +"carved bow in hand and a quiver of arrows over her back. ");
  	set_race("human");
	...
	set_property("swarm",1);
 	...
 	is_shooting = 0;
      ...
      arrows->set_property("monsterweapon",1);
      arrows->move(TO);
      sword = new("/d/common/obj/weapon/longsword");
