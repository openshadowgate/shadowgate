...
#define SHADOW "/d/shadow/room/city/room"

#define YELL ({"He's over here! Get him, lads!",\
"There's the bugger! Make a fancy pin cushion out of him!",\
...
"Shadow will stand for this no longer! It's time for you to leave!",\
...
void create(){
  	...
  	set_id(({"archer","shadow archer","human",}));
  	set_short("%^BOLD%^BLUE%^%^BLUE%^Shadow archer");
  	set_long("%^BOLD%^%^BLUE%^A smartly equipped archer in the livery"
              +" of the city of Shadow. A"
              +" strong and well-trained warrior, the %^RESET%^confidant"
              +" %^BOLD%^%^BLUE%^look on the man's face reveals his"
              ...
              +" %^ORANGE%^sword. A couple of beacon lanterns are"
