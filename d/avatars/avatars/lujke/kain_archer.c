...
#define YELL ({"Here's the beast! Get it, lads!",\
...
"Stay out of our city, wretched cur!",\
"We don't like your kind around here!",\
"Now you die, guard killing monster!",\
...
void create(){
  	...
  	set_short("%^BLUE%^Shadow archer");
  	set_long("%^ORANGE%^The archer is clothed in garments that" 
              +" mark him as a member of Shadow's army. A"
              +" strong and well-trained warrior, he wears an expression"
              +" of sheer determination. He is"
