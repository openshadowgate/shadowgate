...
void create(){
	::create();
	set_name("Spear of Sorrow");
	set_id(({ "spear" }));
	set_short("%^BOLD%^%^GREEN%^A 6' spear, with %^BLUE%^F%^YELLOW%^e%^BLUE%^a%^YELLOW%^t%^BLUE%^h%^YELLOW%^e%^BLUE%^r%^YELLOW%^s %^GREEN%^attached at the blade%^RESET%^");
	set_obvious_short("%^BOLD%^%^GREEN%^A 6' spear, with %^BLUE%^F%^YELLOW%^e%^BLUE%^a%^YELLOW%^t%^BLUE%^h%^YELLOW%^e%^BLUE%^r%^YELLOW%^s %^GREEN%^attached at the blade%^RESET%^");
	set_long(
@AVATAR
