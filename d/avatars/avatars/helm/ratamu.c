...
void create(){
	...
	set_long(
@AVATAR
%^ORANGE%^This is a suspicious-looking amulet made of twigs, fur and straps of leather. The fur apparently originates from a rodent-like creature and smells slightly like a wet carpet.%^RESET%^
