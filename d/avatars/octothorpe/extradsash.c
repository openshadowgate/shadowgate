...
void create(){
	...
	set_long(
@AVATAR
%^BOLD%^%^CYAN%^This sash appears to be moving as if a soft glowing wind were within. The everflowing folds and twists of the sash give a voluminous impression, and make it appear as if the material is almost a hundred feet long. The sash is fashioned out of an incredibly soft turquoise silk, yet it seems as though it has been fortified through magic to be as study as canvas.  It looks like it would be put an item inside of the sash.
