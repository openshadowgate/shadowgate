...
void create()
{
    ...
    ::create();
    set_name("drowshadow");
    set_id(({ "elf", "shadow", "shadowy silhouette", "drowshadow", "shadowy elven silhouette", "elven silhouette" }));
    set_short("%^BOLD%^%^BLACK%^shady elven silhouette%^RESET%^");
    ...
    set_mob_magic_resistance("normal");
