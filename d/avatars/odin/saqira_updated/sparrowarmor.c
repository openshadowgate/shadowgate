//updated 3/25/2020 by Odin.  Equivalent of player crafted.
//updated 4/4/2020 by Odin.  Function swap from night's cover which she got but wanted to keep this for aesthetic purposes
#include <std.h>
...
{
    ::create();
    set_name("%^RESET%^%^ORANGE%^Sp%^BLACK%^%^BOLD%^a%^RESET%^%^ORANGE%^rr%^RESET%^o%^ORANGE%^w's %^MAGENTA%^We%^BOLD%^a%^RESET%^%^MAGENTA%^vi%^BLACK%^%^BOLD%^n%^MAGENTA%^g D%^BOLD%^an%^MAGENTA%^c%^BLACK%^%^BOLD%^e hide armor%^RESET%^");
    set_id(({ "Sparrow Armor", "sparrow armor", "sparrowarmor", "armor", "hide armor", "hide armor" }));
    set_short("%^RESET%^%^ORANGE%^Sp%^BLACK%^%^BOLD%^a%^RESET%^%^ORANGE%^rr%^RESET%^o%^ORANGE%^w's %^MAGENTA%^We%^BOLD%^a%^RESET%^%^MAGENTA%^vi%^BLACK%^%^BOLD%^n%^MAGENTA%^g D%^BOLD%^an%^MAGENTA%^c%^BLACK%^%^BOLD%^e hide armor%^RESET%^");
    set_obvious_short("%^BLACK%^%^BOLD%^black hide armor%^RESET%^");
    set_long("%^BLACK%^%^BOLD%^Crafted from soft hide that has been treated and dyed to %^RESET%^black%^BLACK%^%^BOLD%^, this set of studded has been cut to a woman's "
    ...
    set_property("spell damage resistance", 22);
...
int wear_func()
{
    tell_room(environment(ETO), "%^BLACK%^%^BOLD%^" + ETOQCN + " slips on the black hide armor and ties the %^BLUE%^s%^MAGENTA%^i%^BLACK%^%^BOLD%^l%^RESET%^%^MAGENTA%^k %^BLUE%^r%^BLACK%^%^BOLD%^i%^RESET%^%^BLUE%^b%^MAGENTA%^b%^BLUE%^o%^BLACK%^%^BOLD%^n%^RESET%^%^MAGENTA%^s%^BLACK%^%^BOLD%^ behind her.%^RESET%^", ETO);
    tell_object(ETO, "%^BLACK%^%^BOLD%^You slip on the the black hide armor, the %^BLUE%^s%^MAGENTA%^i%^BLACK%^%^BOLD%^l%^RESET%^%^MAGENTA%^k %^BLUE%^r%^BLACK%^%^BOLD%^i%^RESET%^%^BLUE%^b%^MAGENTA%^b%^BLUE%^o%^BLACK%^%^BOLD%^n%^RESET%^%^MAGENTA%^s%^BLACK%^%^BOLD%^ swirling around you.%^RESET%^");
    return 1;
}

int remove_func()
{
    tell_room(environment(ETO), "%^BLACK%^%^BOLD%^" + ETOQCN + " slips off the black hide armor and unties the %^BLUE%^s%^MAGENTA%^i%^BLACK%^%^BOLD%^l%^RESET%^%^MAGENTA%^k %^BLUE%^r%^BLACK%^%^BOLD%^i%^RESET%^%^BLUE%^b%^MAGENTA%^b%^BLUE%^o%^BLACK%^%^BOLD%^n%^RESET%^%^MAGENTA%^s%^BLACK%^%^BOLD%^ from behind her.%^RESET%^", ETO);
    tell_object(ETO, "%^BLACK%^%^BOLD%^You slip off the the hide armor, the %^BLUE%^s%^MAGENTA%^i%^BLACK%^%^BOLD%^l%^RESET%^%^MAGENTA%^k %^BLUE%^r%^BLACK%^%^BOLD%^i%^RESET%^%^BLUE%^b%^MAGENTA%^b%^BLUE%^o%^BLACK%^%^BOLD%^n%^RESET%^%^MAGENTA%^s%^BLACK%^%^BOLD%^ swirling away from you.%^RESET%^");
    return 1;
}
