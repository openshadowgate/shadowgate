...
void create(){
	...
	set_obvious_short("a platinum shuriken");
	set_long(
@AVATAR
%^RESET%^%^CYAN%^The materials used to make this shuriken are of the highest quality platinum.  Made by a master weaponsmith, the shuriken is crafted to be a fierce weapon in the hands of its wielder during combat.  Stamped with the insignia of a curl of %^RED%^red mist %^CYAN%^rising within a ring of seven %^BOLD%^%^WHITE%^silver stars%^RESET%^%^CYAN%^, the holy symbol of Mystra, this weapon was clearly made for those who serve and protect Mystra's faith.
