...
void create(){
   ...
   ::create();
   	set_lore("Fey creature have always had a deep respect for"+
		...
		"There are rumors that the fey enchant each sure to "+
		"better aid the wearer to avoid magical and supernatural"+
		" effects.\n");
...
int remove_func(){
        tell_room(environment(ETO),"%^BOLD%^"+ETOQCN+" slides off "+ETO->QP+
