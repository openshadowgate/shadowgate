...
void create() {
    ...
    set_short("%^RESET%^%^ORANGE%^Kele%^GREEN%^mv%^ORANGE%^or's Reprieve%^RESET%^");
...
"simple design.%^RESET%^\n");
    set_lore("The scarab is one of several symbols that are sacred to the church of Kelemvor, Lord of the Dead.  Such "
"jewelry as this is as precious as it is rare, and only ever held by those who have enacted some task of considerable "
"worth to him.  As a sign of his favor, it is said to grant the wearer reprieve even from the jaws of death, that they "
"might be spared the wall and the afterlife to live again, if they so wish.  But only one such chance is given, for even "
"Kelemvor will not deny the natural order of life and death save in the rarest of circumstances.");
...
int wearme() {
    tell_object(ETO,"%^RESET%^%^ORANGE%^You feel the protection of Kelemvor upon you.%^RESET%^");
...
int removeme() {
    tell_object(ETO,"%^RESET%^%^ORANGE%^Kelemvor's protection leaves you.%^RESET%^");
