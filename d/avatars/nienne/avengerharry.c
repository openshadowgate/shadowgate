...
int paladin() {
  ...
  switch(god){
       case "auppenser":  GEM = "%^BOLD%^%^CYAN%^blue topaz";
                       break;
	case "grumbar":  GEM = "%^YELLOW%^to%^RESET%^%^ORANGE%^"+
                       "pa%^YELLOW%^z";
                       break;
      case "helm":  GEM = "%^BOLD%^%^BLUE%^sap%^CYAN%^ph%^BLUE%^"+
                    "ire";
                    break;
      case "kossuth":  GEM = "%^BOLD%^%^RED%^fi%^RESET%^%^RED%^r"+
                       ...
                       "%^RED%^l";
                       break;
      case "kelemvor" :  GEM = "%^RESET%^%^ORANGE%^t%^YELLOW%^i"+
				"%^RESET%^%^ORANGE%^g%^YELLOW%^e%^RESET%^"+
				"%^ORANGE%^r's eye";
      case "lathander":  GEM = "%^BOLD%^%^MAGENTA%^rose quartz";
                         break;
      case "mystra":  GEM = "%^BOLD%^%^BLUE%^st%^WHITE%^a%^BLUE%^"+
				"r sapp%^WHITE%^h%^BLUE%^ire";
                      break;
      case "selune":  GEM = "%^BOLD%^mo%^RESET%^o%^BOLD%^nst"+
                      "%^RESET%^o%^BOLD%^ne";
                      break;
      case "sune":  GEM = "%^RESET%^%^RED%^ruby";
      case "torm":  GEM = "%^BOLD%^%^YELLOW%^yellow diamond";
                    break;
      case "tyr":  GEM = "%^BOLD%^dia%^CYAN%^m%^WHITE%^ond";
                   break;
      default:  GEM = "colorless gem";
                break;
   }
  if((string)ETO->query_name() != "harrison") {
...
//      tell_room(EETO,"%^BOLD%^%^CYAN%^A pegasus flies in, answering the call!");
  ...
  switch(god){
      case "auppenser": ob = new("/d/common/mounts/kirre"); break;
      case "grumbar":  ob = new("/d/common/mounts/bulette"); break;
      case "helm":  ob = new("/d/common/mounts/griffon"); break;
      case "kelemvor": ob = new("/d/common/mounts/panther"); break;
      case "kossuth":  ob = new("/d/common/mounts/nightmare"); break;
      case "lathander":  ob = new("/d/common/mounts/gpegasus"); break;
      case "mystra":  ob = new("/d/common/mounts/spegasus"); break;
      case "selune":  ob = new("/d/common/mounts/unicorn"); break;
      case "sune": ob = new("/d/common/mounts/funicorn"); break;
      case "torm":  ob = new("/d/common/mounts/lion"); break;
      case "tyr":  ob = new("/d/common/mounts/graywolf"); break;
      default:  break;
   }
   if(ob) {
      ob->set_owner(TP);
