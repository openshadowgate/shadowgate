...
// The heart is really supposed to be a super rare/end game achievement, akin to the fountain of youth. Removing this from random drops, seems far too easy. N, 11/17.
//    herbs = ({ "divine essence","dragon scales","heart of an ancient wyrm","lich dust" });
    herbs = ({ "divine essence","dragon scales","lich dust" });
