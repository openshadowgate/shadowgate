...
int wearme()
{
    ...
    ETO->set("fixed_age", age); // sets their age to this fixed number.  They shouldn't loose the ring, but if they do fixed age would have to be cleared manually -Ares
