...
int wear_scar()
{
    ...
    ETO->set_monster_feats(({
     "dodge","evasion","knockdown","expertise",
     "mobility","powerattack","rush","smite",
     "mounted combat", "charge", "trample", "ride-by attack",
     "daze", "disarm", "lethal strikes"}));
    return 1;
}
