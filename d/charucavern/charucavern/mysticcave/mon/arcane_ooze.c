...
void create()
{
    ...
    set_short("%^BOLD%^%^GREEN%^mass of g%^RESET%^%^GREEN%^ee%^BOLD%^n pr%^RESET%^"+
...
{
    string *classes, class, spell, *spells;
    int x, max = 0, y;
    mapping tmp;
    int *lvls;
