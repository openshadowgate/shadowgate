...
void create() {
    ...
    set("long", "You are lost deep within clutches of Darkwood Forest.  "+
        ...
        "brittle sticks.  There appears to be a passable gap through "+
        "the trees to the north, and a break in the trees to the east.");
    set_items( ([
    ...
    set_exits( ([
        "north": ROOM_DIR+"forest24",
        "east": ROOM_DIR+"forest27",
    ]) );
}
