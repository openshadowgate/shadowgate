...
void create() {
    ...
    set("long", "You are lost deep within clutches of Darkwood Forest.  "+
        ...
        "brittle sticks.  To the north and south you notice a few "+
        "breaks through the maze of ancient trees that define the forest.");
    set_items( ([
    ...
    set_exits( ([
        "north": ROOM_DIR+"forest17",
        "south": ROOM_DIR+"forest15",
    ]) );
}
