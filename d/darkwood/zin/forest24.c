...
void create() {
    ...
    set("long", "You are lost deep within clutches of Darkwood Forest.  "+
        ...
        "and any light or warth it provides.  You feel the presence of "+
        ...
        "maze of trees to the east and south and a break in the forest "+
        "to the southeast.");
    set_items( ([
    ...
    set_exits( ([
        "south": ROOM_DIR+"forest26",
        "east": ROOM_DIR+"forest25",
        "southeast": ROOM_DIR+"forest27",
    ]) );
}
