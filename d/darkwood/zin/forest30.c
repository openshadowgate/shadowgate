...
void create() {
    ...
    set("long", "You are lost deep within clutches of Darkwood Forest.  "+
        ...
        "to the west created from marble of the blackest nature.  But "+
        "the trees stand as a living wall preventing you from venturing "+
        "nearer.  A dark stream flows by you from the north and "+
        "makes a turns to the to the southwest deeper into the forest.  "+
        "The only way to continue appears to be by following the stream.");
    set_items( ([
    ...
    set_exits( ([
        "north": ROOM_DIR+"forest29",
        "southwest": ROOM_DIR+"forest13",
    ]) );
}
