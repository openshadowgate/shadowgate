...
void create ()
{
  ...
  set_exits( ( [
     "out" : "/d/darkwood/forest/village/str2",
     "up"  : "/d/darkwood/forest/village/room1"
		]) );
  }
...
void reset()
{
  ::reset();
  if(!present("fgnome1"))
      new("/d/darkwood/mon/fgnome1.c")->move(this_object());
  if(!present("cgnome1"))
      new("/d/darkwood/mon/cgnome1.c")->move(this_object());
  if(!present("cgnome2"))
      new("/d/darkwood/mon/cgnome2.c")->move(this_object());
  }
