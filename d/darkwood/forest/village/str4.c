...
VILLAGE
  ...
  set_items( ([
     ...
     "layout" : "You can see homes scattered throughout the village.\nTo the northwest is a central firepit and to the south of it appears to be a general store.\nTo the south lies another home and a stonewell.\nAnd on first glance the only way out of the village is the way you came in.",
  ...
  set_exits( ([
     "east" : "/d/darkwood/forest/village/home3",
     "west" : "/d/darkwood/forest/village/square",
     "north" : "/d/darkwood/forest/village/str3",
     "south" : "/d/darkwood/forest/village/str5"
  ]) );
}
