...
before one of the warehouses and the central firepit.
VILLAGE
  );
  ...
  set_exits( ([
     "east" : "/d/darkwood/forest/village/firepit",
     "west" : "/d/darkwood/forest/village/warehouse1",
     "north" : "/d/darkwood/forest/village/str10",
     "south" : "/d/darkwood/forest/village/str8"
  ]) );
  }
