...
This is one of two stonewells in the village. It is surrounded
...
WELL
  ...
  set_exits( ([
     "east" : "/d/darkwood/forest/village/str10"
  ]) );
  }
...
int drink(string str){
  ...
  tell_object(TP,"You grab a near by ladel and dip it into the well.");
