...
void create()
{
  ...
  set("day long","%^GREEN%^Deep Darkwood%^RESET%^\n"
      ...
      "pretty thick. To the south you notice a well traveled trail.");
  ...
  set_exits( ([
     "north" : "/d/darkwood/forest/if13",
     "south" : "/d/darkwood/forest/if18",
     "east" : "/d/darkwood/forest/if16",
     "west" : "/d/darkwood/forest/if14"
	       ]) );
  }
