...
void create()
{
  ...
  set("day long","%^GREEN%^The Darkwood Forest%^RESET%^\n"
      "%^BOLD%^%^BLUE%^You travel deep within the forest.%^RESET%^\n"
  ...
  set_items( ([
     ...
     "trails" : "Here the trail branches off into several directions... "
                "northwest, northeast, north, and south."
	       ]) );
  set_search("leaves","You scatter the leaves and find an odd trail leading "
             "northwest.");
  set_exits( ([
     "north" : "/d/darkwood/forest/df1",
     "south" : "/d/darkwood/forest/df3",
     "northeast" : "/d/darkwood/forest/df31",
     "northwest" : "/d/darkwood/forest/df32"
	       ]) );
  }
