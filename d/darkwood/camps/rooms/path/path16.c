...
set_monsters(({MON+"raider.c"}),({5}));
   ...
   set("long",
      ...
      " can see that nature is virtually untouched here."
   );
   set_smell("default","%^RESET%^%^ORANGE%^The scent of plants and tree bark surround you.%^RESET%^");
   set_listen("default","%^RESET%^%^CYAN%^You hear birds singing and fluttering wings.%^RESET%^");
   set_items( ([
