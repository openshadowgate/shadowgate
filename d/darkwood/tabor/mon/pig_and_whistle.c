...
themselves.  A small doorway beside the bar leads back into what 
    ...
    "menu" : "It looks like a list of drinks.  Read the menu to see "+
       "what's available.",
        ({"storage","storage room","doorway"}) : "Looks like a storage "+
          "room for the bar.  You might be able to go in the storage "+
          "room if Rosalyn wasn't watching."
  ]));
  set_exits( ([
    "south" : ROOMDIR+"gwy5",
    "storage room" : ROOMDIR+"fencer"
  ]) );
  set_invis_exits(({"storage room"}));
}
...
int read(string str)
{
        ...
        if(str == "menu") {
                ...
                " lists these drinks:\n"+
                "%^ORANGE%^---------------%^YELLOW%^> %^GREEN%^Non-Alcoholic Drinks %^YELLOW%^<%^RESET%^%^ORANGE%^---------------\n",TP);
                ...
                "%^ORANGE%^---------------%^YELLOW%^> %^GREEN%^  Alcoholic Drinks %^YELLOW%^<%^RESET%^%^ORANGE%^---------------\n",TP);
                ...
                "%^ORANGE%^---------------%^YELLOW%^> %^GREEN%^  Shots %^YELLOW%^<%^RESET%^%^ORANGE%^---------------\n",TP);
                ...
                "%^ORANGE%^---------------%^YELLOW%^> %^GREEN%^  Foods %^YELLOW%^<%^RESET%^%^ORANGE%^---------------\n",TP);
