...
void create(){
   ...
   set_long("This aged man is dressed in crisp robes that hint "+
      "at a sense of decorum.  His salt and pepper hair is "+
      "gathered into a topknot, and he bears no arms or "+
...
int shape_em(){
   ...
   tell_room(ETO,"%^BOLD%^The crystal flashes with a brilliant "+
