...
"%^RESET%^From here, you can see the entryway back to the northwest, "+
"and two doorways are set into the southern side of the hall.\n"
  );
  ...
  set_exits( ([
    "northwest" : ROOMDIR+"cnchall",
    "south" : ROOMDIR+"guestroom3",
    "east" : ROOMDIR+"cnchall4"
  ]) );
  set_door("door",ROOMDIR+"guestroom3","south",0);
