...
"%^CYAN%^This small guestroom has few furnishings.  A large bed with "+
"an %^ORANGE%^oak frame %^CYAN%^stands with its head against "+
"the northern wall.  Just beside it is a hand-woven %^MAGENTA%^"+
"rug %^CYAN%^dyed a deep shade of %^MAGENTA%^wine%^CYAN%^.  "+
...
"a cozy feel.\n"
  ...
  set_items(([
     ({"bed","oak bed","frame","oak bed frame"}) : "The "+
        ...
        "star pattern.",
     "rug" : "%^MAGENTA%^The hand-woven rug beside the bed is large and "+
        "oval-shaped.  It is rather thick and seems well-tended.  It "+
     ...
     ({"drawers","chest of drawers"}) : "The chest of drawers matches "+
        "the oaken bed frame.  It is a little narrow, but has five "+
  ...
  set_exits( ([
    "south" : ROOMDIR+"cnchall1"
  ]) );
  set_door("door",ROOMDIR+"cnchall1","south",0);
