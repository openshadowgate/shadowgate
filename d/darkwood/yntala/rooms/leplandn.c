...
::create();
   ...
   set_items(([
      "rainbow":"%^YELLOW%^This is a very pretty and bright %^MAGENTA%^r%^RED%^a%^BLUE%^i%^YELLOW%^n%^GREEN%^b%^RED%^o%^CYAN%^w %^YELLOW%^south of here.  It is quite a bit larger than any other you've seen before, and its %^MAGENTA%^radiance %^YELLOW%^encompasses the entire area.%^RESET%^",
   ...
   set_exits((["south":INRMS+"lepland","southeast":INRMS+"leplande","southwest":INRMS+"leplandw"
...
" green hills covered in fresh spring grass and clovers.  A large rainbow ends south of here and"
