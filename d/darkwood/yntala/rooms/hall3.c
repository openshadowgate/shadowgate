...
::create();
   ...
   set_exits((["west":INRMS+"hall2","east":INRMS+"hall4"]));
}
string ldesc(string str){
   return("%^BOLD%^%^BLACK%^This is a dark, east-west tunnel.  It is quite large and easy to maneuver."
"  No slime covers the walls here, instead, they actually look like they might have"
