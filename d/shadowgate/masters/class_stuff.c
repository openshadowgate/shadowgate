...
void pick_diety()
{
    ...
    if(TP->is_class("ranger") || TP->is_class("cleric") || TP->is_class("cavalier") || TP->is_class("paladin") || TP->is_class("druid"))
    { // threw druids in with clergy. N, 3/16
