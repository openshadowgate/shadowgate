...
void show_hair()
{
   write("%^BOLD%^%^GREEN%^Please indicate the hair color that you would like to have for this character, this will also affect your skin color (see help ogre and half-ogre for more details).");
   ...
   write("%^BOLD%^%^GREEN%^   dark gray");
   possible[0] = "black";
   possible[1] = "brown";
   possible[2] = "dark gray";
   write("");
