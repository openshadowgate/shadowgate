...
void show_hair()
{
   write("%^BOLD%^%^GREEN%^Please indicate the hair color that you would like to have for this character, which will also serve as your fur color.");
   ...
   write("");
   write("%^BOLD%^%^GREEN%^<===============>");
   write("%^BOLD%^%^GREEN%^   reddish-gray");
   write("%^BOLD%^%^GREEN%^   dull yellow");
   possible[0] = "reddish-gray";
   possible[1] = "dull yellow";
   write("");
