//  Designed By Melnmarn.
//  Redone by Zeek.


#define SIZE 50
#define NUMDESCS 3
#define TERRAINPATH "/d/mine2/virtualocean/ocean.terrain"
#define DESCPATH "/d/mine2/virtualocean/ocean.desc"
#define EXITPATH "/d/mine2/virtualocean/ocean.exits"
