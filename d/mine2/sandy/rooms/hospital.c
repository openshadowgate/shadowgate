...
void create() 
{
  ...
  set_indoors(1);
  set_short("Sandy sergeon");
  set_long("You are in a large shop full of clerics.  "
           "There are many things around the room as you start to open your eyes.  "
           "The room is very clean and well lit.  "
  ...
  set_exits( ([
	"out" : "/d/mine2/sandy/room/sandy10"
           ] ));
}
