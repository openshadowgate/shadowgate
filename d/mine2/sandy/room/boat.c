...
"types.  Out of a large window you can see the ship yard where they prepare ships "
"for exploring the ocean.  A man sits behind a counter ready to take your order so "
...
"It may take a week or so for you boat to be made"); 
  this_player()->add_money( "gold", -50000");
     write_file("/d/mine2/sandy/buyers", (string)this_player()->query_name()+                "Bought a ship");
}
}
}
}
