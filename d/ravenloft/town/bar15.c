...
void create(){
	...
	"continues to the east and southwest."
	"%^RESET%^"
    );
    ...
    set_exits( ([
	"east":"/d/ravenloft/town/bar14",
	"southwest":"/d/ravenloft/town/bar16",
	"northwest":"/d/ravenloft/town/bar62",
	"southeast":"/d/ravenloft/town/bar63",
    ]) );
}
