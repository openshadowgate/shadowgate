...
void create(){
	...
	"continues to the west, northwest, northeast and southeast."
	"%^RESET%^"
    );
    ...
    set_exits( ([
	"west":"/d/ravenloft/town/bar24",
	"northwest":"/d/ravenloft/town/bar30",
	"southwest":"/d/ravenloft/town/bar82",
	"northeast":"/d/ravenloft/town/bar22",
	"southeast":"/d/ravenloft/town/bar29",
    ]) );
}
void reset(){
    ::reset();
