...
void create(){
	...
	"continues to the northwest and south."
	"%^RESET%^"
    );
    ...
    set_exits( ([
	"northwest":"/d/ravenloft/town/bar16",
	"south":"/d/ravenloft/town/bar18",
	"east":"/d/ravenloft/town/bar64",
	"west":"/d/ravenloft/town/bar50",
    ]) );
}
