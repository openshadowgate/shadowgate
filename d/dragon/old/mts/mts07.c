...
all the snow falling covers your footsteps.  To the west a light spills out
what you can tell a small window.
    ");
    set_exits(([
       "west" : "/d/dragon/mts/mts08",
       "east" : "/d/dragon/mts/mts06"
    ] ));
