  ...
  object ob, ob2;
 	...
 	races = races - ({"firbolg","half-ogre","ogre","wemic"});
  	...
  	set_gender(random(2)?"male":"female");
        ...
        set_long(
@VOID
%^BLUE%^These shadowy figures carry out some of the Order's most
important jobs, able to move through a battlefield easily, and
cause devistating assaults upon unsuspecting enemies.
VOID
);
