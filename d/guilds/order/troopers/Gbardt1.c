...
void create(){
 	 ...
 	 set_class("bard");
        ...
        set_short("Weak Gallant of the Order");
        set_race("half-elf");
...
The Gallant is one of the weaker troopers the Dragons have, following
the path of the bard, he is still very inexperienced in the ways of
combat.
VOID
);
