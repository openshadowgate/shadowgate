...
void create() {
   ...
   set_travel(FOOT_PATH);
    ...
    set_short("%^BLUE%^Shoikan Grove");
    set_long(
@SEETH
%^RED%^You are following a path in the grove.%^RESET%^
...
SEETH
    ...
    set_exits( ([
    "south" : HALL "firedock2.c",
    "north" : GROVE "g5.c",
    "east" : GROVE "g15.c",
    "west" : GROVE "g10.c",
    "northeast" : GROVE "g4.c",
    "northwest" : GROVE "g2.c",
    "southeast" : GROVE "g14.c",
    "southwest" : GROVE "g9.c",
      ]) );
