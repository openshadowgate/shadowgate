...
void create(){
  	...
  	::create();
       ...
       set_short("%^BLUE%^Intimidating Skeletal warrior%^RESET%^");
       set_alignment(9);
  	set_race("human");
    ...
    set_long(
@SEETH
%^BLUE%^Before you is one of Lord Soth's loyal skeletal warriors. He will kill any intruder upon his lord's lands.%^RESET%^
SEETH
);
