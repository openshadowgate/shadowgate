...
void create(){
    ...
    set_exits( ([
	"north" : "/d/guilds/legion/hall/arena/arena2.c",
	"east" : "/d/guilds/legion/hall/arena/arena5.c",
	"west" : "/d/guilds/legion/hall/arena/arena3.c",
	"southeast" : "/d/guilds/legion/hall/arena/arena8.c",
	"south" : "/d/guilds/legion/hall/arena/arena7.c",
	"southwest" : "/d/guilds/legion/hall/arena/arena6.c",
      ]) );
    set_items( ([
