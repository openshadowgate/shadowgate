...
void create(){
    ...
    set_exits( ([
	"northeast" : "/d/guilds/legion/hall/arena/arena2.c",
	"east" : "/d/guilds/legion/hall/arena/arena4.c",
	"southeast" : "/d/guilds/legion/hall/arena/arena7.c",
	"south" : "/d/guilds/legion/hall/arena/arena6.c",
      ]) );
    set_items( ([
