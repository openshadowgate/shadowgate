...
void create(){
    ...
    set_exits( ([
	"north" : "/d/guilds/legion/hall/arena/arena1.c",
	"south" : "/d/guilds/legion/hall/arena/arena4.c",
	"southeast" : "/d/guilds/legion/hall/arena/arena5.c",
	"southwest" : "/d/guilds/legion/hall/arena/arena3.c",
      ]) );
    set_items( ([
