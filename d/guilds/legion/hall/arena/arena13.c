...
void create(){
    ...
    set_exits( ([
	"down" : "/d/guilds/legion/hall/arena/arena21.c",
	"north" : "/d/guilds/legion/hall/arena/arena9.c",
	"northeast" : "/d/guilds/legion/hall/arena/arena11.c",
	"northwest" : "/d/guilds/legion/hall/arena/arena10.c",
      ]) );
