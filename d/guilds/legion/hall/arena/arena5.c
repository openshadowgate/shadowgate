...
void create(){
    ...
    set_exits( ([
	"west" : "/d/guilds/legion/hall/arena/arena4.c",
	"northwest" : "/d/guilds/legion/hall/arena/arena2.c",
	"southwest" : "/d/guilds/legion/hall/arena/arena7.c",
	"south" : "/d/guilds/legion/hall/arena/arena8.c",
      ]) );
    set_items( ([
