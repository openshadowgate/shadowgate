...
FIST
   ...
   set_items(([
      "fireplace" : "The fireplace is huge, so big that you could stand inside it if you really wanted to. It no longer warms the room and is instead filled with ashes.",
   ...
   set_exits(([
      "east":"/d/guilds/fist/hall/treasury",
      "west":"/d/guilds/fist/hall/guild2",
      "northeast" : "/d/guilds/fist/hall/list_room",
   ]));
