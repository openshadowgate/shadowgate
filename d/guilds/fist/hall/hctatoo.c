...
set_short("%^MAGENTA%^Tatoo of crossed swords, over a %^WHITE%^Yin%^MAGENTA%^/%^BLUE%^Yang%^MAGENTA%^ symbol");
	set_long(
@FIST
This is a beautiful and detailed Tatoo signifying the rank of High Commander in the Iron Fist.
FIST
	);
	set_weight(0);
set_value(0);
