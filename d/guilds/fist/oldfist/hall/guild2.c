...
Here it's members once gathered to revel and share stories of their 
...
FIST
   ...
   set_exits(([
              "north" : "/d/guilds/fist/hall/guildheal.c",
              "out": "/d/guilds/fist/hall/guild1.c",
              "east":"/d/guilds/fist/hall/main.c"
   ]));
