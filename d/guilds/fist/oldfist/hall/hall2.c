...
@FIST
%^BLUE%^
You have entered a dark and ancient tomb. The floor is covered with bits of rotting furniture and dust, deep and thick, obviously undisturbed for a very long time. Along the walls of this rectangular room are a score of massive chairs. Your flesh creeps as you notice that these chairs are indeed occupied, by the cadaverous corpses of long dead warriors, still wearing thier full battle regalia.
As your eyes adjust to the darkness, you see a huge throne at the far end of the room, and seated in it is another corpse, a crown on it's head, and it's right hand still resting on the pommel of a colossal broadsword. 
%^RESET%^
FIST
   );
   ...
   set_exits(([
              "out":"/d/guilds/fist/hall/hall1.c"
              ]) );
...
if (member_array("The Iron Fist",TP->query_guild()) == -1 && !avatarp(TP)) {
      return 0;
   }
