// level 1 mage trooper for the Fist
...
void create(){
 	 ...
 	 set_class("mage");
  	set_alignment(5);
	set_name("Lesser enchantress");
	set_id(({"trooper","mage", "lesser enchantress","Lesser enchantress","Enchantress"}));
	set_short("Lesser enchantress");
