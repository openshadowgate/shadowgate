...
void create(){
   ...
   set_long(
@DESC
%^CYAN%^Holy room%^RESET%^
%^BOLD%^%^WHITE%^This is the holy room of the castle, here the warriors come 
to strengthen thier faith and to remember thier lost friends 
...
DESC
   ...
   set_exits(([
      "west":"/d/guilds/alliance/hall/main.c",
   ]));
}
