...
with many mounted units traveling both north and south. To the north here 
stands an old keep. Its gradually falling into disrepair. It is rumoured that it once held the Alliance of Light.
OLI
   );
   ...
   set_items(([
              ...
              "keep":"This large masonry effort stands watching over the road. It's drawbridge currently stands shut.",
                "drawbridge":"This draw bridge appears to have been broken and then hefted up to allow entrance, with the stout chains now broken the bridge may never again be raised.",
              ]));
   set_exits(([
