...
%^ORANGE%^All around you lie the Charu Mountains. They are very intimidating, looming high in the sky. The road winds through the mountains.
MELNMARN
);
    ...
    set_exits(([
	"southwest" : PASSDIR+"pass12",
	"northwest" : PASSDIR+"pass14"
   	]));
}
