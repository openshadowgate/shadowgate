...
%^CYAN%^All around you lie the Charu Mountains. They are very intimidating, looming high in the sky. The road winds through the mountains. There is a small hut here.
MELNMARN
);
    ...
    set_exits(([
	"southeast" : PASSDIR+"pass13",
        "northeast" : PASSDIR+"pass15",
        "west" : PASSDIR+"hm_quest_begin"
   	]));
}
