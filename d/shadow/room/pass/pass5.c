...
%^ORANGE%^Around you lie the Charu Mountains. They are very intimidating, looming high in the sky. This road seems to be the only way through this area.
MELNMARN
);
    ...
    set_exits(([
	"southwest" : PASSDIR+"pass4",
	"northeast" : PASSDIR+"pass6"
   	]));
}
