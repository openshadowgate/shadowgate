...
%^ORANGE%^All around you lie the Charu Mountains. They are very intimidating, looming high in the sky. The road winds through the mountains. There might once have been a cavern opening here, but now fallen rubble is all that
remains.
MELNMARN
);
    ...
    set_exits(([
	"southeast" : PASSDIR+"pass20",
	"northeast" : PASSDIR+"pass22"
   	]));
}
