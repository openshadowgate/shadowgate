...
%^ORANGE%^All around you lie the Charu Mountains. They are very intimidating, looming high in the sky. The road windsthrough the mountains.
MELNMARN
);
    ...
    set_exits(([
	"south" : PASSDIR+"pass18",
	"north" : PASSDIR+"pass20",
   	]));
}
