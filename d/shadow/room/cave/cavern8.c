/******NOTE - after orc/old orc caverns - southeastern route******/
//cavern8.c
#include "../cave.h"
#include "ddcaves.h"
...
void create(){
    ...
    set_search("default","You find a pool of cool, clear water.");
...
void init(){
    ::init();
//	do_random_encounters(({MONDIR+"orc",MONDIR+"orccaptain"}),80,15);
