/******NOTE - after giant rat caves - eastern route******/
#include "../cave.h"
#include "ddcaves.h"
...
void create(){
    ...
    set_items(([
      ...
      "encampment" : "Despite the broken arms and armor lying around the floor, the large amount "+
         "of rat droppings covering everything suggests that this cavern is nothing more than a breeding "+
    ...
    set_smell("default","The acrid scent of rat droppings hangs heavy in the air.");
    set_listen("default","The sound of squeaking rats and dripping water fills your ears."); 
...
void init(){
    ::init();
//	do_random_encounters(({MONDIR+"rat",MONDIR+"giantrat"}),80,15);
