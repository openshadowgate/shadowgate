...
"%^RESET%^over the treetops further upward.  Just to the south, you can see a much larger and well-defined "
"trail.\n");
...
"%^RESET%^against the even darker backdrop of night sky.  Just to the south, you can see a much larger and "
"well-defined trail.\n");

   set_exits(([
     "northeast":ROOMS"path2",
     "south":"/d/shadow/room/forest/road24",
   ]));
}
