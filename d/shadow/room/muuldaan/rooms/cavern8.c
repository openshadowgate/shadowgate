...
"metal, leaning together in vague semblances of structure.  Several creatures are scurrying into a "
"half-built shanty to the southeast, and returning with various items clutched in their dirty hands.\n");

   set_exits(([
     "southwest":ROOMS"cavern9",
     "north":ROOMS"cavern7",
     "southeast":ROOMS"general",
     "south":ROOMS"thief",
   ]));
}
