...
"the ground%^RESET%^\n\n");
 set_exits(([
     ...
     "south":"/d/shadow/virtual/desert/26,17.desert",
     "north":"/d/shadow/virtual/desert/28,17.desert",
...
void reset() {
   ...
   if(!present("Shannon Doren"))
      new(MOBS"shannon_doren.c")->move(TO);
   }

int step(string str,object who){
    if(!str) {
