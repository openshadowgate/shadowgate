...
void create() {
   ...
   set_short("Tony, the Beach Armory Shop owner.");
   set("aggressive", 0);
   set_level(10);
   ...
   set_body_type("human");
set_storage_room("/d/shadow/room/beach/stores/armory_storage");
...
int at_shop(){
	if(file_name(environment(TO)) != "/d/shadow/room/beach/stores/armory"){
