//lslide1.c for use with ptrail7.c
#include <std.h>
#include "../kildare.h"
...
void create(){
    ...
    set_long(
      ...
      "skeletal limbs moving lightly on the breeze.  Though the rocks "+
       "are piled high here, you might be able to climb over them."
    );
