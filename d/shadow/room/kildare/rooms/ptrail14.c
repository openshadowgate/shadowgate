...
void create(){
   ...
   set_long(
      ...
      "The %^GREEN%^mountainside %^RESET%^rises high to the west here, though there "+
   ...
   set("night long",
      ...
      "high to the west here, though there does not seem to be a way to climb up."+
      "\n"
   );
   add_item("mountainside","The mountain rises sharply to the west, creating a high "+
      "mound.  There does not seem to be a way up from here.");
   set_exits(([
      "northwest" : ROOMS"ptrail15",
      "southwest" : ROOMS"ptrail13"
      ]));
}
