...
void create(){
        ::create();
        set_name("reaping whirlwind");
        set_id(({"scythe","reaping whirlwind","whirlwind"}));
        set_short("%^YELLOW%^Reaping %^RESET%^%^CYAN%^Whirlwind%^RESET%^");
        set_obvious_short("An iron scythe");
        set_long(
