...
"enter it.  Just to the east, you can make out a gate within the city wall.\n");
...
"%^BLUE%^dark %^RESET%^and thickly grown that there's no visible way to leave the path and enter it.  Just to "
"the east, you can make out a gate within the city wall.\n");

   set_exits(([
     "northwest":VILLAGEDIR"path15",
     "east":"/d/darkwood/room/road1",
   ]));
}
