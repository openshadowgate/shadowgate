...
"enter it.  Just to the north, you can make out a gate within the city wall.\n");
...
"the north, you can make out a gate within the city wall.\n");

   set_exits(([
     "north":VILLAGEDIR"path1",
     "south":VILLAGEDIR"path3",
   ]));
}
