...
void create()
{
   ...
   "The road stretches out to the west and east, but quickly turns"+
   " to the southeast up ahead. The road seems to be in very good"+
   " shape here and you feel safe traveling along it."
   );
   ...
   set_exits(([
   "west" : FORESTDIR+"road51",
   "east" : FORESTDIR+"road53",
   ]));
}
