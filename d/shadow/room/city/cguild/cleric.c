...
%^BOLD%^Holy Order of the Clergy. %^RESET%^%^CYAN%^There is a small wooden box
below the sign in which you may place your vote. Remember to choose
wisely, for you will only have one chance.
SEETH
);


set_exits(([
"out":"/d/shadow/room/city/cguild/cleric/cleric1.c",
]));
