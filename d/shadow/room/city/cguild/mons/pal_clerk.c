...
void create() {
   ...
   set_short("%^RED%^Clerk of the Paladin's Armoury%^BOLD%^%^GREEN%^");
   set("aggressive", 0);
   set_level(19);
   set_long("He buys and sells equipment to serve the holy knights of the land.\n"+
...
__List(string str){
    if(TP->is_class("paladin")) return ::__List(str);
      ...
      tell_object(TP, "Only holy knights of light may purchase from me!");
      return 1;
    }
}
__Buy(string str){
