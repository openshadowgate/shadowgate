#define SIZE 70
#define NUMDESCS 10
#define TERRAINPATH "/d/shadow/virtual/river/river.terrain"
#define DESCPATH "/d/shadow/virtual/river/river.desc"
#define EXITPATH "/d/shadow/virtual/river/river.exits"
