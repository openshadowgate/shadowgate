...
To the north, east, and west, you see nothing but sand for miles. 
Strangely, a large %^BOLD%^stone building %^RESET%^rises to the south 
...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/37,15.desert",
	"north":"/d/shadow/virtual/desert/36,14.desert",
      "west":"/d/shadow/virtual/desert/37,13.desert"
   ]));
