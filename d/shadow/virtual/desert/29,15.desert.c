...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/29,16.desert",
      "west":"/d/shadow/virtual/desert/29,14.desert",
	"north":"/d/shadow/virtual/desert/28,15.desert",
      "south":"/d/shadow/virtual/desert/30,15.desert"
   ]));
