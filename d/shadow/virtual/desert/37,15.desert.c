...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/37,16.desert",
	"north":"/d/shadow/virtual/desert/36,15.desert",
      "west":"/d/shadow/virtual/desert/37,14.desert",
      "south":"/d/shadow/virtual/desert/38,15.desert"
   ]));
