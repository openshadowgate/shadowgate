...
In most directions, you see nothing but sand for miles.  Here, 
though, a few %^ORANGE%^stones %^RESET%^catch your eye.  They 
have been lined up in the sand here, leading south.
MELNMARN
   );
   set_exits(([
	"east":"/d/shadow/virtual/desert/25,16.desert",
      "west":"/d/shadow/virtual/desert/25,14.desert",
	"north":"/d/shadow/virtual/desert/24,15.desert",
      "south":"/d/shadow/virtual/desert/26,15.desert"
   ]));
