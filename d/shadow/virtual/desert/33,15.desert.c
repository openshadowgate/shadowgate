...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/33,16.desert",
      "west":"/d/shadow/virtual/desert/33,14.desert",
	"north":"/d/shadow/virtual/desert/32,15.desert",
      "south":"/d/shadow/virtual/desert/34,15.desert"
   ]));
