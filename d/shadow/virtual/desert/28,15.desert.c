...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/28,16.desert",
      "west":"/d/shadow/virtual/desert/28,14.desert",
	"north":"/d/shadow/virtual/desert/27,15.desert",
      "south":"/d/shadow/virtual/desert/29,15.desert"
   ]));
