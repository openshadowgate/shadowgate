...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/34,16.desert",
      "west":"/d/shadow/virtual/desert/34,14.desert",
	"north":"/d/shadow/virtual/desert/33,15.desert",
      "south":"/d/shadow/virtual/desert/35,15.desert"
   ]));
