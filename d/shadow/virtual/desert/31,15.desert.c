...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/31,16.desert",
      "west":"/d/shadow/virtual/desert/31,14.desert",
	"north":"/d/shadow/virtual/desert/30,15.desert",
      "south":"/d/shadow/virtual/desert/32,15.desert"
   ]));
