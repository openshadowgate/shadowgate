...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/35,16.desert",
      "west":"/d/shadow/virtual/desert/35,14.desert",
	"north":"/d/shadow/virtual/desert/34,15.desert",
      "south":"/d/shadow/virtual/desert/36,15.desert"
   ]));
