...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/30,16.desert",
      "west":"/d/shadow/virtual/desert/30,14.desert",
	"north":"/d/shadow/virtual/desert/29,15.desert",
      "south":"/d/shadow/virtual/desert/31,15.desert"
   ]));
