...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/26,16.desert",
      "west":"/d/shadow/virtual/desert/26,14.desert",
	"north":"/d/shadow/virtual/desert/25,15.desert",
      "south":"/d/shadow/virtual/desert/27,15.desert"
   ]));
