...
MELNMARN
   ...
   set_exits(([
	"east":"/d/shadow/virtual/desert/27,16.desert",
      "west":"/d/shadow/virtual/desert/27,14.desert",
	"north":"/d/shadow/virtual/desert/26,15.desert",
      "south":"/d/shadow/virtual/desert/28,15.desert"
   ]));
