...
To the north, south, and west, you see nothing but sand for miles. 
Strangely, a large %^BOLD%^stone building %^RESET%^rises to the east 
...
MELNMARN
   ...
   set_exits(([
	"south":"/d/shadow/virtual/desert/39,13.desert",
	"north":"/d/shadow/virtual/desert/37,13.desert",
      "west":"/d/shadow/virtual/desert/38,12.desert"
   ]));
