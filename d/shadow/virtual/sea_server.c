...
#define BASE "/d/shadow/virtual/sea/"
#define SUFFIX ".sea"
#define DESERT_DAEMON "/d/shadow/virtual/sea_daemon.c"
...
string query_smell(string str){
	...
	if(y > 48)
	   ...
	   return "You can smell arid desert air blowing from the west.";
	else 
...
string query_listen(string str){
	...
	if(y > 48)
		...
		return "You can hear the crashing waves to the west.";
	else
