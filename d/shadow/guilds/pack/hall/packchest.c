...
set_name("Shades of Death Donation Chest");
set_short("Shades of Death Donation Chest");

   set_long(
@SEETH
%^RED%^This is a chest in which Pack members can donate items for other members to have.%^RESET%^
SEETH
);
