...
set_smell("default","You smell the fear and ecstacy of battle.");
    set_exits( ([
"north" : "/d/shadow/guilds/pack/hall/arena5.c",
"south" : "/d/shadow/guilds/pack/hall/arena1.c",
"west" : "/d/shadow/guilds/pack/hall/arena2.c",
"east" : "/d/shadow/guilds/pack/hall/arena4.c",
    ]) );
}
