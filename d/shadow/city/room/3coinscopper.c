...
void create()
{
   ...
   set_name("Copper Guest Room, Three Coins Inn, Shadow");
   set_short("%^BOLD%^%^WHITE%^Copper Guest Room, Three Coins "+
      "Inn, Shadow%^RESET%^");
   set_long("%^BOLD%^%^WHITE%^Copper Guest Room, Three Coins "+
      "Inn, Shadow%^RESET%^\n"+
      "%^RESET%^%^ORANGE%^A large, %^CYAN%^curtained bed%^ORANGE%^, "+
      "set upon a raised dais, takes centerstage in this %^BOLD%^"+
      "%^MAGENTA%^charming %^RESET%^%^ORANGE%^room. Behind it, two "+
      "shallow %^BOLD%^%^BLACK%^alcoves %^RESET%^%^ORANGE%^lead to "+
      "large windows that allow light to spill across the dark %^CYAN%^"+
      "wooden floors%^ORANGE%^. The walls are in part carved from the "+
      "same %^BOLD%^%^BLACK%^light gray stones %^RESET%^%^ORANGE%^as "+
      "the rest of the inn, but the upper halves has been painted a "+
      "lovely hue of %^BOLD%^%^MAGENTA%^lavender%^RESET%^%^ORANGE%^, "+
      "and decorated with pictures. One side of the room is home to a "+
      "%^CYAN%^table %^ORANGE%^and %^CYAN%^two grand chairs%^ORANGE%^, "+
      "while the other wall features a functioning %^BOLD%^%^BLACK%^"+
      "fireplace%^RESET%^%^ORANGE%^, lined in %^BOLD%^%^BLACK%^black "+
      "stones%^RESET%^%^ORANGE%^. Lanterns are placed strategically "+
      "around the room, providing a calming glow to the cozy space. "+
      "Nearly almost everything is accented with at least a touch of "+
      "%^BOLD%^%^BLACK%^copper%^RESET%^%^ORANGE%^. A small, shuttered "+
   ...
   set_items(([
      ...
      "shuttered window" : "%^RESET%^%^ORANGE%^This is a small window "+
         ...
         "%^BLACK%^copper paint%^RESET%^%^ORANGE%^.%^RESET%^",
      ...
      "lanterns" : "%^RESET%^%^ORANGE%^These old fashioned oil lanterns "+
         ...
         "%^BOLD%^%^BLACK%^copper %^RESET%^%^ORANGE%^and hang from "+
   ...
   set_door("copper door",ROOMS"3coinsbalcony","out",0,0);
   set_door_description("copper door","%^BOLD%^This wooden door is "+
