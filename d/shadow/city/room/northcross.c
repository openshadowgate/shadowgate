...
void create(){
   ...
   set_short("%^BOLD%^Intersection of %^CYAN%^Melistel Avenue "+
      "%^BOLD%^%^WHITE%^and %^RESET%^%^MAGENTA%^Crossway Road"+
      "%^BOLD%^%^WHITE%^, Shadow%^RESET%^");
   set_long("%^BOLD%^Intersection of %^CYAN%^Melistel Avenue "+
      "%^BOLD%^%^WHITE%^and %^RESET%^%^MAGENTA%^Crossway Road"+
      "%^BOLD%^%^WHITE%^, Shadow%^RESET%^\n "+
      ...
      "The %^BOLD%^%^BLACK%^city gates %^RESET%^lie "+
      "to the north. To the west is the city %^BOLD%^scribe%^RESET%^.\n");
   ...
   set_exits(([
      "north" : ROOMS"northgate",
      "south" : ROOMS"melistel4",
      "southeast" : ROOMS"crossways1",
	  "west": ROOMS"scribe",
   ]));
}      
