...
void create(){
   ...
   set_name("Courtyard of the Shadow Tower of Wizardry");
   set_short("%^BOLD%^%^BLUE%^Courtyard of the Tower of Wizardry, "+
      "Shadow%^RESET%^");
   set_long("%^BOLD%^%^BLUE%^Courtyard of the Tower of Wizardry, "+
      "Shadow%^RESET%^\n "+
