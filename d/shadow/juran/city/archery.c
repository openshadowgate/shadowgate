...
void create(){
	...
	set_short("Archery Range, Juran");
	set_long(
@NROHT
%^CYAN%^BOLD%^Archery Range, Juran%^RESET%^
This is the archery range in Juran.  Archers come here to practice on
...
int GoThroughDoor(){
	...
	write("You step back very embarassed as you hear the other archers "+
