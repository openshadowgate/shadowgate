...
set_short("A pathway");
set_long("%^GREEN%^
The path veers to the west as the magical area slips into the mist.
The immense trees are now overshadowed by mountains that fill the air
with grey foreboding.  Snowtopped caps appears about the leafy boughs,
and craggy edges form a backdrop to the forest.");
...
set_exits (([
"northeast" : PMID+"room115.c",
"east" : PMID+"room116.c",
"southeast" : PMID+"room117.c",
"west" : PMID+"room119.c",
"northwest" : PMID+"room120.c"
]));
set_items(([
