...
set_long("%^ORANGE%^As you continue to walk you notice more of the Sloridge Gnomes.  For the most part they are a pitiful bunch, small ferretlike burrowing creatures, who beg, borrow and mostly steal whatever comes within their reach.  Most of the other forest creatures ignore them, however, there will be the occasional mud puppy around as it seems like the pitiful gnomes for some reason.");
...
set_exits (([
"east" : PMID+"room137.c",
"southeast" : PMID+"room134.c",
"south" : PMID+"room133.c"
]));
set_items(([
