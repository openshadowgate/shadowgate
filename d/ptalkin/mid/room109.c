...
set_short("A pathway");
set_long("%^MAGENTA%^The black unicorn nods its head in recognition of the homage being paid.  Ebony body gleams in the halflight, mane and fetlocks shimmering like silk thrown in the wind.  Goat's feet shift and lion's tail swishes, restless movements against the backdrop of the still-life world.  The ridged horn knifes the darkness, shining faintly with magic.  There has never before been a thing of such beauty and grace in all creation and never will be again.");
...
set_exits (([
"southeast" : PMID+"room107.c",
"northwest" : PMID+"room110.c"
]));
set_items(([
