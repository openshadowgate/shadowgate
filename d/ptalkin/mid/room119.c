...
set_short("A pathway");
set_long("%^GREEN%^The path veers to the west as the magical area slips into the mist.  The immense trees are now overshadowed by mountains that fill the air with grey foreboding.  Snowtopped caps appear about the leafy boughs, and crazzy edges form a backdrop to the forest.");
