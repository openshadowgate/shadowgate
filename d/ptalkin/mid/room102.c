...
set_short("A pathway");
set_long("%^GREEN%^You straighten your back against a pines roughened coat, swallowing the dryness in your throat, trying to consider the dream being shown you.");
...
set_exits (([
"north" : PMID+"room101.c",
"south" : PMID+"room103.c",
"southwest" : PMID+"room104.c"
]));
set_items(([
