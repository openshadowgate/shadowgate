...
set_short("A pathway");
set_long("%^MAGENTA%^
Colour glimmers in hazy patches through the fading dark where streaks
of sunlight or moonlight dances off morning or evening dew.  The 
silence seems to deepen further with the appearance of the unicorn, as
if that one small event in that one tiny corner was sensed
throughout the whole of the forest.");
...
set_exits (([
"northeast" : PMID+"room106.c",
"northwest" : PMID+"room109.c",
"southeast" : PMID+"room108.c"
]));
set_items(([
