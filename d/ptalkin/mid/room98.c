...
set_short("A pathway");
set_long("%^MAGENTA%^She kneels at the edge of the water, surrounded by leafy elms.  She is light and ephemeral, born of air and blown on the wind.  She is a tiny thing, little more than a wisp of life.");
...
set_exits (([
"northeast" : PMID+"room97.c",
"northwest" : PMID+"room111.c",
"southwest" : PMID+"room99.c"
]));
set_items(([
