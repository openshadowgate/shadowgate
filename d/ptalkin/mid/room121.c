...
set_short("A pathway");
set_long("%^GREEN%^You cannot put your finger upon the sense that you feel.  Darkness, fear, eeriness is beginning to fill your soul, empty, watchful.  The sense of being watched raises the hair upon your nape, making your hands twitch in readiness.  But for what, is not clear to you.");
...
set_exits (([
"northeast" : PMID+"room120.c",
"east" : PMID+"room119.c",
"northwest" : PMID+"room122.c"
]));
set_items(([
