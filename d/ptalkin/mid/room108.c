...
set_short("A pathway");
set_long("%^MAGENTA%^Colour glimmers in hazy patches through the fading dark where streaks of sunlight or moonlight dances off morning or evening dew.  The silence seems to deepen further with the appearance of the unicorn, as if that one small even in that one tiny corner was sensed throughout the whole of the forest.");
