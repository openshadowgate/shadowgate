...
set_short("A pathway");
set_long("%^BLUE%^You see a large rock centered in the lake.  Small waves lap against it to the earths' rhythm, creating small splashing sounds.  The area is a picture of serenity.");
...
set_exits (([
"northeast" : PMID+"room96.c",
"southwest" : PMID+"room98.c"
]));
set_items(([
...
if(!present("elfin cat"));
new("/d/ptalkin/mon/elfincat")->move(TO);
}
