...
set_short("A pathway");
set_long("%^MAGENTA%^The black unicorn slips like quicksilver through shadows and light in search of its freedom.");
...
set_exits (([
"north" : PMID+"room104.c",
"northeast" : PMID+"room103.c",
"southwest" : PMID+"room106.c"
]));
set_items(([
