...
set_short("A pathway");
set_long("%^GREEN%^You follow once more upon the needle strewn path.  Your footsteps muffled by the foliage.  The peace of the forest is beginning to be replaced by a sense of awe and danger.  The birds sing a song that seems mournful and wary.");
...
set_exits (([
"south" : PMID+"room119.c",
"southwest" : PMID+"room121.c",
"southeast" : PMID+"room118.c"
]));
set_items(([
