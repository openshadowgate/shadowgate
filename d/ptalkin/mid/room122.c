...
set_short("A pathway");
set_long("%^GREEN%^
Your senses have been justified.  The eerie, dangerous feeling that has
haunted you has been drawn into reality.  Grey, forbidding, unexplored
territory reaches your eyes as the mountains come into view.  Stories
come to mind, whispering to you of horrors untold.");
...
set_exits (([
"northwest" : PDROW+"room158.c",
"southeast" : PMID+"room121.c"
]));
set_items(([
