...
set_short("A pathway");
set_long("%^GREEN%^You wander past the magical lake into stands of cypress and willow.  The sky is concealed within boughs and shadows making the sky look as though green lacework has been cast upon it.");
...
set_exits (([
"northeast" : PMID+"room99.c",
"south" : PMID+"room102.c"
]));
set_items(([
...
if(!present("toadstool"));
new("/d/ptalkin/mon/toadstool")->move(TO);
}
