...
set_short("A pathway");
set_long("%^GREEN%^
The waters have gone still, the churning smoothed away as a mothers
hand would smooth a sleeping childs' ruffled hair.  The glow dances
at the waters edge, a living thing.  Dozens of the wood nymphs appear
as if from nowhere and dance and flitter at the shores of the mirrored
lake in a kaleidoscope of movement.");
...
set_exits (([
"north" : PMID+"room116.c",
"northwest" : PMID+"room118.c"
]));
set_items(([
