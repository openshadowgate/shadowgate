...
set_short("A pathway");
set_long("%^ORANGE%^The street is narrow, although the occasional bucket of flowers appears to brighten the way.");
...
set_exits (([
"northeast" : PROOM+"room59.c",
"northwest" : PROOM+"room61.c",
]));
set_items(([
