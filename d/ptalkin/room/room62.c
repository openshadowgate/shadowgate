...
set_short("A pathway");
set_long("%^ORANGE%^The street is narrow, although the occasional bucket of flowers appears to brighten the way.  To the west is a Chocolate and Flower Shop.");
...
set_exits (([
"northeast" : PROOM+"room65.c",
"south" : PROOM+"room63.c",
"west" : PROOM+"flower.c"
]));
set_items(([
