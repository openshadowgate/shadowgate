...
set_short("A pathway");
set_long("%^ORANGE%^The street is well tended, with flower beds along the sides.  Many shops line the street, their names carved or burned into wooden signs, hung by metal chains.  To the east is the General Store.");
...
set_exits (([
"east" : PROOM+"g_store.c",
"west" : PROOM+"room66.c",
"north" : PROOM+"room55.c",
"south" : PROOM+"room53.c",
"northeast" : PROOM+"room56.c",
"northwest" : PROOM+"room67.c",
"southwest" : PROOM+"room52.c"
]));
set_items(([
