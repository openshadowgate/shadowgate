...
set_short("A pathway");
set_long("%^ORANGE%^The street is narrow, although the occasional bucket of flowers appears to brighten the way.  To the north is the stables.");
...
set_exits (([
"north" : PROOM+"stable.c",
"southeast" : PROOM+"room58.c",
"southwest" : PROOM+"room60.c"
]));
set_items(([
