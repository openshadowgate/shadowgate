...
"the %^RESET%^floor%^BOLD%^%^WHITE%^ is covered in %^RESET%^%^ORANGE%^dirt%^BOLD%^%^WHITE%^ and %^RESET%^%^GREEN%^grime%^BOLD%^%^WHITE%^.%^RESET%^\n");
  ...
  set_items( ([
     "floor" : "You notice that there are another set of footprints other then your own.",
     "footprints" : "The other set of footprints appear to be heading east."
]) );
  set_exits( ([
     "south" : "/d/koenig/town/tower20",
     "east" : "/d/koenig/town/tower22.c"
]) );
