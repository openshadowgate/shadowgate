//bard_xvim.c - Bard of xvim reward for Nereid Riddle Quest.  Circe 1/22/04
#include <std.h>
#include "../../nereid.h"
...
*/
    set_read("%^BOLD%^%^GREEN%^May the gauntleted hand of tyranny "+
       "stretch forth over all your foes.  You may "+
       "%^BLACK%^<%^BOLD%^%^GREEN%^play%^BLACK%^> %^BOLD%^%^GREEN%^ this drum to create an "+
       "inky darkness to confuse and blind your foes.%^RESET%^");
    set_weight(8);
    set_value(0);
    set_lore("Drums such as these have long been used by followers of the "+
       "Cruel Master to inspire fear in all others.  Bards in his faith have "+
       ...
       "Xvim to one bard in particular who had served him well.  Sadly, Malicant "+
       "the Green overstepped his bounds one day, and Xvim had to smite him.  No "+
       "one can aspire to rise about such a Cruel Master, not even his most favored "+
       "pupil.");
