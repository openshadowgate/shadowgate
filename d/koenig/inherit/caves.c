//caves.c - inherit for Koenig caves.  Updated 11/28/03 by Circe.
#include <std.h>
#include "../koenig.h"
...
void pick_critters(){
   switch(random(6)){
         case 0:   set_monsters( ({KMON"orc",KMON"orcguard"}),({random(2),random(1)}) );
                   break;
         case 1:   set_monsters( ({KMON"orccaptain",KMON"k_goblin"}),({random(2),random(1)}) );
                   break;
         case 2:   set_monsters( ({KMON"k_goblin",KMON"orcguard",KMON"orccaptain"}),({1,random(1)+1,random(2)}) );
                   break;
         case 3:   set_monsters( ({KMON"k_goblin",KMON"orc"}),({random(2)+1,1}) );
                   break;
         case 4..5: break;
   }
}
