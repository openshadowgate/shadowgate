//this is the garden with the enchantress in it
#include <std.h>
#include "../defs.h"
inherit ROOM;
...
void create() {
    ...
    set_items(([
        ...
        ({"loom", "building" }) : "The building houses a giant loom that shimmers, it practically shouts with magical power.",
    ]));
    set_exits(([
        "northeast" : ROOMS"garden1",
        "south" : ROOMS"garden3",
    ]));
}
