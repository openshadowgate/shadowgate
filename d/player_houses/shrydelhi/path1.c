//path1.c - winding path to Shrydelhi's house.  Coded by Circe 9/26/03
#include <std.h>
#include "shry.h"
...
void create(){
  ...
  set_search("trees","Searching the trees, you think you see a path leading off to the north.");
  set_exits(([
  "southwest":"/d/dagger/derro/rooms/r5",
  "north":SHRY"path2",
  ]));
