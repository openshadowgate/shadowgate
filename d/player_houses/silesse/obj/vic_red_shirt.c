...
void create(){
   ::create();
   set_name("shirt");
   set_id(({"shirt","crimson shirt","red shirt","vicdaerrysn clothing","vic red shirt"}));
   set_short("%^RESET%^%^RED%^a crim%^BOLD%^s%^RESET%^%^RED%^on shirt%^RESET%^");
   set_long("This well-made shirt is rather simple in design, made "+
      ...
      "and the design is flawless.  It has been dyed a %^RESET%^%^RED%^"+
      "deep crim%^BOLD%^s%^RESET%^%^RED%^on%^RESET%^, the color saturating "+
