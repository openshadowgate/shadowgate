...
void create(){
   ::create();
   set_name("shirt");
   set_id(({"shirt","white shirt","vicdaerrysn clothing","vic white shirt"}));
   set_short("%^BOLD%^%^WHITE%^a stylish white shirt%^RESET%^");
   set_long("This well-made shirt is rather simple in design, made "+
      ...
      "and the design is flawless.  It has been dyed a %^BOLD%^%^WHITE%^"+
      "pristine ivory%^RESET%^, the color saturating "+
