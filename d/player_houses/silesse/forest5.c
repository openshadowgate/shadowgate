...
void create(){
::create();
set_post_exit_functions(({"east","northwest","northeast"}),({"go_out1","go_out2","go_out3"}));
set_exits(([
"east":SIL"forest3",
"northwest":SIL"forest6",
"northeast":SIL"forest2",
]));
set_invis_exits(({"east","northwest","northeast"}));
}
