...
void create() {
    ...
    set_search("trees","You take a moment, searching out a path through the trees.  You think perhaps you could continue on to the east.");
    set_search("forest","You take a moment, searching out a path through the trees.  You think perhaps you could continue on to the east.");
    set_exits(([
      "northwest" : "/d/laerad/parnelli/forest/for146",
      "east" : ROOMS"path2",
    ]));
