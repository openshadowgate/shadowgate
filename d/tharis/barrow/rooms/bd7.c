...
string lng_fun(string str) {
    if(random(10) > 0) {
	str =
            "%^BLUE%^You stand east of a large burial mound "
	    "within an %^WHITE%^ancient burial field%^BLUE%^. "
	    "To your "
	    "west is the top of the large burial mound. "
...
int exit_fun() {
	...
	+TPQCN+" gets a glazed and strange look on his face "
	"as "+TPSX+" wanders off.%^RESET%^"
    ,TP);
    return 1;
}	
