...
set_indoors(0);
 set_light(2);
 set_short("%^GREEN%^Mystical jungle");
 set_long(
@MELNMARN
...
MELNMARN
 ...
 set_exits(([
	"north":"/d/tharis/barrow/virtual/level1/1,0.level1",
	"south":"/d/tharis/barrow/virtual/level1/3,0.level1"
]));
set_smell("default","You smell jungle air.");
set_listen("default","It is dead silent.");
}
