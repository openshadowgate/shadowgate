...
string ldesc(string str) {
   if(query_night() == 1)
     return("Very little of the moonlight manages to find its "+
	...
	"to the southwest and northeast of here."
   );
   return("All around you, tall pine and majestic oak trees "+
	...
	"rustle all around you as small creatures scurry about.  "+
   	"The path you are on seems to continue northeast and southwest from here, "+
