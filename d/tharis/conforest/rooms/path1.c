...
void create()
{
  ...
  set_long("All around you, tall pine and majestic oak trees "+
   ...
   "The path you are on seems to continue southeast and northwest from here, "+
  ...
  set("night long","Very little of the moonlight manages to find its "+
	...
	"to the northwest and southeast of here.");
  ...
  set_exits(
    ([
    "northwest" : "/d/darkwood/room/road5",
    "southeast" : ROOMS+"path2"
    ]) );
//  call_out("wild",10);
/* moving to have new improved /daemon/monster_d handle placing them
	find_object_or_load("/d/npc/shiper");
	find_object_or_load("/d/npc/thrance");
*/
}
/*
void wild()
