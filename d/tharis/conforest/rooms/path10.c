...
void create()
{
  ...
  set_long("%^ORANGE%^All around you, tall pine and majestic oak %^MAGENTA%^t%^ORANGE%^r%^ORANGE%^e%^ORANGE%^e%^MAGENTA%^s%^ORANGE%^ rise up and block out the majority of the light from above, leaving you little question as to why they call it the Darkwood Forest. A carpet of pine needles stretches out and away from the path. Signs of wildlife are everywhere...birds sing merrily from their perches, and the bushes rustle all around you as small creatures scurry about. The path you are on seems to continue east and west from here, hopefully providing you with safe passage through the forest. A second path branches off from here, heading northeast.
");
  set("night long","%^BLUE%^Very little of the moonlight manages to find its way down to your level, leaving you in almost total darkness. %^MAGENTA%^Tree%^ORANGE%^s%^BLUE%^ rise ominously around you, making you feel as if you're in a closet instead of the open wilderness. An owl hoots in the distance, startling a small creature in the bushes a little ways ahead of you. As best you can tell, the path stretches to the west and east of here. A second path branches off from here, heading northeast.
");
