...
void create() {
        ...
        set_long("%^GREEN%^Barely noticeable as it winds through the trees, this is more of a footpath than a trail. Amongst the conifers grows "
"the occasional %^ORANGE%^nut%^GREEN%^ tree.");
        ...
        set_exits(([
           "south" : ROOMS"elfpath002",
           "northeast" : ROOMS"elfpath004",
        ]));
}
