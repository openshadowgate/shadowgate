...
You worry of the possiblities of what lies in those alcoves. Above you, 
you hear vibrations floating down. You must be below the main street.  
OLI
	);
	set_exits(([
		"east":"/d/tharis/Tharis/sewer13",
		"west":"/d/tharis/Tharis/sewer11",
		"south":"/d/tharis/Tharis/sewer18"
