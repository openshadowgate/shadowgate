...
void create() {
    ...
    set_light(2);
    set_indoors(1); 
   set_short("The top of the tower at the northern edge of the West Wall");
    set_long(
@OLI
        This room is for the watch to keep a lookout over
the North Wall. The majority of the time the room
