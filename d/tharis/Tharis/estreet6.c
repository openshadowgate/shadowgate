...
void init(){
	...
	if(present("elf hater") && !present("elven citizen"))
...
OLI
	...
	set_exits(([
		"west":"/d/tharis/Tharis/estreet5",
		"east":"/d/tharis/Tharis/estreet7",
		"south":"/d/tharis/Tharis/esside1",
		"north":"/d/tharis/Tharis/enside1"
	]));
	set_items(([]));
