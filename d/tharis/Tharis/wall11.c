...
sparsely. The tower at the West Gate is to the south. To the
north is the West Wall.
OLI
    );
   set_smell("default","Your senses are accosted by the normal smells of a city.");
   set_listen("default","The city bustles below you.");
    set_exits(([
"south" : "/d/tharis/Tharis/tower4",
"north" : "/d/tharis/Tharis/wall10",
    ] ));
}
void reset(){
int num;
