...
little about muggers. 
	To the south is the door to a small warehouse.
	
OLI
	);
	set_exits(([
		"east":"/d/tharis/Tharis/wstreet5",
		"west":"/d/tharis/Tharis/wstreet7",
		"south":"/d/tharis/Tharis/warehouse1"
		]));
	set_items(([]));
...
void init(){
    ...
    do_random_encounters(({"/d/tharis/monsters/mugger.c"}),50,1);
}
