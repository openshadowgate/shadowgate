...
be the West gate. To the east is the market place. It appears that now to
the west there are more and more warehouses and to the east you see that
the area becomes more residential. You are not really worried about pick
pockets here but you are worried a little about muggers.
	
OLI
	);
	set_exits(([
		"east":"/d/tharis/Tharis/wstreet2",
		"west":"/d/tharis/Tharis/wstreet4"
		]));
	set_items(([]));
