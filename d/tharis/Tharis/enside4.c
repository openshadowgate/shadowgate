...
void init(){
	...
	do_random_encounters(({"/d/tharis/monsters/ehater"}),25,5);
...
void create(){
	...
	set("short","Northern side street in the Elven quarter");
	set("long",
@OLI
	%^BOLD%^%^YELLOW%^Northern side street in the Elven quarter%^RESET%^
...
OLI
	...
	set_exits(([
		"southwest":"/d/tharis/Tharis/enside3",
		"southeast":"/d/tharis/Tharis/en2side3"
	]));
	set_items(([
		"wall":"A great thick wall placed here for no obvious reason.",
		"mural":"It's a picture of elves herded into this cage."
		]));
