...
is patrolled sparsely. On either side are the northeastern watch 
towers.
OLI
    );
   ...
   set_listen("default","The city bustles below you.");
    set_exits(([
"southeast" : "/d/tharis/Tharis/tower8",
"northwest" : "/d/tharis/Tharis/tower7"
    ] ));
}
void reset(){
int num;
