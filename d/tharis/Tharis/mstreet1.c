...
wealthy houses. The street is lined with locked doors.
	To the east is the Church of Tharis.
OLI
	);
	set_exits(([
		"north":"/d/tharis/Tharis/mstreet2",
		"south":"/d/tharis/Tharis/wstreet2",
		"east":"/d/tharis/Tharis/church"
		]));
	
	set_items(([]));
	
	set_listen("default","You hear only the sounds of the city.");
	set_smell("default","Wafts of baking and household smells circle you.");
}
