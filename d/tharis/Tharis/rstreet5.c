...
void create(){
   ...
   set_short("A street through a wealthy area");
	set("long",
@OLI
	%^BOLD%^%^YELLOW%^Street through the wealthy section%^RESET%^
These are bricked streets that have been well cleaned. Locked doors
line the streets, all adorned with the marks of wealth. The smooth 
red bricks on the road are clean and almost shine. You see an 
occasional coach drive by and are passed by a few security guards as 
you go. 
OLI
	);
	set_exits(([
		"north":"/d/tharis/Tharis/rstreet4",
		"south":"/d/tharis/Tharis/rstreet6"
		]));
	set_items(([]));
