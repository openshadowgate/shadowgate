...
OLI
    ...
    set_items((["floor":"The ground is cluttered  with twigs and leaves.",
                ...
                "ground":"You notice a small silk thread across the paths to the northeast.",
                "thread":"This thread leads off the path and up a tree, you know that this is a trap."
                ]));
    set_exits(([
                "south":TFOREST"forest143",
                "northeast":TFOREST"forest148",
                ]));
    ...
    set_trap_functions(({"northeast"}),({"kill_em"}),({"northeast"}));
}
