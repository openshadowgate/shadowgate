...
OLI
    ...
    set_items((["floor":"The ground is cluttered  with twigs and leaves.",
                ...
                "ground":"You notice a small silk thread across the path to the southeast.",
                "thread":"This thread leads off the path and up a tree, you know that this is a trap."
                ]));
    set_exits(([
                "north":TFOREST"forest142",
                             "southeast":TFOREST"forest108",
                ]));
...
int kill_em(){
    ...
    tell_room(TO,"%^BOLD%^As "+TPQCN+" walks southest "+TP->query_possessive()+" foot catches on something.",TP);
