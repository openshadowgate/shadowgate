...
OLI
    ...
    set_items((["floor":"The ground is cluttered  with twigs and leaves.",
                ...
                "ground":"You notice a small silk thread across the paths to the southwest and southeast.",
                "thread":"This thread leads off the path and up a tree, you know that this is a trap."
                ]));
    set_exits(([
                "north":TFOREST"forest149",
                "southeast":TFOREST"forest144",
                "southwest":TFOREST"forest147",
                ]));
...
int kill_em2(){
    write("%^BOLD%^As you walk southeast you feel your foot catch on something.");
    tell_room(TO,"%^BOLD%^As "+TPQCN+" walks southeast "+TP->query_possessive()+" foot catches on something.",TP);
