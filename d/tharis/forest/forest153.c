...
A clearing appears before you. The ground draws your eye.
OLI
    );
    set_items((["floor":"The ground is cluttered  with twigs and leaves.",
                ...
                "ground":"You notice a small cob web across the path to the southeast.",
                "cobweb":"You notice that it is connected to a bent tree. You would have to disarm the trap to go further."
                ]));
    set_exits(([
                "north":TFOREST"forest154",
                "southeast":TFOREST"forest152",
                ]));
    ...
    set_trap_functions(({"southeast"}),({"kill_em"}),({"southeast"}));
}
