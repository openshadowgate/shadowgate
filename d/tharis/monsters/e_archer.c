...
armor, leggings, and boots camouflage him well.  His sharp ears and 
angled face are worn, yet beautiful.  The time of warring here has left 
him tired.  Being sent to help reclaim this forest for good by his 
elders, he fights evil with the sole purpose of good.
OLI
    );
    set_alignment(1);
    set_race("elf");
