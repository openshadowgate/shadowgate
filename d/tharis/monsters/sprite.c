...
brown trousers and a tree colored tunic. He flitters around lightly on his
dainty wings. However, when provoked by his hatred for evil, he relishes 
its demise.
OLI
	);
	set_class("ranger");
	...
	set_emotes(5,({"The sprite flutters around."}),0);
		}
