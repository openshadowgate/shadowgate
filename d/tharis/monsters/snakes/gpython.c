...
void create(){
	::create();
	set_name("giant python");
	set_id(({"snake","python","Python","giant","giant python"}));
   set_short("A giant python");
	set_long(
@OLI
...
*/
	...
	tell_room(ETO,"%^BOLD%^The constrictor successfully manages to grasp "+capname+" in its thick coils!",targ);
