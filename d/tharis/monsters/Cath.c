//updated by Circe 9/7/04 to interact with evils, also new desc, etc.
#include <daemons.h>
inherit "/std/vendor";
...
void create() {
   ...
   set("aggressive", 0);
   set_level(19);
   set_long("Cath is an aging man with a still-sleek appearance.  "+
        "His salt and pepper hair is worn long, pulled back in a "+
        "ponytail at the base of his neck.  He wears a fine silk "+
