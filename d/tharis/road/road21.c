...
The road and wall are now headed directly to the south. You notice
that you are nearly upon the western gate.
OLI
    );
    set_smell("default","Your senses are accosted by the normal smells of a city.");
    set_listen("default","The city bustles about you.");
    set_exits(([
"north" : "/d/tharis/road/road20",
"south" : "/d/tharis/road/wroad1"
    ] ));
    set_items(([
    ...
    set_dest("/d/tharis/Tharis/wall11");
}
