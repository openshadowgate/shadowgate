...
OLI
    ...
    set_search("default","You find a concealed openning to the south.");
    set_exits(([
"east": "/d/tharis/road/road13",  
"west": "/d/tharis/road/road15",
"south":"/d/tharis/Tharis/sewer1"
    ] ));
   ...
   set_dest("/d/tharis/Tharis/wall4");
}