...
OLI
    ...
    set_exits(([
"west" : "/d/tharis/road/road13",
"east" : "/d/tharis/road/road10"
    ] ));
    set_items(([
       "road" : "The road is deeply rutted by the eons of travle by heavily laden wagons of trade.",
  "wall":"You notice that the base of the wall has been over grown. It looks climbable."
    ] ));
   set_dest("/d/tharis/Tharis/wall2");
}

void reset(){
	::reset();
      if(!present("beggar")) new("d/tharis/monsters/os_beggar")->move(TO);
}