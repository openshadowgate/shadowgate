...
OLI
    ...
    set_exits(([
    "west" : "/d/tharis/road/road12",
    "east" : "/d/tharis/road/road9"
    ] ));
    set_items(([
       "road" : "The road is deeply rutted by the eons of travle by heavily laden wagons oftrade.",
