...
The wall bends to the southwest here. The road and wall are now 
headed directly to the south.
OLI
    );
    set_smell("default","Your senses are accosted by the normal smells of a city.");
    set_listen("default","The city bustles about you.");
    set_exits(([
"northeast" : "/d/tharis/road/road17",
"south" : "/d/tharis/road/road19"
    ] ));
      set_items(([
    ...
    set_dest("/d/tharis/Tharis/wall8");
}