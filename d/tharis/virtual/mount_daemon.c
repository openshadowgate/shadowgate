#define SIZE 40
#define NUMDESCS 6
#define TERRAINPATH "/d/tharis/virtual/mountains/mount.terrain"
#define DESCPATH "/d/tharis/virtual/mountains/mount.desc"
#define EXITPATH "/d/tharis/virtual/mountains/mount.exits"
