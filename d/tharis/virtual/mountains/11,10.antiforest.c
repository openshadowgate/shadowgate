...
void create() {
  ...
  set_exits( ([
    "east": "/realms/grolim/virtual/antiforest/11,11.antiforest",
    "south": "/realms/grolim/virtual/antiforest/12,10.antiforest",
    "northwest": "/realms/grolim/virtual/antiforest/10,9.antiforest"
    ]) );
