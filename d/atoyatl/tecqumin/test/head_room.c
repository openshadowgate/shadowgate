...
#include <terrain.h>
#include "../tecqumin.h"
#define STORE "/realms/lujke/tecqumin/rooms/storage/tec_storage.c"
...
//set_door_description("double doors","A grand set of stone double"
//  +" doors, set beneath massive stone frames.");


//  set_door("stone door",ROOMS+"sac_eq_store","east",0); 
//  set_door_description("stone door","An ancient stone door,"
//    +" balanced somehow on invisible hinges");
//  set_door("door",ROOMS+"vestibule","east",0); 
