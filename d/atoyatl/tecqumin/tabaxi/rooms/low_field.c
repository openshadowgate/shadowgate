...
void create() {
  ...
  set_exits( (["north" : TABAXROOM + "stock_wall1", 
                "south": TABAXROOM + "corner_field2",
                "east": TABAXROOM + "jungle03",
          "southwest" : TABAXROOM + "entry"
          ]) );
  battlement = find_object_or_load(TABAXROOM + "battlement4");
