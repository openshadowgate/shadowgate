...
return ::base_desc() + "%^RESET%^ A broad stone causeway runs east-west through the jungle here. To the east, it leads to a stone bridge across the canal. To the west, it opens out to a large stonr plaza";
