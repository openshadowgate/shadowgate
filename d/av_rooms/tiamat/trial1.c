...
%^BLUE%^It smells crisp and clean.%^RESET%^");
    ...
    set_exits(([ 
		"north" : "/d/av_rooms/tiamat/trial2",
		"south" : "/d/av_rooms/tiamat/trial4",
		"west" : "/d/av_rooms/tiamat/trial5",
		"east" : "/d/av_rooms/tiamat/trial3",
	]));

    set_door("crystal door","/d/av_rooms/tiamat/trial4","south");
    set_open("crystal door",0);
    set_string("crystal door","knock","taps on the stony");
    set_string("crystal door","open","%^BOLD%^%^BLUE%^The door is opened%^RESET%^");
    set_string("crystal door","close","%^BOLD%^%^BLUE%^The door is closed.%^RESET%^");
    set_door_description("crystal door","The other side of the crystal door looks rough and rocky.");
}