...
void create()
{
	...
	"^ suggests that civilized things once lived here, but not for quite some time. A short archway with no door leads east into a landing.%^RESET%^"
	);
...
set_items(([ 
    ...
    set_exits(([ 
		"south" : "/d/av_rooms/tiamat/castle9",
		"west" : "/d/av_rooms/tiamat/castle7",
		"east" : "/d/av_rooms/tiamat/castletower1",
	]));
