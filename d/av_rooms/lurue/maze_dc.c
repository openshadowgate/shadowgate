...
A horrific smell pervades this tunnel.");
    ...
    set_search("water","%^BOLD%^%^BLUE%^You search around in the scummy water but can't seem to find anything that you want to take a closer look at.%^RESET%^");
...
set_items(([ 
    ...
    set_exits(([ 
		...
		"south" : "/d/av_rooms/lurue/maze_out",
	]));
