...
A horrific smell pervades this tunnel.");
    ...
    set_search("water","%^BOLD%^%^RED%^You search around in the scummy water and pull up an old rotten piece of cloth that looks like it might have once been a child's shirt.  There is a tear and a few stains on it that look like they may have been made by dried blood.%^RESET%^");
...
set_items(([ 
    ...
    set_exits(([ 
		"south" : "/d/av_rooms/lurue/maze_c8",
		"southwest" : "/d/av_rooms/lurue/maze_c6",
	]));
