...
void create()
{
    ...
    set_listen("default","The chamber is silent but for the sounds you make.");
    ...
    set_exits(([ 
		...
		"west" : "/d/av_rooms/lurue/selune_under3",
		"east" : "/d/av_rooms/lurue/selune_under5",
		"southwest" : "/d/av_rooms/lurue/selune_under5",
		"northwest" : "/d/av_rooms/lurue/selune_under5",
	]));

    set_door("double doors","/d/av_rooms/lurue/selune_under3","west","moonstone rod","silver door lock");
