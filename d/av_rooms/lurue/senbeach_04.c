...
set_items(([ 
	({ "muscle", "clam", "barnacles", "barnacle", "muscles", "clams" }) : "%^RESET%^Here and there, niches and crevices spring up where the water has dug away at the surrounding stone.  In these relatively calm spots, muscles, clams and barnacles have found purchase and keep hold against the ever shifting tide.  A large crevice in the north wall is especially prevalent with such little creatures.%^RESET%^",
	...
	"crevice" : "%^BOLD%^%^BLACK%^It appears there is a hole in the north wall here, perhaps the start of another passage.  You might be able to wiggle through the wall, if you tried.%^RESET%^",
	]));

    set_exits(([ 
		"north" : "/d/av_rooms/lurue/senbeach_07",
		"south" : "/d/av_rooms/lurue/senbeach_05",
		"hole" : "/d/av_rooms/lurue/senbeach_07",
		"northwest" : "/d/av_rooms/lurue/senbeach_03",
	]));



    set_invis_exits(({ "north", "hole" }));
