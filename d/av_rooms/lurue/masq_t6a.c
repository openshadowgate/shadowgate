...
set_items(([ 
    ...
    set_exits(([ 
		"northeast" : "/d/av_rooms/lurue/masq_t2",
		"north" : "/d/av_rooms/lurue/masq_t60",
		"west" : "/d/av_rooms/lurue/masq_t61",
		"south" : "/d/av_rooms/lurue/masq_t6b",
		"east" : "/d/av_rooms/lurue/masq_t69",
	]));
...
int room_north(string str) {
   if(!present("masq_key_60",TP) && !avatarp(TP)) {
     tell_object(TP,"You can't seem to pass through the doorway. You will need key 60 to enter here.");
     return 0;
   }
...
int room_west(string str) {
   if(!present("masq_key_61",TP) && !avatarp(TP)) {
     tell_object(TP,"You can't seem to pass through the doorway. You will need key 61 to enter here.");
     return 0;
   }
   tell_object(TP,"The key in your hand hums as you pass through the doorway.");
   return 1;
...
int room_east(string str) {
   if(!present("masq_key_69",TP) && !avatarp(TP)) {
     tell_object(TP,"You can't seem to pass through the doorway. You will need key 69 to enter here.");
     return 0;
   }
   tell_object(TP,"The key in your hand hums as you pass through the doorway.");
   return 1;
