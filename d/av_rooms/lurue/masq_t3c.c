...
set_items(([ 
    ...
    set_exits(([ 
		"northeast" : "/d/av_rooms/lurue/masq_t36",
		"south" : "/d/av_rooms/lurue/masq_t3b",
		"north" : "/d/av_rooms/lurue/masq_t35",
		"northwest" : "/d/av_rooms/lurue/masq_t34",
	]));
...
int room_north(string str) {
   if(!present("masq_key_35",TP) && !avatarp(TP)) {
     tell_object(TP,"You can't seem to pass through the doorway. You will need key 35 to enter here.");
     return 0;
   }
...
int room_northeast(string str) {
   if(!present("masq_key_36",TP) && !avatarp(TP)) {
     tell_object(TP,"You can't seem to pass through the doorway. You will need key 36 to enter here.");
     return 0;
   }
   tell_object(TP,"The key in your hand hums as you pass through the doorway.");
   return 1;
...
int room_northwest(string str) {
   if(!present("masq_key_34",TP) && !avatarp(TP)) {
     tell_object(TP,"You can't seem to pass through the doorway. You will need key 34 to enter here.");
     return 0;
   }
   tell_object(TP,"The key in your hand hums as you pass through the doorway.");
   return 1;
