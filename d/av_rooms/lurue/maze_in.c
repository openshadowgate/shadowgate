...
A horrific smell pervades this tunnel.");
    ...
    set_search("water","%^RESET%^%^CYAN%^You begin to search around in the water and find %^ORANGE%^trash%^CYAN%^, %^GREEN%^leaves %^CYAN%^and other %^WHITE%^things %^CYAN%^that have washed down the drain above.%^RESET%^");
...
set_items(([ 
    ...
    set_exits(([ 
		"northeast" : "/d/av_rooms/lurue/maze_a2",
		"up" : "/d/av_rooms/lurue/attaya_10",
		"north" : "/d/av_rooms/lurue/maze_a1",
	]));
