...
set_items(([ 
    ...
    set_exits(([ 
		"southeast" : "/d/av_rooms/lurue/seawreck_d6",
		"up" : "/d/av_rooms/lurue/seawreck_u6",
		"northwest" : "/d/av_rooms/lurue/seawreck_d3",
		"southwest" : "/d/av_rooms/lurue/seawreck_d5",
	]));



    set_invis_exits(({ "up", "up" }));
