...
Dust and rot tingle your nose.");
    ...
    set_search("trash","%^BOLD%^%^BLACK%^You search around in the trash and find a notice for an upcoming battle between %^CYAN%^Urthorta the Ogre%^BLACK%^ and someone called %^BLUE%^Vrox the Destroyer%^BOLD%^%^BLACK%^.  The battle was scheduled for 1 Plantingdays, 581 SG at tenth bell.%^RESET%^");
...
set_items(([ 
    ...
    set_exits(([ 
		"northwest" : "/d/av_rooms/lurue/arena_02",
	]));
