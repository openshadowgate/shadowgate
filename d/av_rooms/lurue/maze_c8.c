...
A horrific smell pervades this tunnel.");
    ...
    set_search("water","%^BOLD%^%^BLACK%^You search around in the scummy water and pull up a dead rat that's partially eaten.  As you hold it, some of it's insides begin to leak out on your hand!%^RESET%^");
...
set_items(([ 
    ...
    set_exits(([ 
		"northeast" : "/d/av_rooms/lurue/maze_bj",
		"south" : "/d/av_rooms/lurue/maze_bl",
	]));
