...
set_items(([ 
    ...
    set_exits(([ 
		"south" : "/d/av_rooms/myrkul/boneyard_south_gate",
		"west" : "/d/av_rooms/myrkul/boneyard_southwest",
		"north" : "/d/av_rooms/myrkul/boneyard_center",
		"east" : "/d/av_rooms/myrkul/boneyard_southeast",
	]));
