...
set_items(([ 
    ...
    set_exits(([ 
		"southeast" : "/d/av_rooms/myrkul/boneyard_southeast_mausoleum",
		"west" : "/d/av_rooms/myrkul/boneyard_south",
		"north" : "/d/av_rooms/myrkul/boneyard_east",
		"northwest" : "/d/av_rooms/myrkul/boneyard_center",
	]));
