...
{
    ::create();
    set_name("boneyard_northwest_home");
...
set_items(([ 
    ...
    set_exits(([ 
		"southeast" : "/d/av_rooms/myrkul/boneyard_northwest",
		"northwest" : "/d/av_rooms/myrkul/location_home",
	]));

    set_door("door","/d/av_rooms/myrkul/location_home","northwest","skeleton key","cast iron lock");
