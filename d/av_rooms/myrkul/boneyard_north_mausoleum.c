...
{
    ::create();
    set_name("boneyard_north_mausoleum");
...
set_items(([ 
    ...
    set_exits(([ 
		"north" : "/d/av_rooms/myrkul/location_mausoleum_north",
		"south" : "/d/av_rooms/myrkul/boneyard_north",
	]));

    set_door("marble door","/d/av_rooms/myrkul/location_mausoleum_north","north","skeleton key","brass lock");
