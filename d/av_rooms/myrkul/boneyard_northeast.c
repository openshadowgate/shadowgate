...
set_items(([ 
    ...
    set_exits(([ 
		"northeast" : "/d/av_rooms/myrkul/boneyard_northeast_mausoleum",
		"west" : "/d/av_rooms/myrkul/boneyard_north",
		"south" : "/d/av_rooms/myrkul/boneyard_east",
		"southwest" : "/d/av_rooms/myrkul/boneyard_center",
	]));
