...
set_items(([ 
    ...
    set_exits(([ 
		"west" : "/d/av_rooms/myrkul/location_manor",
		"east" : "/d/av_rooms/myrkul/boneyard_west",
	]));

    set_door("door","/d/av_rooms/myrkul/location_manor","west","silver key","enchanted lock");
