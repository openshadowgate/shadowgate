...
set_items(([ 
    ...
    set_exits(([ 
		"southeast" : "/d/av_rooms/myrkul/aash_trail12",
		"north" : "/d/av_rooms/myrkul/aash_trail14",
		"southwest" : "/d/av_rooms/myrkul/aash_trail11",
		"grotto" : "/d/av_rooms/myrkul/aash_trail15",
	]));
