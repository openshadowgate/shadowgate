...
set_items(([ 
    ...
    set_exits(([ 
		"northeast" : "/d/av_rooms/myrkul/boneyard_center",
		"north" : "/d/av_rooms/myrkul/boneyard_west",
		"east" : "/d/av_rooms/myrkul/boneyard_south",
		"southwest" : "/d/av_rooms/myrkul/boneyard_southwest_mausoleum",
	]));
