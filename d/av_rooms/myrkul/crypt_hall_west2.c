...
%^BOLD%^%^BLACK%^A m%^YELLOW%^u%^BOLD%^%^BLACK%^sky scent of %^GREEN%^mold%^BOLD%^%^BLACK%^ and ancient st%^WHITE%^o%^BOLD%^%^BLACK%^ne pervades the room.%^RESET%^");
    ...
    set_exits(([ 
		"southeast" : "/d/av_rooms/myrkul/crypt_hall_west1",
		"northeast" : "/d/av_rooms/myrkul/crypt_hall_west3",
		"up" : "/d/av_rooms/myrkul/basement_west",
		"down" : "/d/av_rooms/myrkul/crypt_vault_west",
	]));
