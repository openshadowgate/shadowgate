...
set_items(([ 
    ...
    set_exits(([ 
		"west" : "/d/av_rooms/myrkul/boneyard_east",
		"east" : "/d/av_rooms/myrkul/location_chapel_entry",
	]));

    set_door("chapel doors","/d/av_rooms/myrkul/location_chapel_entry","east","skeleton key","large iron lock");
    add_lock("chapel doors","skeleton key","large iron lock","The large iron lock seems so big, a mischevious child could pick it.");
    set_locked("chapel doors",0,"large iron lock");
    set_open("chapel doors",0);
    set_string("chapel doors","knock","");
    set_string("chapel doors","open","");
    set_string("chapel doors","close","");
    set_door_description("chapel doors","The chapel doors are large, sturdy iron-bound oak double doors with iron rings for handles.");
