...
It smells like ancient skeletons and rotted coffins");
    ...
    set_search("gap","You find a <gap> in the wall through which you might pass.");
    set_search("wall","You find a <gap> in the wall through which you might pass.");
...
set_items(([ 
    ...
    set_exits(([ 
		"up" : "/d/av_rooms/myrkul/crypt_hall_west2",
		"gap" : "/d/av_rooms/myrkul/crypt_archeology_west",
	]));
