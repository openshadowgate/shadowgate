...
{
    ::create();
    set_name("boneyard_southwest_mausoleum");
...
set_items(([ 
    ...
    set_exits(([ 
		"northeast" : "/d/av_rooms/myrkul/boneyard_southwest",
		"southwest" : "/d/av_rooms/myrkul/location_mausoleum_southwest",
	]));

    set_door("marble door","/d/av_rooms/myrkul/location_mausoleum_southwest","southwest","skeleton key","brass lock");
