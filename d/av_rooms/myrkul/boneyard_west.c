...
set_items(([ 
    ...
    set_exits(([ 
		"south" : "/d/av_rooms/myrkul/boneyard_southwest",
		"north" : "/d/av_rooms/myrkul/boneyard_northwest",
		"west" : "/d/av_rooms/myrkul/boneyard_west_manor",
		"east" : "/d/av_rooms/myrkul/boneyard_center",
	]));
