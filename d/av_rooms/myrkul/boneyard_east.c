...
set_items(([ 
    ...
    set_exits(([ 
		"west" : "/d/av_rooms/myrkul/boneyard_center",
		"south" : "/d/av_rooms/myrkul/boneyard_southeast",
		"north" : "/d/av_rooms/myrkul/boneyard_northeast",
		"east" : "/d/av_rooms/myrkul/boneyard_east_chapel",
	]));
