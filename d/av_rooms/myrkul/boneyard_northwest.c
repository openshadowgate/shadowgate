...
set_items(([ 
    ...
    set_exits(([ 
		"southeast" : "/d/av_rooms/myrkul/boneyard_center",
		"south" : "/d/av_rooms/myrkul/boneyard_west",
		"east" : "/d/av_rooms/myrkul/boneyard_north",
		"northwest" : "/d/av_rooms/myrkul/boneyard_northwest_home",
	]));
