...
void create()
{
	...
	"ight to get around. There is a %^BOLD%^%^WHITE%^ladder%^RESET%^ that leads up to a manhole cover, which presumably opens up to the street above."
	);
...
set_items(([ 
    ...
    set_exits(([ 
		"west" : "/d/av_rooms/myrkul/sen_sewer2",
		"up" : "/d/attaya/newseneca/rooms/estreet15",
	]));
