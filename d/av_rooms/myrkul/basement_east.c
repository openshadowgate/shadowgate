...
void create()
{
	...
	"ay continues west into the gloom. The marble floors, wall, and ceiling seem stable enough. The only light here is that which you carry. "
	);
...
You smell nothing.");
    ...
    set_exits(([ 
		"west" : "/d/av_rooms/myrkul/basement_mid",
		"down" : "/d/av_rooms/myrkul/crypt_hall_east2",
	]));
