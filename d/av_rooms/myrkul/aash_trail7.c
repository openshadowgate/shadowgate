...
set_items(([ 
    ...
    set_exits(([ 
		"southeast" : "/d/av_rooms/myrkul/aash_trail6",
		"north" : "/d/av_rooms/myrkul/aash_trail8",
		"ravine" : "/d/av_rooms/myrkul/aash_trail16",
		"southwest" : "/d/av_rooms/myrkul/aash_trail5",
	]));
