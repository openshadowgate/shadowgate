...
%^BOLD%^%^BLACK%^A m%^YELLOW%^u%^BOLD%^%^BLACK%^sky scent of %^GREEN%^mold%^BOLD%^%^BLACK%^ and ancient st%^WHITE%^o%^BOLD%^%^BLACK%^ne pervades the room.%^RESET%^");
    ...
    set_exits(([ 
		"up" : "/d/av_rooms/myrkul/basement_east",
		"down" : "/d/av_rooms/myrkul/crypt_vault_east",
		"southwest" : "/d/av_rooms/myrkul/crypt_hall_east1",
		"northwest" : "/d/av_rooms/myrkul/crypt_hall_east3",
	]));
