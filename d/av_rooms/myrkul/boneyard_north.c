...
set_items(([ 
    ...
    set_exits(([ 
		"north" : "/d/av_rooms/myrkul/boneyard_north_mausoleum",
		"west" : "/d/av_rooms/myrkul/boneyard_northwest",
		"south" : "/d/av_rooms/myrkul/boneyard_center",
		"east" : "/d/av_rooms/myrkul/boneyard_northeast",
	]));
