...
{
    ::create();
    set_name("boneyard_northeast_mausoleum");
...
set_items(([ 
    ...
    set_exits(([ 
		"northeast" : "/d/av_rooms/myrkul/location_mausoleum_northeast",
		"southwest" : "/d/av_rooms/myrkul/boneyard_northeast",
	]));

    set_door("marble door","/d/av_rooms/myrkul/location_mausoleum_northeast","northeast","iron key","iron lock");
