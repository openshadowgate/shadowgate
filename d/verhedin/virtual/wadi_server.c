...
#define BASE "/d/verhedin/virtual/wadi/"
#define SUFFIX ".wadi"
#define DESERT_DAEMON "/d/verhedin/virtual/wadi_daemon.c"
#define MONDIR "/d/verhedin/mon/"
...
string query_smell(string str){
        ...
        if(y > 18)
           ...
           return "You can smell the odor of the river life.";
}
string query_listen(string str){
        ...
        if(y > 19)
                ...
                return "You hear the small waves of the river all around.";
}
