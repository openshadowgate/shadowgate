...
#define BASE "/d/azha/virtual/fort1/"
#define SUFFIX ".fort1"
#define _DAEMON "/d/azha/virtual/fort1_daemon.c"
#define MONDIR "/d/azha/mon/"

#define ENCOUNTERED ({ "/d/antioch/mon/ulord" })
#define ENC_CHANCE 25
...
/*****
 * void init();
 *  -- driver apply that is called whenver an object is moved into this
room
 *****/
void init()
{
  ::init();
  do_random_encounters(ENCOUNTERED,ENC_CHANCE,1);
}
...
string query_smell( string str )
{
  ...
  if ( str != "default" )
    return 0;
      ...
      return "The air smells absolutely rank and putrid.";
 }
...
string query_listen( string str )
{
  ...
  if ( str != "default" )
    return 0;
      ...
      return "It is unnaturally quiet.";
 }
