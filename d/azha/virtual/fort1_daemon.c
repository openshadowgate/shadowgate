/** -*-C++-*- **
 * fort1_daemon.c -- daemon that handles the exits, descriptions, etc for
 *  Dark Tower Random Level 1
 *
 * thorn@shadowgate -- 16 June 2000 -- creation
 *****/
#include <std.h>
#include <daemons.h>
...
/* define some macros... */
#define FILE_TERRAIN   "/d/azha/virtual/fort1/fort1.terrain"
#define FILE_DESC      "/d/azha/virtual/fort1/fort1.desc"
#define FILE_EXITS     "/d/azha/virtual/fort1/fort1.exits"
#define NUMDESCS 2
