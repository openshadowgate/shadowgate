...
// High Mortal area
// Coded by Bane
// added this version for rooms to control their wandering mobs *Styx*
...
string ldesc(string str) {
   return("You are standing in an underground cavern system.  A small stream "+
	...
	"a strange flourescent yellow and lighting up the area.  Stalagtites "+
...
// added check for cursed items to not be dropped  *Styx*  9/8/02
		...
		return; 
            moving->force_me("drop "+inven[b]->query_name());
        }
      }
    }
}
