...
void create(){
	...
	"a strange fluorescent yellow and lighting up the area.  A couple tables "+
	"are set up across the room, covered in glass tubes and beakers.  This "+
	"room looks as though it was once used as a lab of some sort."
    );
