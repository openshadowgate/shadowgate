...
void create()
{
    ...
    set_long(
        ...
        "and stalagmites litter the ceilings and floor.  There are bones and " +
        "numerous other random items lying around this cave."
        );
    ...
    set_exits(([
                   "northeast" : "/d/laerad/cavern1/cav066"
               ]));
}

/*void reset(){ //Muln used to be here, she's not anymore.
    ::reset();
    if(!present("dragon")){
    new("/d/laerad/mon/dragon")->move(this_object());
    }
   }*/
