...
void create(){
	...
	"\nTo the southwest are what appears to be animal pens."
    );
    ...
    set_exits( ([
	"southwest":"/d/laerad/cavern1/cav091",
	"southeast":"/d/laerad/cavern1/cav102",
	"northeast":"/d/laerad/cavern1/cav101"
    ]) );
}
