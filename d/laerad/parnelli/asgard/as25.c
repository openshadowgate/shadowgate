...
*/
   set_long(::query_long()+"\nThis is the ruins of a small home. An old wooden "
      "table is overturned here, partially crushed by the fallen stone and wood.\n");
    set_exits( ([
	"west":"/d/laerad/parnelli/asgard/as15"
    ]) );
}
