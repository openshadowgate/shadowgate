...
You are standing in a guard tower.  The walls are lined with bows and swords "+
	...
	"the circular room.  An exit to the northwest leads back into the "+
	"central market square while an exit to the northeast leads "+
...
*/
    ...
    set_exits( ([
	"northwest":"/d/laerad/parnelli/asgard/as75",
	"northeast":"/d/laerad/parnelli/asgard/tower12"
    ]) );
}
/*
void reset(){
