...
You are standing in a back alley.  Trash litters the street and dirty water "+
	...
	"more dark alleys to the west, east and north.  Off in the distance you "+
	"can see a guard tower to the southwest and the city wall to the south."
    );
...
*/
    set_exits( ([
	"east":"/d/laerad/parnelli/asgard/as77",
	"north":"/d/laerad/parnelli/asgard/as80",
	"southwest":"/d/laerad/parnelli/asgard/tower5",
	"west":"/d/laerad/parnelli/asgard/as79"
    ]) );
}
/*
void reset(){
