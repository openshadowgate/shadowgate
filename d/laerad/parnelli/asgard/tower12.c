...
You are standing in a guard tower.  The walls are lined with bows and swords "+
	...
	"circular room.  An exit to the northeast leads back onto South "+
	"Thunder road while an exit to the southwest leads into another "+
	"guard tower."
    );
...
*/
    ...
    set_exits( ([
	"northeast":"/d/laerad/parnelli/asgard/as57",
	"southwest":"/d/laerad/parnelli/asgard/tower10"
    ]) );
}
/*
void reset(){
