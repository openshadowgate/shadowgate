...
You are standing in a back alley.  Trash litters the street and dirty water "+
	...
	"more dark alleys to the east and south.  Off in the distance you "+
	"can see the city wall to the north."
    );
...
*/
    set_exits( ([
	"east":"/d/laerad/parnelli/asgard/as81",
	"northwest":"/d/laerad/parnelli/asgard/as42",
	"south":"/d/laerad/parnelli/asgard/as83"
    ]) );
}
/*
void reset(){
