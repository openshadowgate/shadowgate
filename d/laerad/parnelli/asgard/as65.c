...
/*
   ...
   set_travel(PAVED_ROAD);
	...
	"%^BOLD%^Central market square%^RESET%^\n"+
      "You have walked into Asgard's central market "+
      "square.  The streets are mobbed "+
	...
	"see hundreds of tents and carts set up alongside the roads.  Just to "+
      "the west, a simple wooden door stands open, leading into a "+
      "humble shop.\n"
    );
...
*/
    ...
    set_exits( ([
	"east":"/d/laerad/parnelli/asgard/as70",
	"north":"/d/laerad/parnelli/asgard/as47",
	"southwest":"/d/laerad/parnelli/asgard/as77",
      "west" : "/d/laerad/parnelli/asgard/asgardpsicomps"
    ]) );
}
/*
void reset(){
    ::reset();
    if(!present("vendor")){
	new("/d/laerad/mon/vendor")->move(TO);
    }
}
*/