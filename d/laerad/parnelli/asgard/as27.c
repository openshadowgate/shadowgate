...
*/
   set_long(::query_long()+"\nFilling this small space is a collection of worn "
      "furniture and broken wood.  Little else remains of what was once a small home.\n");
    set_exits( ([
	"east":"/d/laerad/parnelli/asgard/as22"
    ]) );
}
/*
void reset(){
