...
You are standing in a back alley.  The cobblestone street leads northwest "+
	"back to Nirvana avenue and further into the alley east.  You can see "+
	"the backs of a few houses to the north and the city wall to the south."
    );
...
*/
    set_exits( ([
	"east":"/d/laerad/parnelli/asgard/as32",
	"northwest":"/d/laerad/parnelli/asgard/as30"
    ]) );
}
