...
You are standing in a guard tower.  The walls are lined with bows and swords "+
	...
	"the circular room.  An exit to the west leads back into the street "+
	"alley and there is another guard tower to the east."
    );
...
*/
    ...
    set_exits( ([
	"west":"/d/laerad/parnelli/asgard/as32",
	"east":"/d/laerad/parnelli/asgard/tower5"
    ]) );
}
/*
void reset(){
