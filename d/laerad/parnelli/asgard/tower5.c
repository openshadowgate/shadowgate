...
You are standing in a guard tower.  The walls are lined with bows and swords "+
	...
	"the circular room.  An exit to the northeast leads back into the "+
	"the alley and there is another guard tower to the west."
    );
...
*/
    ...
    set_exits( ([
	"west":"/d/laerad/parnelli/asgard/tower4",
	"northeast":"/d/laerad/parnelli/asgard/as78"
    ]) );
}
/*
void reset(){
