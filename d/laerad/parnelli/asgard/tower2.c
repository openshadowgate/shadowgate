...
You are standing in a guard tower.  The walls are lined with bows and swords "+
	...
	"the circular room.  The guards barracks are to the northwest and "+
	"there is an exit into the street to the southeast."
    );
...
*/
    ...
    set_exits( ([
	"northwest":"/d/laerad/parnelli/asgard/as14",
	"southeast":"/d/laerad/parnelli/asgard/as30"
    ]) );
}
/*
void reset(){
