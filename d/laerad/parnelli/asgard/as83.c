...
You are standing in a back alley.  Trash litters the street and dirty water "+
	...
	"more dark alleys to the west, east and north.  You notice a few homeless "+
	"people wandering through the alley."
    );
...
*/
    set_exits( ([
	"east":"/d/laerad/parnelli/asgard/as84",
	"north":"/d/laerad/parnelli/asgard/as82",
	"west":"/d/laerad/parnelli/asgard/as85"
    ]) );
}
