...
*/
   set_long(::query_long()+"\nThe old wooden table and crushed remains of a stove "
      "show that this was once a house.  Now, it is no more than a pile of rubble.\n");
    set_exits( ([
	"east":"/d/laerad/parnelli/asgard/as21"
    ]) );
}
