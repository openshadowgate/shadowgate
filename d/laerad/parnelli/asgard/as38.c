...
*/
   set_long(::query_long()+"\nThe rubble here has been pounded into the ground, "
      "leaving the ground a mix of mud and stone.  Little else can be seen in "
      "what was once a home.\n");
    set_exits( ([
	"west":"/d/laerad/parnelli/asgard/as30"
    ]) );
}
