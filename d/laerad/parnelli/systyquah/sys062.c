...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the northwest, southwest and east "+
    ...
    set_exits( ([
        "southwest":"/d/laerad/parnelli/systyquah/sys063",
	"east":"/d/laerad/parnelli/systyquah/sys105",
	"northwest":"/d/laerad/parnelli/systyquah/sys061"
    ]) );
}
