...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the east, west and southeast here.  "+
    ...
    set_exits( ([
        "west":"/d/laerad/parnelli/systyquah/sys050",
	"east":"/d/laerad/parnelli/systyquah/sys053",
        "southeast":"/d/laerad/parnelli/systyquah/sys052"
    ]) );
}
