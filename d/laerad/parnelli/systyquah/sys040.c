...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the northeast and northwest here.  "+
        "You can see a large wooden hut to the northeast side of the "+
    ...
    set_exits( ([
        "northwest":"/d/laerad/parnelli/systyquah/sys039",
	"northeast":"/d/laerad/parnelli/systyquah/hut07"
    ]) );
}
