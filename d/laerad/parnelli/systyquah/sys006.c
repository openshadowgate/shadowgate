...
You are standing on the central road of Systyquah.  The street "+
	"forks to the northeast and southeast here, leading into "+
    ...
    set_exits( ([
	"west":"/d/laerad/parnelli/systyquah/sys033",
	"northeast":"/d/laerad/parnelli/systyquah/sys005",
	"southeast":"/d/laerad/parnelli/systyquah/sys008"
    ]) );
}
