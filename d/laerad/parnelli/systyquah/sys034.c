...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the west, north and southwest here.  "+
    ...
    set_exits( ([
        "west":"/d/laerad/parnelli/systyquah/sys035",
        "southwest":"/d/laerad/parnelli/systyquah/sys047",
	"north":"/d/laerad/parnelli/systyquah/sys033"
    ]) );
}
