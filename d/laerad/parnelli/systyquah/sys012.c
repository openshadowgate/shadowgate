...
You are standing on one of the central roads of Systyquah.  The "+
        "street leads off to the west, south and northeast here.  "+
    ...
    set_exits( ([
        "west":"/d/laerad/parnelli/systyquah/sys041",
        "south":"/d/laerad/parnelli/systyquah/sys014",
        "northeast":"/d/laerad/parnelli/systyquah/sys010"
    ]) );
}
