...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the east, west and north "+
    ...
    set_exits( ([
        "west":"/d/laerad/parnelli/systyquah/sys066",
	"east":"/d/laerad/parnelli/systyquah/sys065",
	"north":"/d/laerad/parnelli/systyquah/sys063"
    ]) );
}
