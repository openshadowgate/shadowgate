...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the southeast and southwest here.  "+
        "You can see a large wooden hut to the southeast side of the "+
    ...
    set_exits( ([
        "southwest":"/d/laerad/parnelli/systyquah/sys045",
	"southeast":"/d/laerad/parnelli/systyquah/hut09"
    ]) );
}
