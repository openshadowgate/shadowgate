...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the west and south here.  "+
        "You can see a large wooden hut to the west side of the "+
    ...
    set_exits( ([
        "west":"/d/laerad/parnelli/systyquah/hut01",
        "south":"/d/laerad/parnelli/systyquah/sys023"
    ]) );
}
