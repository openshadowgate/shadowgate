...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the east, northwest and southwest "+
    ...
    set_exits( ([
        "east":"/d/laerad/parnelli/systyquah/sys036",
        "southwest":"/d/laerad/parnelli/systyquah/sys039",
	"northwest":"/d/laerad/parnelli/systyquah/sys038"
    ]) );
}
