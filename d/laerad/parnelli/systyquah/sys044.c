...
You are standing on one of the back roads of Systyquah.  The "+
        ...
        "You can see a large wooden hut to the north side of the "+
    ...
    set_exits( ([
        "west":"/d/laerad/parnelli/systyquah/sys085",
	"east":"/d/laerad/parnelli/systyquah/sys043",
	"north":"/d/laerad/parnelli/systyquah/hut08"
    ]) );
}
