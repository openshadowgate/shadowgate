...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the northeast, west and south here.  "+
    ...
    set_exits( ([
        "northeast":"/d/laerad/parnelli/systyquah/sys052",
	"west":"/d/laerad/parnelli/systyquah/sys055",
	"south":"/d/laerad/parnelli/systyquah/sys057"
    ]) );
}
