...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the east and southwest "+
        "here.  You can see a large wooden hut to the "+
    ...
    set_exits( ([
        "east":"/d/laerad/parnelli/systyquah/sys102",
	"north":"/d/laerad/parnelli/systyquah/sys065",
	"southwest":"/d/laerad/parnelli/systyquah/hut15"
    ]) );
}
