...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the northeast, west and south "+
        "here.  You can see a large wooden hut to the west side "+
    ...
    set_exits( ([
        "northeast":"/d/laerad/parnelli/systyquah/sys057",
	"west":"/d/laerad/parnelli/systyquah/hut12",
	"south":"/d/laerad/parnelli/systyquah/sys059"
    ]) );
}
