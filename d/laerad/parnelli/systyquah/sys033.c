...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the east, south and north here.  "+
    ...
    set_exits( ([
        "east":"/d/laerad/parnelli/systyquah/sys006",
        "south":"/d/laerad/parnelli/systyquah/sys034",
	"north":"/d/laerad/parnelli/systyquah/sys024"
    ]) );
}
