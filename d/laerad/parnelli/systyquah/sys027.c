...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the east, south and northwest here.  "+
    ...
    set_exits( ([
        "east":"/d/laerad/parnelli/systyquah/sys026",
        "south":"/d/laerad/parnelli/systyquah/sys028",
	"northwest":"/d/laerad/parnelli/systyquah/sys030"
    ]) );
}
