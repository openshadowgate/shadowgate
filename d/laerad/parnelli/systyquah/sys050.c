...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the east, north and southwest here.  "+
    ...
    set_exits( ([
	"north":"/d/laerad/parnelli/systyquah/sys115",
	"east":"/d/laerad/parnelli/systyquah/sys051",
        "southwest":"/d/laerad/parnelli/systyquah/sys049"
    ]) );
}
