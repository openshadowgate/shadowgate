...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the east, northwest and southwest here.  "+
    ...
    set_exits( ([
        "east":"/d/laerad/parnelli/systyquah/sys054",
	"northwest":"/d/laerad/parnelli/systyquah/sys049",
	"southwest":"/d/laerad/parnelli/systyquah/sys056"
    ]) );
}
