...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the south, east and north here.  "+
    ...
    set_exits( ([
        "east":"/d/laerad/parnelli/systyquah/hut03",
        "south":"/d/laerad/parnelli/systyquah/sys036",
	"north":"/d/laerad/parnelli/systyquah/sys028"
    ]) );
}
