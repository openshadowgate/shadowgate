...
You are standing on one of the back roads of Systyquah.  The "+
        "street leads off to the northeast, northwest and south here.  "+
    ...
    set_exits( ([
        "northwest":"/d/laerad/parnelli/systyquah/sys043",
        "northeast":"/d/laerad/parnelli/systyquah/sys046",
	"south":"/d/laerad/parnelli/systyquah/sys090"
    ]) );
}
