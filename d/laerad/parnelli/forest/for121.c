...
void create(){
	...
	"that you just don't ever want to leave.  The village of Systyquah "+
	"is to the south."
    );
    set_exits( ([
	"west":"/d/laerad/parnelli/forest/for108",
	"east":"/d/laerad/parnelli/forest/for132",
	"south":"/d/laerad/parnelli/systyquah/sys001",
	"north":"/d/laerad/parnelli/forest/for120",
    ]) );
}
