...
void create(){
    ...
    set_exits( ([
	"east":"/d/laerad/parnelli/forest/for045",
	"northeast":"/d/laerad/parnelli/forest/for044",
	"west":"/d/laerad/parnelli/forest/for025",
	"south":"/d/laerad/parnelli/forest/for035"
    ]) );
}
