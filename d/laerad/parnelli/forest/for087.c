...
void create(){
	...
	"to the north."
	"\nThere is a large cave mouth in the mountain side."
    );
    set_exits( ([
	"east":"/d/laerad/parnelli/forest/for099",
	"west":"/d/laerad/parnelli/forest/for076",
        "south":"/d/laerad/parnelli/forest/for088",
        "cave":"/d/laerad/cavern1/cave"
    ]) );
}
