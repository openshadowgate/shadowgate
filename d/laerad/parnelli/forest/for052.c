...
void create(){
	...
	"off to the west.  A large stone bridge has been built here for people "+
	"to cross over the water."
    );
    set_exits( ([
	"bridge":"/d/laerad/parnelli/forest/for041",
	"north":"/d/laerad/parnelli/forest/for051",
	"south":"/d/laerad/parnelli/forest/for053",
        "east":"/d/laerad/parnelli/forest/for062"
    ]) );
}
void reset(){
    ::reset();
