...
#define EXTRAS ({ MOB+"tlin1", MOB+"tlin2", MOB+"tlin3", MOB+"tlin4", MOB+"tlin5", MOB+"cildabrin", MOB+"tshala", MOB+"flailer", MOB+"gearth", MOB+"hordling", MOB+"hordling" })
...
void create() {
    ...
    set_short("%^BOLD%^%^BLACK%^The Gods Plains");
}
