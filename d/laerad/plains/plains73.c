...
void create(){
    ::create();
    set_long(::query_long()+"\n"
       "To the south, a murky, sulfurous %^RESET%^river %^BOLD%^%^BLACK%^cuts "
    ...
    add_item("river","The murky waters of the river might be gray or "
       ...
       "sulfurous scent.");
    set_exits( ([
	"west":"/d/laerad/plains/plains65",
	"east":"/d/laerad/plains/plains78",
//	"south":"/d/laerad/SWAMP",
	"north":"/d/laerad/plains/plains72"
    ]) );
}
