...
//    set_ac(3); taken care of in the inherit
    ...
    set_lore("These bracers are known as bracers of defense, as they "+
       ...
       "have.  The gnomish artificer, Karionflindus Ficklefingers, "+
       "in the 1st century SG crafted wonderous magical bracers that "+
       "could even act as additional hands for the wearer, doing such "+
       "mundane tasks as pulling spell components from pouches or "+
       "loading a bow with an arrow.");
}
