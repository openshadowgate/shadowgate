...
void create(){
   ...
   set_long(
         ...
         "%^ORANGE%^This simple shop features walls of planks "+
   ...
   set_items( ([
      ...
      ({"counter","wooden counter"}) : "A bleached wooden counter "+
   ...
   set_exits(([
      ...
      "west" : "/d/laerad/parnelli/asgard/psicrystal"
   ]));
   set_door("inlaid door","/d/laerad/parnelli/asgard/psicrystal","west",0);
   set_door_description("inlaid door","%^ORANGE%^Crafted from "+
