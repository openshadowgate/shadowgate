...
void create()
{
	...
	"into the depths of the darkness or find a way to open the %^RED%^rusty "+
	...
	set_exits(([
		"down" : KEEPR + "dungeon10", "up" : KEEPR + "towerNW2",
    	] ));
	set_door("rusty door",KEEPR + "towerNW2","up","blacktongue master key","lock");
