//	/realms/pator/castle/castleE7.c
...
set_listen("default","You hear not much, but maybe you notice some mouses behind the walls.");
    set_exits(([
       "south" : CASTLE+"castleE6.c",
       "west"  : CASTLE+"castleE8.c",
    ] ));
    set_items(([
       "hole" : (: "mouse_hole" :),
