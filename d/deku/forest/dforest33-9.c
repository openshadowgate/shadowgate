...
void create() {
    ...
    "large %^BLUE%^lake%^BOLD%^%^BLACK%^ is visible to the "+
    "southeast of here.%^RESET%^");
    ...
    set_exits(([
       ...
       "north" : F_ROOMS"33-10",
       "south" : F_ROOMS"33-8",
       "southeast" : F_ROOMS"32-8",
       "southwest" : F_ROOMS"34-8",
       "northeast" : F_ROOMS"32-10",
       "northwest" : F_ROOMS"34-10",
    ] ));
}
