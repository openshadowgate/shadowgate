...
inherit "/d/deku/hhouse/inherits/test/container.c";
inherit "/d/deku/hhouse/inherits/test/exits.c";
inherit "/d/deku/hhouse/inherits/test/battle.c";
inherit "/d/deku/hhouse/inherits/test/items";
inherit "/d/deku/hhouse/inherits/test/senses";
...
{	
    mixed tmp2;
    //object tmp;
    //tmp = find_player("saide");
	log_file("deku_code", "@@START@@\n room.c before container ::create\n");
    
    container::create();
    
    log_file("deku_code", "@@END@@\n room.c after container ::create\n");
    log_file("deku_code", "@@START@@\n room.c before exits ::create\n");
    
    exits::create();
    
    log_file("deku_code", "@@END@@\n room.c after exits ::create\n");
    log_file("deku_code", "@@START@@\n room.c before battle ::create\n");
    
    battle::create();
    
    log_file("deku_code", "@@END@@\n room.c after battle ::create\n");
    log_file("deku_code", "@@START@@\n room.c before items ::create\n");
    
    items::create();
    
    log_file("deku_code", "@@END@@\n room.c after items ::create\n");
    log_file("deku_code", "@@START@@\n room.c before senses ::create\n");
    
    senses::create();
    
    log_file("deku_code", "@@END@@\n room.c after senses ::create\n");
...
{
  object *ppl;
  log_file("deku_code", "@@RESET@@START\n room.c before container::reset \n");   
  //container::reset();
  log_file("deku_code", "@@RESET@@END\n room.c after container::reset call\n");
   do_room_stuff();
  
   log_file("deku_code", "@@RESET@@START\n room.c END of reset function \n");
   return;
}
