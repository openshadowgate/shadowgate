...
void create() {
    ...
    (string)EVENTS_D->query_time_of_day() == "night" && !random(2)) { 
     switch(random(10)) {
      case 0:
        break;
      case 1:
...
void headstone_desc() {
    if((string)EVENTS_D->query_time_of_day() != "night") { 
        ...
        "than garble and completely illegible.%^RESET%^";
    }
    ...
    "discover what names once adorned them.%^RESET%^";
}
