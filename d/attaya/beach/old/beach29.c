...
void create() {
    ...
    set_long("
    The beach extends to the north and south as far as you can see.  It is quite lonely.  The ocean crashes against a barrier of tar covered natural rocks to the east.  To the west, the jungle towers above you, casting shadows over the beach.  It is nearly impenetrable.
");
    ...
    set_exits(([
       ...
       "north" : "/d/attaya/beach30",
       "south" : "/d/attaya/beach28",
