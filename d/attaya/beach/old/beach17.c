...
void create() {
    ...
    set_long("
    Several small buildings lie on the northern side of a road that begins here and curves around a fence.  The fence starts here and extends eastward until the road reconnects to the beach and fades away.
    You are standing on the beach.  The sand is very dry here and the ocean is a fair distance to the south.  
