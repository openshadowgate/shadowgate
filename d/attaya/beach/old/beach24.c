...
void create() {
    ...
    set_long("
    The beach extends to the north as far as you can see.  Not far to the south, the beach curves away to the west.  It is quite lonely.  The ocean crashes against a barrier of tar covered natural rocks to the east.  To the west, the jungle towers above you, casting shadows over the beach.  It is nearly impenetrable.
");
