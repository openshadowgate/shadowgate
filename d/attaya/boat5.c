...
void create() {
     ...
     set_long("
%^RED%^
    The vessel shall go no further.  You are at the other side of the molten river.  A shiny black stone staircase climbs the rocky cliff face here.  Looking up, A massive dark tower rises from atop the cliff.  It is heavily shrouded by the thick smoke.
