...
of the street has stood up to a lot of wear. The %^CYAN%^Scribe's 
Office%^RESET%^ is to the west.
DESC
   );
   set_items( ([
   ...
   set_exits( ([
      "north" : "/d/attaya/seneca/road9",
      "south" : "/d/attaya/seneca/road11",
      "west" : "/d/attaya/seneca/scribe"
   ]) );
}
