...
of the street has stood up to a lot of wear. The side of
a building is on the north side of the road.
DESC
   );
   set_items( ([
   ...
   set_exits( ([
      "east" : "/d/attaya/seneca/road19",
      "west" : "/d/attaya/seneca/road21",
   ]) );
}
