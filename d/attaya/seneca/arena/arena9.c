...
set_name("%^BOLD%^%^RED%^The arena floor.%^RESET%^");
 set_short("The Arena at Seneca");
  set_long("
    ...
    A large circle of stakes draped with scorched skeletal remains lies to the west at the center of the arena floor.
...
set_smell("default","The smoke from torches burns your nose.");
    set_exits( ([
"south" : "/d/attaya/seneca/arena/arena12.c",
"north" : "/d/attaya/seneca/arena/arena7.c",
    ]) );
}
