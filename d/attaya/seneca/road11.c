...
of the street has stood up to a lot of wear. The %^CYAN%^Alchemist%^RESET%^ 
is to the west.
DESC
   );
   set_items( ([
   ...
   set_exits( ([
      "north" : "/d/attaya/seneca/road10",
      "south" : "/d/attaya/seneca/road12",
      "west" : "/d/attaya/seneca/alchemist"
   ]) );
}
