//moved dock to sandy beach closer to Seneca per Tristan - Styx 8/24/01
...
void create() {
    ...
    set_long("
    You stand at the foot of a old and now abandoned wooden pier that extends out into the choppy seas.  The beach around you is rugged, and littered with large boulders and stone fragments, many having the appearance of having been hand carved.
    ...
    The abandoned pier creaks behind you.
...
");
    ...
    set_exits(([
       "southwest" : "/d/attaya/beach2",
       "northeast" : "/d/attaya/beach1n",
//      "dock":"/d/shadow/virtual/sea/attaya.dock",
    ...
    set_items(([
         ...
         "pier" : "The abandoned pier still stretches defiantly into the ocean.  Its rotting boards supported by powerful driven stone pillars.  The waves cover the end of the pier occasionally!",
    ] ));
}
