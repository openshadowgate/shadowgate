...
void create(){
    ...
    set_items(([
	"paintings" : "There are three paintings here. One is of a mother, father, son, and daughter. You are struck by the family resemblance. The next painting of of the parents and son. The daughter is strangely absent from this picture. The last painting is of the daughter alone. She looks about 16 years of age, and she is wearing a bright %^RED%^crimson%^RESET%^ dress. Her hair is black and her eyes are bright blue.",

      ]));

    set_exits(([
	"out" : "/d/attaya/newseneca/thiefyard.c",
	"north" : THIEF "thief5",
	"west" : THIEF "thief3",
	"east" : THIEF "thief4",
      ]));
    set_door("door", "/d/attaya/newseneca/thiefyard", "out", 0);
    set_open("door", 0); 
