//wstreet ~Circe~ 11/23/07
//Western thoroughfare around Seneca, runs N-S
#include <std.h>
#include "../seneca.h"
...
void create(){
   ...
   set_name("Rosa Terrace");
   set_short("Rosa Terrace");
   set_long("%^BOLD%^%^MAGENTA%^Rosa Terrace, Seneca%^RESET%^\n"+
      "This broad thoroughfare runs north and south along the western "+
      ...
      "in a zig-zagging pattern.  Lining the eastern side of the "+
      "street at intervals are ornate %^BOLD%^%^BLACK%^"+
      "street lamps%^RESET%^ to light the way at night, while the "+
      "western edge of the street is bounded by the rough %^BOLD%^co"+
