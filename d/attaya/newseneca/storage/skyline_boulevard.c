//sol_boulevard.c ~Circe~ 10/31/07 (originally named Skyline)
//Main thoroughfare through Seneca - runs N-S
#include <std.h>
#include "../seneca.h"
...
void create(){
   ...
   set_name("Sol Boulevard");
   set_short("Sol Boulevard");
   set_long("%^YELLOW%^Sol Boulevard, Seneca%^RESET%^\n"+
      "This broad thoroughfare runs north and south through the city "+
