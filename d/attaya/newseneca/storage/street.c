//street ~Circe~ 11/21/07
//Northern thoroughfare around Seneca, runs E-W
#include <std.h>
#include "../seneca.h"
...
void create(){
   ...
   set_name("Azul Avenue");
   set_short("Azul Avenue");
   set_long("%^BOLD%^%^BLUE%^Azul Avenue, Seneca%^RESET%^\n"+
      "This broad thoroughfare runs east and west along the northern "+
      ...
      "in a zig-zagging pattern.  Lining the southern side of the "+
      "street at intervals are ornate %^BOLD%^%^BLACK%^"+
      "street lamps%^RESET%^ to light the way at night, while the "+
      "northern edge of the street is bounded by the rough %^BOLD%^co"+
