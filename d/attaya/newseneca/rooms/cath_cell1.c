//cath_cell1.c - monk's cell of the cathedral
//for new Seneca ~Circe~ 2/03/08
#include <std.h>
#include "../seneca.h"
...
void create() {
   ...
   set_door("door","/d/attaya/newseneca/rooms/cath_hall2","east",0);
   set_door_description("door","%^ORANGE%^The simple oaken door "+
      "set in the eastern wall is lightly varnished and has a "+
