//barracks_housing2 - Barracks for new Seneca
//~Circe~ 12/7/07
#include <std.h>
#include "../seneca.h"
...
void create(){
   ...
   set_long("%^BOLD%^%^WHITE%^Men's Dormitory of the Guard Barracks, Seneca%^RESET%^\n"+
      ...
      "wooden wall %^RESET%^that protrudes from the northern wall, "+
      "housing the %^ORANGE%^doorway %^RESET%^that leads "+
      "to the %^ORANGE%^stairway%^RESET%^.  Taking a quick "+
   ...
   set_exits(([
      "down" : ROOMS"barracks_housing1"
   ]));
   set_door("stairway door","/d/attaya/newseneca/rooms/barracks_housing1","down",0,0);
