...
void create(){
   ...
   set_name("puka shell bracelet");
   set_id(({"bracelet","puka bracelet","shell bracelet","puka shell bracelet"}));
   set_short("a "+COLOR+" puka shell bracelet%^RESET%^");
   set_long("This bracelet is crafted entirely from "+COLOR+" puka "+
      ...
      "of the cord are left long so the bracelet may be tied on.");
   set_type("ring");
