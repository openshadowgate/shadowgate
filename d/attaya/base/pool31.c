...
void create() {
   ...
   %^BLUE%^You are in a small boat floating in the reflection pool.  The waters lap against the hull almost melodically.
    %^RED%^The wall of the red marble platform is just to the north of you and a magnificent marble and gold bridge spans the pool to the west.%^RESET%^
...
set_listen("default", "%^BOLD%^%^MAGENTA%^A small boat is here.\n");
   set_exits( ([
       "west" : "/d/attaya/base/pool30",
       "south" : "/d/attaya/base/pool43",
       "east" : "/d/attaya/base/pool32"
]) );
    set_items( ([
