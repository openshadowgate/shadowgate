...
void create() {
    ...
    set_short("Just inside the magnificent crystalline tower.");
    set_long("
     You are just inside the unbelievable crystalline tower.  The wall at your back, comprised of hundreds upon thousands of glass panels, stretches upwards out of view.  Within the room of nearly unimaginable proportions are hundreds of transparent platforms no more than a meter thick each that seem to simply float in various spots!
    You are standing upon a small bridge that links the soul chamber with this main hall.  A reflection pool of shallow water moves silently beneath you and seems to surround the entire floor in here between the main walls and the center of the room.
...
");
    ...
    set_exits( ([
    "south" : "/d/attaya/base/base2",
    "north" : "/d/attaya/base/soulchamber",
        ]) );
    set_items(([
