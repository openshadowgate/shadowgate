...
void create() {
   ...
   %^BLUE%^You are in a small boat floating in the reflection pool.  The waters lap against the hull almost melodically.
    %^RED%^The wall of the red marble platform is just to the south of you, and a low bridge blocks further sailing to the east.%^RESET%^
...
set_listen("default", "%^BOLD%^%^MAGENTA%^A small boat is here.\n");
   set_exits( ([
       "west" : "/d/attaya/base/pool10",
       "north" : "/d/attaya/base/pool5"
]) );
    set_items( ([
