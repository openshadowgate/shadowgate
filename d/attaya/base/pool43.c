...
void create() {
   ...
   %^BLUE%^You are in a small boat floating in the reflection pool.  The waters lap against the hull almost melodically.
    ...
    A magnificent marble and walnut bridge spans the reflection pool to the west.  It connects to a large door in the fortress!
...
set_listen("default", "%^BOLD%^%^MAGENTA%^A small boat is here.\n");
   set_exits( ([
       "west" : "/d/attaya/base/pool42",
       "east" : "/d/attaya/base/pool44",
       "north" : "/d/attaya/base/pool31"
]) );
    set_items( ([
