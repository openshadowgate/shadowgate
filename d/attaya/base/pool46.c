...
void create() {
   ...
   %^BLUE%^You are in a small boat floating in the reflection pool.  The waters lap against the hull almost melodically.
    %^YELLOW%^A great pillar rises from the water to the east to a height of about 25 feet above the waterline.  It is hard to tell from here, but it almost looks like it has been made to communicate from as it is easily visible from the main platform.
    %^CYAN%^The great fortress wall of the tower rises out of view just to the south.%^RESET%^
...
set_listen("default", "%^BOLD%^%^MAGENTA%^A small boat is here.\n");
   set_exits( ([
       "west" : "/d/attaya/base/pool45",
       "north" : "/d/attaya/base/pool34",
       "east" : "/d/attaya/base/pool47"
]) );
    set_items( ([
