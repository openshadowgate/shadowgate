...
void create() {
     ...
     set_long("
    You stand at the northern edge of the great red marble platform at the center of the crystalline tower's base.  Before you stretches a reflection pool that extends to the inside of the tower's northern wall.
...
set_listen("default", "The water seems to crackle like parchment.\n");
   set_exits( ([
       "west" : "/d/attaya/base/base5",
       "east" : "/d/attaya/base/base7",
       "south" : "/d/attaya/base/base14"
]) );
    set_items( ([
