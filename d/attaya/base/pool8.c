...
void create() {
   ...
   %^BLUE%^You are in a small boat floating in the reflection pool.  The waters lap against the hull almost melodically.
    %^RED%^The wall of the red marble platform is just to the south of you.%^RESET%^
...
set_listen("default", "%^BOLD%^%^MAGENTA%^A small boat is here.\n");
   set_exits( ([
       "west" : "/d/attaya/base/pool7.c",
       "east" : "/d/attaya/base/pool9.c",
       "north" : "/d/attaya/base/pool2.c"
]) );
    set_items( ([
