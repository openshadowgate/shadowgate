...
void create() {
     ...
     set_long("
    You stand at the eastern edge of the great red marble platform at the center of the crystalline tower's base.  Before you stretches a reflection pool that extends to the inside of the tower's eastern wall.
...
set_listen("default", "The water seems to crackle like parchment.\n");
   set_exits( ([
       "north" : "/d/attaya/base/base34",
       "west" : "/d/attaya/base/base41",
       "south" : "/d/attaya/base/base50"
]) );
    set_items( ([
