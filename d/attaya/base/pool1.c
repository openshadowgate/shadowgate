...
void create() {
   ...
   %^YELLOW%^A great pillar rises from the water just to the west.  There is a metal rung ladder fastened to it on it's southern side.
...
set_listen("default", "%^BOLD%^%^MAGENTA%^A small boat is here.\n");
   set_exits( ([
       "east" : "/d/attaya/base/pool2",
       "south" : "/d/attaya/base/pool7"
]) );
    set_items( ([
