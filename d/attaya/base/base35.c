...
void create() {
     ...
     set_long("
    You stand at the western edge of the great red marble platform at the center of the crystalline tower's base.  Before you stretches a reflection pool that extends to the inside of the tower's western wall.
...
set_listen("default", "The water seems to crackle like parchment.\n");
   set_exits( ([
       "north" : "/d/attaya/base/base27",
       "east" : "/d/attaya/base/base36",
       "south" : "/d/attaya/base/base43"
]) );
    set_items( ([
...
.\n");
this_player()->move_player("/d/attaya/base/oubliette14",);
return 1;
}
