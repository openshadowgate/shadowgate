...
set_items( ([
        ...
        "platform" : "The grand central platform is not too far away to the southwest.  Wyverns move about upon it.",
...
this_player()->move_player("/d/attaya/base/pool52");
...
.\n");
this_player()->move_player("/d/attaya/base/oubliette12",);
return 1;
}
