...
void create() {
     ...
     set_long("
    You are standing atop one of the large marble pillars in the reflection pool.  There is quite a view from up here and you take a moment to look over your surroundings.  At your back is the southern wall fortress and the reflection pool stretches out before you.  To the northeast, hundreds of wyverns scurry around the central platform.
...
set_items( ([
        ...
        "platform" : "The grand central platform is not too far away to the northeast.  Wyverns move about upon it.",
...
this_player()->move_player("/d/attaya/base/pool36");
...
.\n");
this_player()->move_player("/d/attaya/base/oubliette43",);
return 1;
}
