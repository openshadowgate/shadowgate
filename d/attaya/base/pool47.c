...
set_smell("default", "%^BOLD%^%^MAGENTA%^A small boat is here.");
   set_exits( ([
       "northwest" : "/d/attaya/base/pool34",
       "west" : "/d/attaya/base/pool46",
       "north" : "/d/attaya/base/pool35"
]) );
set_items( ([
...
this_player()->move_player("/d/attaya/base/pillar2");
...
.\n");
this_player()->move_player("/d/attaya/base/oubliette8",);
return 1;
}
