...
set_smell("default", "%^BOLD%^%^MAGENTA%^A small boat is here.");
   set_exits( ([
       "northeast" : "/d/attaya/base/pool1",
       "east" : "/d/attaya/base/pool7",
       "south" : "/d/attaya/base/pool12"
]) );
set_items( ([
...
this_player()->move_player("/d/attaya/base/warp");
...
.\n");
this_player()->move_player("/d/attaya/base/oubliette36",);
return 1;
}
