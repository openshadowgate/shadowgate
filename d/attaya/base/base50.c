...
void create() {
     ...
     set_long("
    This is the southeast corner of the grand marble platform.  The reflection pool glimmers to the south and to the east.  In the corner of this great hall, across the water, you can make out the top of a large pillar that is protruding from the water against the wall.  It is large enough to walk around upon.
...
set_listen("default", "The water seems to crackle like parchment.\n");
   set_exits( ([
       "west" : "/d/attaya/base/base49",
       "north" : "/d/attaya/base/base42"
]) );
    set_items( ([
...
void reset(){
   object mon;
   ::reset();
    if(!present("golden wyvern")) {
         mon = new("/d/attaya/mon/gwyvern");
