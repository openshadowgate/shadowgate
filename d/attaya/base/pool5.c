...
void create() {
   ...
   %^BLUE%^You are in a small boat floating in the reflection pool.  The waters lap against the hull almost melodically.
    %^CYAN%^The great wall of the tower rises out of view just to the north and a low bridge blocks further sailing to the east.%^RESET%^
...
set_listen("default", "%^BOLD%^%^MAGENTA%^A small boat is here.\n");
   set_exits( ([
       "west" : "/d/attaya/base/pool4",
       "south" : "/d/attaya/base/pool11"
]) );
    set_items( ([
