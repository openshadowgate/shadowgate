...
void create() {
   ...
   %^BLUE%^You are in a small boat floating in the reflection pool.  The waters lap against the hull almost melodically.
    %^CYAN%^The great wall of the tower rises out of view just to the north, and the dock lies directly to the south.%^RESET%^
...
set_listen("default", "%^BOLD%^%^MAGENTA%^A small boat is here.\n");
   set_exits( ([
       "west" : "/d/attaya/base/pool48",
       "east" : "/d/attaya/base/pool50",
       "south" : "/d/attaya/base/pool54"
]) );
    set_items( ([
