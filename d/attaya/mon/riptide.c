...
create() {
    ...
    set_emotes(5,({
	"Riptide nods to you.",
	"%^BOLD%^%^CYAN%^Riptide whispers to you: %^RESET%^Simply motion to me and I shall assume the form of the mist and carry you to the Tower of the Black Dawn",
	"%^BOLD%^%^CYAN%^Riptide whispers to you: %^RESET%^Only death awaits you over there.",
