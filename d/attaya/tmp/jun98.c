...
set_long("
    ...
    An algae covered lake lies to the northeast.  Several dead trees rise from its waters and you can see a small temple on the other side..
");
       set_exits(([
         "north":"/d/attaya/jun102",
         "south":"/d/attaya/jun94.c",
         "east":"/d/attaya/jun99",
]));
...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/archer.c","/d/attaya/mon/archer2.c","/d/attaya/mon/phalanx.c","/d/common/mon/scorpion.c","/d/attaya/mon/nightstalker.c","/d/attaya/mon/poltergeist.c", "/d/attaya/mon/uwarrior.c","/d/attaya/mon/toclahar.c","/d/common/mon/necrophidius.c"}),30,6);
}
