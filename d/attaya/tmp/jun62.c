...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/bwyvern.c","/d/attaya/mon/solstice.c", "/d/attaya/mon/uwarrior.c","/d/common/mon/spiritdancer.c","/d/common/mon/necrophidius.c"}),50,3);
}
