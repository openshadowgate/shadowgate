...
");
       set_exits(([
         "north":"/d/attaya/jun98",
          "south":"/d/attaya/jun88",
         "west":"/d/attaya/jun93",
         "east":"/d/attaya/jun95",
]));
...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/archer.c","/d/attaya/mon/nightstalker.c","/d/attaya/mon/poltergeist.c", "/d/attaya/mon/uwarrior.c","/d/attaya/mon/toclahar.c","/d/common/mon/necrophidius.c"}),30,6);
}
