...
");
       set_exits(([
         "north":"/d/attaya/jun89",
          "south":"/d/attaya/jun79",
         "west":"/d/attaya/jun83",
         "east":"/d/attaya/jun85",
]));
...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/phalanx.c","/d/attaya/mon/nightstalker.c","/d/attaya/mon/poltergeist.c", "/d/attaya/mon/uwarrior.c","/d/attaya/mon/toclahar.c","/d/common/mon/necrophidius.c"}),30,6);
}
