...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/nightstalker.c","/d/attaya/mon/solstice.c", "/d/attaya/mon/uwarrior.c","/d/attaya/mon/toclahar.c","/d/common/mon/necrophidius.c"}),30,6);
}
