...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/nightstalker.c","/d/attaya/mon/poltergeist.c", "/d/attaya/mon/phalanx.c","/d/attaya/mon/toclahar.c","/d/common/mon/necrophidius.c"}),30,6);
}
