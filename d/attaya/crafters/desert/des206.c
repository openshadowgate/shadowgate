...
set_exits(([
"northwest" : "/d/attaya/crafters/desert/des186.c",
"northeast" : "/d/attaya/crafters/desert/des187",
"southwest" : "/d/attaya/crafters/desert/Odes227.c",
"southeast" : "/d/attaya/crafters/desert/des228.c",

]));

set_smell("default", "You can smell nothing.");
set_listen("default", "You can hear faint noises to the southwest.");
