...
set_exits(([
"northwest" : "/d/attaya/crafters/desert/Odes227",
"northeast" : "/d/attaya/crafters/desert/des228",
"southwest" : "/d/attaya/crafters/desert/des271.c",
"southeast" : "/d/attaya/crafters/desert/des272.c",

]));

set_smell("default", "You can smell nothing.");
set_listen("default", "You can hear faint noises to the northwest.");
