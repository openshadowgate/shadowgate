...
void create() {
    ...
    set_long("
    One of the most feared creatures of the deserts is the Earwig Scorpion.  The Earwig Scorpion builds large sandtraps in the desert that catch pray that happens to wander into the area.  They grapple their pray with enormous twenty foot pincers and pull them under the sand.  They also have a scorpion like sting.
");
