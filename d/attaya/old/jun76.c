...
set_long("
    ...
    An old stone building stands crumbled in the foliage around you...  You are just inside its decaying walls.
...
");
       set_exits(([
         "north":"/d/attaya/jun83",
          "south":"/d/attaya/jun75",
         "west":"/d/attaya/jun77",
         "east":"/d/attaya/jun79",
]));
...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/nightstalker.c","/d/attaya/mon/entity.c", "/d/attaya/mon/uwarrior.c","/d/attaya/mon/toclahar.c","/d/attaya/mon/necrophidius.c"}),50,6);
}
