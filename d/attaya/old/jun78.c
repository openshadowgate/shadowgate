...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/entity.c","/d/attaya/mon/scorpion.c", "/d/attaya/mon/uwarrior.c","/d/attaya/mon/toclahar.c","/d/attaya/mon/necrophidius.c"}),30,6);
   reset();
   do_random_encounters(({"/d/attaya/mon/solstice.c"}),10,1);
}
