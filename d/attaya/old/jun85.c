...
");
       set_exits(([
         "north":"/d/attaya/jun90",
          "south":"/d/attaya/jun80",
         "west":"/d/attaya/jun84",
         "east":"/d/attaya/jun86",
]));
...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/phalanx.c","/d/attaya/mon/nightstalker.c","/d/attaya/mon/poltergeist.c", "/d/attaya/mon/uwarrior.c","/d/attaya/mon/toclahar.c","/d/attaya/mon/necrophidius.c"}),30,6);
}
