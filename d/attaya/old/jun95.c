...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/phalanx","/d/attaya/mon/nightstalker","/d/attaya/mon/poltergeist", "/d/attaya/mon/uwarrior","/d/attaya/mon/toclahar","/d/islands/common/mon/necrophidius"}),30,6);
}
