...
");
       set_exits(([
         "north":"/d/attaya/jun95",
          "south":"/d/attaya/jun84",
         "west":"/d/attaya/jun88",
         "east":"/d/attaya/jun90",
]));
...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/phalanx.c","/d/attaya/mon/nightstalker.c","/d/attaya/mon/poltergeist.c", "/d/attaya/mon/uwarrior.c","/d/attaya/mon/toclahar.c","/d/islands/common/mon/necrophidius.c"}),30,6);
}
