...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/phalanx","/d/attaya/mon/nightstalker","/d/attaya/mon/poltergeist", "/d/attaya/mon/guardian","/d/attaya/mon/toclahar","/d/islands/common/mon/necrophidius"}),30,6);
   reset();

  do_random_encounters(({"/d/attaya/mon/solstice"}),10,2);
}
