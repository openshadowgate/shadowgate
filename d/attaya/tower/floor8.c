...
void create(){
   ...
   set_property("no teleport",1);
       set_short("Metal catwalk over rushing water");
        set_long("%^BLUE%^Metal catwalk over %^BLUE%^r%^BOLD%^%^BLUE%^ush%^RESET%^%^BLUE%^i%^BOLD%^%^BLUE%^ng %^BLUE%^wa%^RESET%^%^BLUE%^t%^BLUE%^e%^BOLD%^%^BLUE%^r%^RESET%^
%^BLUE%^You are walking along a metal mesh catwalk about a hundred feet over %^BLUE%^f%^BLUE%^a%^BOLD%^%^BLUE%^st %^BLUE%^m%^RESET%^%^BLUE%^o%^BOLD%^%^BLUE%^vi%^RESET%^%^BLUE%^n%^BOLD%^%^BLUE%^g %^BLUE%^wat%^RESET%^%^BLUE%^e%^BOLD%^%^BLUE%^r.%^RESET%^%^BLUE%^ It makes you extremely nervous to look down because far beneath the thin meshwork of the catwalk, the entire surface is moving southward in a rush. There are wooden planks that have been nailed to the catwalk that lead across to open doors to the north and south. You long to find more secure ground.");
