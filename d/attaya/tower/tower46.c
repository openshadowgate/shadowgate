//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 46
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^RESET%^%^MAGENTA%^purple %^BOLD%^%^WHITE%^crystal "+
	  "hovers here.%^RESET%^\n");
   ...
   set_exits(([
      "northwest":TWR"tower45",
	  "southeast":TWR"tower47",
   ]));
}
