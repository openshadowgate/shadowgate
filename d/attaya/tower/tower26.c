//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 26
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^CYAN%^turquoise %^WHITE%^crystal hovers here.%^RESET%^\n");
   ...
   set_exits(([
      "southwest":TWR"tower25",
	  "northeast":TWR"tower27",
   ]));
}
