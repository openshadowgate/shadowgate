//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 34
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^RESET%^%^ORANGE%^amber %^WHITE%^crystal hovers here.%^RESET%^\n");
   ...
   set_exits(([
      "northeast":TWR"tower33",
      "southeast":TWR"tower35",
   ]));
}
