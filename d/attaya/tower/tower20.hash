...
");
set_listen("default", "%^CYAN%^A remarkable aquamarine crystal floats here");
    set_exits(([
      "southwest" : "/d/attaya/tower/tower19",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^CYAN%^aquamarine",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower24",);
return 1;
}
