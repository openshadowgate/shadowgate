...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^BOLD%^%^BLACK%^dark %^WHITE%^crystal hovers here.%^RESET%^\n");
