//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 55
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^An %^RESET%^%^BLUE%^indigo %^BOLD%^%^WHITE%^crystal hovers "+
	  "here.%^RESET%^\n");
   ...
   set_items(([
      "crystal" : "%^BOLD%^The crystal glistens and adds a spark of "+
		 ...
		 "brilliant %^RESET%^%^BLUE%^indigo%^BOLD%^%^WHITE%^.%^RESET%^",
