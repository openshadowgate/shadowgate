...
void create(){
   ...
   set_property("no teleport",1);
    ...
    A nearby doorway has been bricked up on the east wall.
");
       set_listen("default", "There is an uneasy calm in the stale air.");
       set_exits(([
       "north" : "/d/attaya/tower/hall28",
       "south" : "/d/attaya/tower/hall30",
]));
       set_items(([
...
void init() {
  ::init();
  do_random_encounters(({"/d/attaya/mon/poltergeist.c"}),35,1);
}
