//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 62
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^An %^RESET%^%^GREEN%^emerald %^BOLD%^%^WHITE%^crystal "+
	  "hovers here.%^RESET%^\n");
