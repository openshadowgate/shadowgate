//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 57
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^An %^RESET%^%^BLUE%^indigo %^BOLD%^%^WHITE%^crystal hovers here.%^RESET%^\n");
