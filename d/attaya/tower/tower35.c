//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 35
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^RESET%^%^RED%^ruby %^BOLD%^%^WHITE%^crystal hovers "+
	  "here.%^RESET%^\n");
