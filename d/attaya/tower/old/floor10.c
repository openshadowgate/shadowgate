...
void create(){
   ...
   set_property("no teleport",1);
       set_short("Southeast guard tower");
        set_long("
    This is a round room with open doors to the north and east.  It has been set up as a guard tower in the midst of the chamber.
    A wooden plank is nailed to the floor here and extends to the north to a metal catwalk.
");
     set_listen("default", "Water roars around far below this room.");
       set_exits(([
       "out" : "/d/attaya/tower/floor8",
       "east" : "/d/attaya/tower/floor7",
]));
       set_items(([
