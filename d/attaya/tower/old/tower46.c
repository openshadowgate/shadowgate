...
");
set_listen("default", "%^BOLD%^%^MAGENTA%^A remarkable purple crystal floats here");
    set_exits(([
      "northwest" : "/d/attaya/tower/tower45",
      "southeast" : "/d/attaya/tower/tower47",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^BOLD%^%^MAGENTA%^purple%^RESET%^.",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower44",);
return 1;
}
