...
void create(){
   ...
   set_property("no teleport",1);
       set_short("Metal catwalk over rushing water");
        set_long("
    You are walking along a metal mesh catwalk about a hundred feet over fast moving water.  It makes you extremely nervous to look down because far beneath the thin meshwork of the catwalk, the entire surface is franticly moving southward in a rush.
    The main wall to this chamber lies just to the east.  An opening in the wall reveals a staircase leading up to the library.
