...
");
set_listen("default", "%^GREEN%^A remarkable emerald crystal floats here");
    set_exits(([
      "northwest" : "/d/attaya/tower/tower54",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^GREEN%^emerald",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower62",);
return 1;
}
