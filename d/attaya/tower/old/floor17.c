...
void create(){
   ...
   set_property("no teleport",1);
       set_short("End of the passage");
        set_long("
    This is a large room that opens out into the vast chamber to the east.  Beyond partial dividers to the north and south, the room continues and is endcapped by strange dark walls.  There is no railing at this center portion to protect you from falling into the watery depths to the east.
    It may be wise not to stand too close.
");
