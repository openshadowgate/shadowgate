...
");
set_listen("default", "%^BOLD%^%^BLUE%^A remarkable blue crystal floats here");
    set_exits(([
      "southwest" : "/d/attaya/tower/tower41",
      "southeast" : "/d/attaya/tower/tower43",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^BOLD%^%^BLUE%^blue%^RESET%^.",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower70",);
return 1;
}
