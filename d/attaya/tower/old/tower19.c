...
");
set_listen("default", "%^ORANGE%^A remarkable amber crystal floats here");
    set_exits(([
      "northeast" : "/d/attaya/tower/tower20",
      "southwest" : "/d/attaya/tower/tower18",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^ORANGE%^AMBER",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower34",);
return 1;
}
