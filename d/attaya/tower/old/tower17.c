...
");
set_listen("default", "%^BOLD%^%^RED%^A remarkable vermillion crystal floats here");
    set_exits(([
      "northeast" : "/d/attaya/tower/tower18",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^BOLD%^%^RED%^vermillion%^RESET%^.",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower36",);
return 1;
}
