...
");
set_listen("default", "%^BOLD%^%^YELLOW%^A remarkable golden crystal floats here");
    set_exits(([
      "southwest" : "/d/attaya/tower/tower48",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^BOLD%^%^YELLOW%^golden%^RESET%^.",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower71",);
return 1;
}
