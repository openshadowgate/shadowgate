...
set_listen("default", "%^BLUE%^A remarkable dark crystal floats here");
    set_exits(([
      "northeast" : "/d/attaya/tower/tower60",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^BLUE%^dark",
...
.\n");
this_player()->move_player("/d/attaya/tower/hallroof",);
return 1;
}
