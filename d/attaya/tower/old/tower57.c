...
");
set_listen("default", "%^MAGENTA%^A remarkable indigo crystal floats here");
    set_exits(([
      "southwest" : "/d/attaya/tower/tower58",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^MAGENTA%^indigo",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower55",);
return 1;
}
