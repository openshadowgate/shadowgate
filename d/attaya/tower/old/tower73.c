...
void create() {
     ...
     set_long("
    You stand atop a clear crystal platform that is floating high above the ground in an incredibly vast chamber with glass walls.  All around you, are similiar such platforms hovering in this chamber, but they are too far away to jump to.  All the platforms are clear like ice and you can see all the way to the ceiling and the floor through them.  
    Through the glass windows, you can see the entire island of Attaya and the sorrounding ocean.  You feel so very tiny in here.
...
");
    set_exits(([
       "northwest" : "/d/attaya/tower/tower71",
       "southwest" : "/d/attaya/tower/tower54",
       "northeast" : "/d/attaya/tower/tower70",
   ] ));
   set_items(([
