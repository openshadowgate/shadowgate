...
");
set_listen("default", "%^BOLD%^%^CYAN%^A remarkable turquoise crystal floats here");
    set_exits(([
      "southwest" : "/d/attaya/tower/tower25",
      "northeast" : "/d/attaya/tower/tower27",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^BOLD%^%^CYAN%^turquoise%^RESET%^.",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower40",);
return 1;
}
