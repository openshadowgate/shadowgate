...
");
set_listen("default", "%^RED%^A remarkable ruby crystal floats here");
    set_exits(([
      "northwest" : "/d/attaya/tower/tower34",
   ] ));
   set_items(([
         "crystal" : "The crystal glistens and adds a spark of color to this otherwise transparent scene.  It shines a brilliant %^RED%^ruby",
...
.\n");
this_player()->move_player("/d/attaya/tower/tower16",);
return 1;
}
