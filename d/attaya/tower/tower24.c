//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 24
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^RESET%^%^CYAN%^aquamarine %^WHITE%^crystal hovers "+
	  "here.%^RESET%^\n");
   ...
   set_items(([
      "crystal" : "%^BOLD%^The crystal glistens and adds a spark of "+
		 ...
		 "brilliant %^RESET%^%^CYAN%^aquamarine%^WHITE%^.%^RESET%^",
