//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 19
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^RESET%^%^ORANGE%^amber %^BOLD%^%^WHITE%^crystal "+
	  "hovers here.%^RESET%^\n");
   set("night long","%^BOLD%^A floating quartz platform%^RESET%^\n "+
      ...
      "%^BLUE%^.\n "+
	  "%^BLUE%^A %^ORANGE%^amber %^BLUE%^crystal hovers here.%^RESET%^\n");
   set_items(([
   ...
   set_exits(([
      "northeast":TWR"tower20",
	  "southwest":TWR"tower18",
   ]));
}
