//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 70
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^BLUE%^blue %^WHITE%^crystal hovers here.%^RESET%^\n");
   ...
   set_exits(([
      "southwest":TWR"tower73",
	  "southeast":TWR"tower55",
   ]));
}
