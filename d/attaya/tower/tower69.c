//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 69
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^GREEN%^green %^WHITE%^crystal hovers here.%^RESET%^\n");
