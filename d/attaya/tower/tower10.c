//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 10
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^WHITE%^white crystal hovers here.%^RESET%^\n");
