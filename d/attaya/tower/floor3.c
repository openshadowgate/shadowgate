...
void create(){
   ...
   set_property("no teleport",1);
       set_short("Floor of the library");
        set_long("%^ORANGE%^Floor of %^ORANGE%^th%^CYAN%^e %^CYAN%^l%^ORANGE%^i%^CYAN%^b%^ORANGE%^rary
%^ORANGE%^You climb a couple small steps to get to this part of the %^BOLD%^%^ORANGE%^fl%^RESET%^%^ORANGE%^o%^BOLD%^%^ORANGE%^or.%^RESET%^%^ORANGE%^ It is a slightly raised area that looks out over the library. A %^BLUE%^h%^BLUE%^u%^BLUE%^g%^BLUE%^e %^BLUE%^g%^BOLD%^%^GREEN%^lobe%^RESET%^%^ORANGE%^ and a %^WHITE%^s%^CYAN%^ta%^WHITE%^r %^WHITE%^c%^WHITE%^h%^WHITE%^a%^CYAN%^r%^WHITE%^t%^ORANGE%^ stand here. A brass %^ORANGE%^r%^CYAN%^a%^ORANGE%^il%^CYAN%^i%^ORANGE%^n%^CYAN%^g%^ORANGE%^ surrounds them. There is dust on everything and you get the feeling that people don't come down here often. The ceiling is far above you, and shadowy forms slip around the railings of the next level up. Their glistening silvery eyes peer down upon you and their hatred can be felt in their gaze.");
       set_exits(([
