//Octothorpe (1/14/10)
//Attaya, Crystal Platform Room 71
...
void create(){
   ...
   set_long("%^BOLD%^A floating quartz platform\n "+
      ...
      "%^WHITE%^.\n "+
	  "%^BOLD%^A %^YELLOW%^golden %^WHITE%^crystal hovers here.%^RESET%^\n");
