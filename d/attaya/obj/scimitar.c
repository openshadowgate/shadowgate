...
AVATAR
	...
	set_lore(
@AVATAR
This is a heavy drow weapon, designed for an individual warrior. The runes obviously appear to be drow, but it lacks the subtlety of typical drow weapons. It's as if drow made this weapon to pollute the human world.
