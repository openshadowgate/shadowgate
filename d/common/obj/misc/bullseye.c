...
void create() {
  ::create();
    ...
    set_long(
@STYX
A deluxe model of bullseye lantern to light up the dark times.  It has a reflector that helps focus the light.  It lasts longer than the beacon and hooded, but doesn't light an area as well as the beacon.  It has a sight-glass along the side so you can <check> the approximate amount of fuel remaining.
STYX
);
    set_weight(2);
    set_value(30);
...
int check_fuel(string str) {
   ...
   switch(fuel) {
      case 3400..4000:
         ETO->more("/d/common/text/bslantern_full");
         break;
      case 2400..3399:
         ETO->more("/d/common/text/bslantern_three-fourths");
         break;
      case 1100..2399:
         ETO->more("/d/common/text/bslantern_half");
         break;
      case 100..1099:
         ETO->more("/d/common/text/bslantern_one-fourth");
         break;
      case 1..99:
