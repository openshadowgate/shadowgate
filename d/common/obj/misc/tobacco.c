...
void set_uses(int myuses) { loads = myuses; }
int query_con_check() { return min_con; }
void set_con_check(int mycon) { min_con = mycon; }
int query_has_messages() { return hasmsgs; }
void set_has_messages() { hasmsgs = 1; }
void set_my_messages(string *themsgs) { mymsgs = themsgs; }
void set_your_messages(string *themsgs) { yourmsgs = themsgs; }
string *query_my_messages() { return mymsgs; }
string *query_your_messages() { return yourmsgs; }
int is_tobacco() { return 1; }
void set_intox(int myintox) { intox = myintox; }
