...
being watched.  To the south there appears to be an
impenetratable dark, black barrier.  And to the east you just
barely take notice of a small hidden building.
...
STOP
       ...
       set_exits((["east":"/d/cursed/cursed1.c",
                   "west":"/d/cursed/cursed5.c"]));
