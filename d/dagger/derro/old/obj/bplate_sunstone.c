...
void create(){
   ...
   set_short("%^RESET%^%^ORANGE%^S%^BOLD%^u%^RESET%^%^ORANGE%^n"+
      "%^BOLD%^s%^RESET%^%^ORANGE%^t%^BOLD%^o%^RESET%^%^ORANGE%^n"+
      "%^BOLD%^e Breastplate%^RESET%^");
   set_long("%^RESET%^%^ORANGE%^This flawless breastplate is fashioned "+
      "from a single %^RESET%^%^ORANGE%^s%^BOLD%^u%^RESET%^%^ORANGE%^n"+
      "%^BOLD%^s%^RESET%^%^ORANGE%^t%^BOLD%^o%^RESET%^%^ORANGE%^n"+
      "%^BOLD%^e%^RESET%^%^ORANGE%^.  The outer surface is completely "+
      ...
      "%^RESET%^%^ORANGE%^s%^BOLD%^u%^RESET%^%^ORANGE%^n"+
      "%^BOLD%^s%^RESET%^%^ORANGE%^t%^BOLD%^o%^RESET%^%^ORANGE%^n"+
      "%^BOLD%^e %^RESET%^%^ORANGE%^backplate.  The two join together "+
      "at the sides and shoulders seamlessly, encasing the wearer in "+
      "a protective %^RESET%^%^ORANGE%^s%^BOLD%^u%^RESET%^%^ORANGE%^n"+
      "%^BOLD%^s%^RESET%^%^ORANGE%^t%^BOLD%^o%^RESET%^%^ORANGE%^n"+
      "%^BOLD%^e %^RESET%^%^ORANGE%^shell.%^RESET%^");
   set_lore("The Sunstone Breastplate is naturally a favorite "+
      "among the Lathandrites, but it is also valued by any who "+
      "prize the golden yellow color.  Many Grumbarians and Talosians "+
      "have favored sunstones as well.  These breastplates are "+
