...
void create(){
  ...
  set_long(  "%^RED%^Barracks%^RESET%^\n"
  "  This massive room continues far off to the south and west and appears to be the living quarters for numerous huge creatures.  Great curtains partition off the room and behind these lay individual beds and great chests."
  ...
  set_listen("default",
  "Hot air rushes by from the west filling the room with the low murmur of shifting curtains."
  );
  set_items(([
  "floor":"The floor looks carved from the bedrock of the mountains.",
  "curtains":"Woven of some rough cloth these are large enough to cover most human sized huts.   The material is course and worthless and its great size makes it impossible to move.",
...
void init(){
  ::init();
  do_random_encounters(({  MON"derro1.c",MON"derro2.c",MON"derro3.c" }),25,6);
}
