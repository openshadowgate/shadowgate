...
void create(){
  ...
  "lava":"It leads right up to the paths face but the walls look impossible to climb here.",
  "path":"It's up above you and the slick glassy face is impossible to climb here!",
  ]));
  set_exits(([
  "north":ROOMS"c29",
  "west":ROOMS"lavapit",
...
void heart_beat(){
  ...
  if(objectp(TO) && objectp(heat[i])) { heat[i]->remove_attacker(TO); }
  }
}
