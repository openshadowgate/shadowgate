...
set ("day long", "%^ORANGE%^You travel southeastward, towards the centre of the city.  You are leaving behind the shops but hear music and laughter ahead of you.%^RESET%^");
set ("night long", "%^CYAN%^You travel southeastward, towards the centre of the city.  You are leaving behind the shops but hear music and laughter ahead of you.%^RESET%^");
set_smell ("default", "%^MAGENTA%^\nYou smell the forest, green and alive.");
set_listen ("default", "You hear laughter, music and singing coming from ahead of you.");
set_exits (([
"northwest" : "/d/dagger/Elvanta/forest/room122",
"southeast" : "/d/dagger/Elvanta/forest/room124"
]));
set_items
(([
