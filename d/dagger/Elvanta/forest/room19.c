...
set ("night long", "%^ORANGE%^As you pause to look at the <walkway> by the light of the hanging globes, you can't help but notice the fine workmanship once again.  The vines themselves are a wonder to behold as they weave themselves into wooden <planks>.%^RESET%^");
...
set_exits (([
"northeast" : "/d/dagger/Elvanta/forest/room20",
"north" : "/d/dagger/Elvanta/forest/roomH1",
"southwest" : "/d/dagger/Elvanta/forest/room18"
]));
set_items
(([
