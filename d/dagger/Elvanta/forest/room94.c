...
set ("day long", "%^ORANGE%^Here a lumpish figure lies slumped down within a doorway, asleep in a drunken stupor, his clothes stripped from his body, his purse gone.%^RESET%^");
set ("night long", "%^CYAN%^Here a lumpish figure lies slumped down within a doorway, asleep in a drunken stupor, his clothes stripped from his body, his purse gone.%^RESET%^");
set_smell ("default", "%^MAGENTA%^\nFetid odours rise from the victim.");
set_listen ("default", "Moans, grumbles, cries for help fill the gloom.");
set_exits (([
"north" : "/d/dagger/Elvanta/forest/room95",
"south" : "/d/dagger/Elvanta/forest/room93"
]));
set_items
(([
