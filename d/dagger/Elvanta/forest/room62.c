...
set ("day long", "%^ORANGE%^The <walkway> has just come through a very large <tree>.  To either side of you is 'The Knightly Inn',  and you can pause here for refreshments, laughter and sleep.  Someone is a good business person as you have to go through the Inn to keep on the path.  hmmm, Smart idea.%^RESET%^");
set ("night long", "%^CYAN%^The <walkway> has just come through a very large <tree>.  To either side of you is 'The Knightly Inn', and you can pause here for refreshments, laughter and sleep.  Someone is a good business person as you have to go through the Inn to keep on the path. hmmmm Smart idea.%^RESET%^");
set_smell ("default", "%^MAGENTA%^\nThe smell of ale, food, and pipe smoke fills the air.");
set_listen ("default", "The singing, off key, the sound of laughter and music is louder now and quite close.");
set_exits (([
"north" : "/d/dagger/Elvanta/forest/room61",
"south" : "/d/dagger/Elvanta/forest/room63",
"east" : "/d/dagger/Elvanta/forest/knighta",
"west" : "/d/dagger/Elvanta/forest/knightb"
]));
set_items
(([
