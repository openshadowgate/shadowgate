...
set ("day long", "%^ORANGE%^The city is alive in the daylight, the Elves busy at their work, the <pathway> bustling with activity.  The pathway continues in a southwest direction, and the Alchemists shop is to the north.%^RESET%^");
set ("night long", "%^CYAN%^The city is quieter by night, however the Elves still go about their business, however, more appear to be headed towards an evening of pleasure rather than work.  The <pathway> continues in a southwest direction, while the Alchemists shop is to the north.%^RESET%^");
...
set_exits (([
"north" : "/d/dagger/Elvanta/forest/roomalch",
"northeast" : "/d/dagger/Elvanta/forest/room116",
"southwest" : "/d/dagger/Elvanta/forest/room118"
]));
set_items
(([
