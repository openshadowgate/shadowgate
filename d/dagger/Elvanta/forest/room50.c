...
set ("day long", "%^ORANGE%^You have finally found the source of all that noise. To the north of you is a large forge works.  To the left and right more pathway. Maybe you should investigate the place, since it seems full of movement.%^RESET%^");
set ("night long", "%^CYAN%^You have finally found the source of all that noise.  To the north of you is a large forge works.  To the left and right of you, more pathway.  Maybe you should investigate the place, since it seems full of movement.%^RESET%^");
...
set_exits (([
"west" : "/d/dagger/Elvanta/forest/room51",
"east" : "/d/dagger/Elvanta/forest/room49",
"north" : "/d/dagger/Elvanta/forest/roomforge"
]));
set_items
(([
