...
set ("day long", "%^ORANGE%^The <pathway> continues to travel in a spiral fashion.  You notice <trees>, large <branches> and <children> running.  There is also a small <building> to the right of you, perhaps you should investigate.%^RESET%^");
set ("night long", "%^CYAN%^The <pathway> continues  to travel in a spiral fashion.  You notice by the light of the <globes>, <trees>, <branches> and small <children> running.  There is also a small <building> to the right of you, perhaps you should investigate.%^RESET%^");
set_smell ("default", "%^MAGENTA%^\nThe smell of food and forest mingle in the air");
set_listen ("default", "The sounds of the forest follow you as you travel");
set_exits (([
"northwest" : "/d/dagger/Elvanta/forest/room67",
"southeast" : "/d/dagger/Elvanta/forest/room69",
"west" : "/d/dagger/Elvanta/forest/roomG9"
]));
set_items
(([
...
"building" : "This appears to be a guard post of some sort.  Small but effecient, a look inside might be in order.",
...
"branches" : "This is what you walk upon, huge molded branches larger than most highways and biways you have ever travelled.",
"children" : "Small children race up and down the trees like the squirrels they chase",
