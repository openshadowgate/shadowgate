...
set_exits (([
"west" : "/d/dagger/Elvanta/forest/room46",
"east" : "/d/dagger/Elvanta/forest/room44"
]));
set_items
(([
...
"pathway" : "The pathway seems well travelled in this area, the carvings upon the planks are still clear, but the edges seem well worn.",
"elves" : "More and more elves pass you, carrying pots, pans, jewellry, and other metal items.",
"city" : "The city is laid out in a circle, will you ever come to an end, you wonder.",
...
new("/d/dagger/Elvanta/forest/mon/blackbear")->move(TO);
if(!present("owlbear"))
