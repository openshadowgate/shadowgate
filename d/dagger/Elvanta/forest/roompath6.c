...
set_short ("A pathway");
set_long("%^ORANGE%^You pass out of the sunlight to where it is dark and cool, even at midday, and shadows drape thier intricate patterns like spider's webs across the woodland.");
...
set_exits (([
"northeast" : "/d/dagger/Elvanta/forest/roompath7",
"southwest" : "/d/dagger/Elvanta/forest/roompath5"
]));
set_items
(([
