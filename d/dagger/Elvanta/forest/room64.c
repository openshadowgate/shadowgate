...
set ("day long", "%^ORANGE%^You are travelling along a <pathway> noticing more elves, dwarves and men travelling along with you.  The pathway travels southward and starts to curve towards the east, obviously you are going in a circle towards something.%^RESET%^");
set("night long", "%^CYAN%^You are travelling along a <pathway> noticing more elves, dwarves, and men travelling along with you.  The pathway travels southward and starts to curve towards the east, obviously you are going in a circle toward something.%^RESET%^");
set_smell ("default", "%^MAGENTA%^\nThe smell of pine needles and warm earth fill your senses.");
set_listen ("default", "The sound of the forest, squeeks, squawks, and laughter reach your ears.");
set_exits (([
"north" : "/d/dagger/Elvanta/forest/room63",
"south" : "/d/dagger/Elvanta/forest/room65"
]));
set_items
(([
...
"pathway" : "The pathway continues in an unending circle it seems",
