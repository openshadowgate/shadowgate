...
set ("day long", "%^ORANGE%^As you keep on walking you notice the fine workmanship of the walkway.  The vines continue to hold the walkway in place and give you a feeling of security this high above the ground.  The <planks> continue in a southwest direction, ever circling, ever closing.%^RESET%^");
set ("night long", "%^CYAN%^As you keep on walking you continue to notice the fine workmanship on the <planks> upon which you travel.  Even in the light given from the <globes> you can see the many designs which have been carved.  The vines continue to give you a feeling of secuity as they hold the <walkway> in place.  You continue to travel southwest now, in an ever tightenting circle.  What wonders are ahead of you?%^RESET%^");
set_smell ("default", "%^MAGENTA%^\nYou smell the forest, green and alive.");
set_listen ("default", "You hear animals scampering through the trees.");
set_exits (([
"southwest" : "/d/dagger/Elvanta/forest/room114",
"east" : "/d/dagger/Elvanta/forest/room112"
]));
set_items
(([
