...
set ("day long", "%^ORANGE%^As you continue ever spiralling you notice that the <trees> seem to be set closer together and more <buildings> are appearing more often.%^RESET%^");
set ("night long", "%^CYAN%^As you continue ever spiralling you notice that the <trees> seem to be set closer together and more <buildings> are appearing more often.%^RESET%^");
...
set_exits (([
"northeast" : "/d/dagger/Elvanta/forest/room58",
"southwest" : "/d/dagger/Elvanta/forest/room60"
]));
set_items
(([
