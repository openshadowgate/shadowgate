...
set_exits (([
"northeast" : "/d/dagger/Elvanta/forest/room56",
"southwest" : "/d/dagger/Elvanta/forest/room58",
"west" : "/d/dagger/Elvanta/forest/roomH4"
]));
set_items
(([
...
::reset();
if(!present("satyr"))
new("/d/dagger/Elvanta/forest/mon/satyr")->move(TO);
}
