...
set_exits (([
"west" : "/d/dagger/Elvanta/forest/room110",
"east" : "/d/dagger/Elvanta/forest/room108"
]));
set_items
(([
"long bow" : "These bows ar five feet in length and made of hardwood.  They are strung and instantly available for use.",
