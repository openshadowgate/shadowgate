...
set_short("Moirbin Castle, a hallway");
...
set_listen ("default", "%^CYAN%^The falling of water from the fountain reaches your ears, but so does soft warm music.");
set_exits( ([
"north" : "/d/dagger/Elvanta/forest/roomcastle5",
"south" : "/d/dagger/Elvanta/forest/roomcastle3"
]) );
set_items(([
