...
set ("day long", "%^ORANGE%^The <pathway> continues.  People pass you talking and laughing.  Nothing but <trees> lie to the north of you, but the Elvanta Armoury lies to the south.  Perhaps you would like to check it out>%^RESET%^");
set ("night long", "%^CYAN%^The <pathway> continues, and the <globes> continue to light your way.  As evening settles, more people come by dressed in evening finery.  The Elvanta Armoury is south of you and nothing but <trees> to the north.%^RESET%^");
...
set_exits (([
"south" : "/d/dagger/Elvanta/forest/roomarmour.c",
"northeast" : "/d/dagger/Elvanta/forest/room115",
"southwest" : "/d/dagger/Elvanta/forest/room117"
]));
set_items
(([
