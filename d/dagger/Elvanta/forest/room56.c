...
set ("day long", "%^ORANGE%^There appears to be not all that much in this area of the <walkway> as you journey.  However, more elves, dwarves and men seem to be upon the same walkway as you.%^RESET%^");
set ("night long", "%^CYAN%^There appears to be not much in this area of the <walkway> as you journey.  However, by the light of the <globes> you see more elves, dwarves and men upon the same walkway as you.%^RESET%^");
...
set_exits (([
"east" : "/d/dagger/Elvanta/forest/room55",
"southwest" : "/d/dagger/Elvanta/forest/room57"
]));
set_items
(([
