...
set ("day long", "%^ORANGE%^The city is busy, with many peoples rushing to and fro.  There is a trace of ask and sulfur in the air, sunlight brightens the greens of the <trees> and the wood of the <buildings>.  The <walkway> continues to the southwest and the Elvanta Weapons Store is to the north.%^RESET%^");
set ("night long", "%^CYAN%^The city is quieter by night, however the Elves still go about their business.  Elven guards patrol the city during the night, and you can hear faint sounds of laughter and singing.  The <pathway> continues in a southwest direction, while the Elvanta Weapons Store is to the north.%^RESET%^");
...
set_exits (([
"north" : "/d/dagger/Elvanta/forest/roomweap",
"northeast" : "/d/dagger/Elvanta/forest/room117",
"south" : "/d/dagger/Elvanta/forest/room119"
]));
set_items
(([
