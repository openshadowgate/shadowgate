...
set ("day long", "%^ORANGE%^This is the storage room of the guard post.  There is a <bed>, a small <table>, and <boxes> overflowing with papers.  An elf is going through the <papers> obviously searching for something and now succeeding.%^RESET%^");
...
set_exits (([
"west" : "/d/dagger/Elvanta/forest/roomcastg_shack"
]));
set_items
(([
