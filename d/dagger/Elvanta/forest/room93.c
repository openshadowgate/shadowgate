...
set ("day long", "%^ORANGE%^Here lies a tattered form, still and twisted within a dark passage, the lifeblood seeping from the wound at his throat.  All about dogs prowl, ragged and hungry, slinking through the shadows like wraiths.%^RESET%^");
set ("night long", "%^CYAN%^Here lies a tattered form, still and twisted within a dark passage, the lifeblood seeping from the wound at his throat.  All about dogs prowl, ragged and hungry, slinking through the shadows like wraiths.%^RESET%^");
set_smell ("default", "%^MAGENTA%^\nFetid odours rise from the victim.");
set_listen ("default", "Moans, grumbles, cries for help fill the gloom.");
set_exits (([
"north" : "/d/dagger/Elvanta/forest/room94",
"southwest" : "/d/dagger/Elvanta/forest/room92"
]));
set_items
(([
