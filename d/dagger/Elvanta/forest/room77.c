...
set ("day long", "%^ORANGE%^It isn't creeping. It is stalking, like a cat, but something far more confident, far more determined.  It steals the life out of the air as it goes, a shadow that swallows sound and movement.  It might have been an animal once, it still has the look of one.  It is misshapen and distorted, the parts of its body hinged like giant grapples that allow it to swing freely in any direction.  It is sinewy and grotesque beyond imagining.%^RESET%^");
set ("night long", "%^CYAN%^It isn't creeping.  It is stalking, like a cat, but something far more confident, far more determined.  It steals the life out of the air as it goes, a shadow that swallows sound and movement.  It might have been an animal once, it still has the look of one.  It is misshapen and distorted, the parts of its body hinged like giant grapples that allow it to swing freely in any direction.  It is sinewy and grotesque beyond imagining.%^RESET%^");
...
set_exits (([
"northwest" : "/d/dagger/Elvanta/forest/room76",
"east" : "/d/dagger/Elvanta/forest/room78"
]));
set_items
(([
...
::reset();
if(!present("wspider"))
new("/d/dagger/Elvanta/forest/mon/wspider")->move(this_object());
}
