...
set_exits (([
"north" : "/d/dagger/Elvanta/forest/room31",
"south" : "/d/dagger/Elvanta/forest/room29"
]));
set_items
(([
...
"vines" : "These vines are strong, they hold the walkway in place and wind around the trees creating wonderful rides for the children and a quick escape for the people, if required.",
