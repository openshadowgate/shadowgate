...
set ("day long", "%^ORANGE%^The city is busy, with many peoples rushing to and fro.  Sunlight brightens the greens of the trees and the wood of the buildings.  The walkway continues to the south and the Healers is to the west.%^RESET%^");
set ("night long", "%^CYAN%^The city is busy, with many peoples rushing to and fro.  Globes light the walkway, which continues to the south.  The Healers is to the west of here.%^RESET%^");
...
set_exits (([
"west" : "/d/dagger/Elvanta/forest/roomhealer",
"north" : "/d/dagger/Elvanta/forest/room118",
"south" : "/d/dagger/Elvanta/forest/room120"
]));
set_items
(([
