...
set ("day long", "%^ORANGE%^<Shadows> and <mist> play hide and seek in the sprawling depths ahead of you.  Nothing else can be seen.  What lifeforms that are here lay in waiting, pawns in a hard and vicious game of survival that rewards only the quick and the stong.%^RESET%^");
set ("night long", "%^CYAN%^<Shadows> and <mist> play hide and seek in the sprawling depths ahead of you.  Nothing else can be seen. What lifeforms that are here lay in waiting, pawns in a hard and vicious game of survival that rewards only the quick and the strong.%^RESET%^");
...
set_exits (([
"northwest" : "/d/dagger/Elvanta/forest/room71",
"east" : "/d/dagger/Elvanta/forest/room73"
]));
set_items
(([
"shadows" : "Wraith like forms appear and disappear within the forest, creating shadows of fear.",
"mist" : "The mist continues to weave its way through the limbs and vines of the forest.",
