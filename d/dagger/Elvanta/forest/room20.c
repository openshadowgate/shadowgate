...
set ("day long", "%^ORANGE%^There appears to be nothing much in this area of the walkway, as you journey.  There is a small house to your left and more walkway ahead and behind you.%^RESET%^");
set ("night long", "%^CYAN%^There appears to be nothing much in this area of the walkway, as you journey every onward.  There is a small house to your left and more walkway ahead and behind you.%^RESET%^");
set_smell ("default", "%^MAGENTA%^\nYou can smell smoke from chimneys wafting through the air.");
set_listen ("default", "You hear the sounds of wildlife in the area, squeeks, squawks and chirps.");
set_exits (([
"northeast" : "/d/dagger/Elvanta/forest/room21",
"southwest" : "/d/dagger/Elvanta/forest/room19",
"west" : "/d/dagger/Elvanta/forest/roomH1"
]));
set_items
(([
...
"house" : "This is a small house, with rounded edges which seems to be growing out of the trees themselves",
