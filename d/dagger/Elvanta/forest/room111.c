...
set ("day long", "%^ORANGE%^There appears to be a small <house> to your left.  Perhaps you should investigate, then again, perhaps not.%^RESET%^");
set ("night long", "%^CYAN%^There appears to be a small <house> to you left.  Perhaps you should investigate, then again, perhaps not.%^RESET%^");
...
set_exits (([
"west" : "/d/dagger/Elvanta/forest/room112",
"east" : "/d/dagger/Elvanta/forest/room110",
"south" : "/d/dagger/Elvanta/forest/roomH6"
]));
set_items
(([
...
"house" : "The house you see beside you appears to be molded from the tree itself.  It is more rounded than what you are used to, but blends in with the forest so well, that it is difficult to see unless you are close to it.",
