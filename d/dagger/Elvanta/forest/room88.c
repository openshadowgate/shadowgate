...
set ("day long", "%^ORANGE%^Ahead, the gloom tightens into pockets, upon the floor of the stairs layers of human deadwood lies, the sticks of once life.%^RESET%^");
set ("night long", "%^CYAN%^Ahead, the gloom tightens into pockets, upon the floor of the stairs layers of human deadwood lies, the sticks of once life.%^RESET%^");
...
set_exits (([
"up" : "/d/dagger/Elvanta/forest/room87",
"down" : "/d/dagger/Elvanta/forest/room89"
]));
set_items
(([
...
::reset();
if(!present("ettercap"))
new("/d/tharis/monsters/ettercap")->move(TO);
}
