...
set ("day long", "%^ORANGE%^You see a tree trunk ahead of you, with a huge bulge to it.  As you watch, the tree's groans rise into a growling, splitting crackle.  A great rift appears in the trunk, lengthening to six feet, widens and rolls back.  A nut-brown girl steps from the trunk with a caroling cry of joy.%^RESET%^");
set ("night long", "%^CYAN%^You see a tree trunk ahead of you, with a huge bulge to it.  As you watch, the tree's groans rise into a growling, splitting crackle.  A great rift appears in the trunk, lengthening to six feet, widens and rolls back.  A nut-brown girl steps from the trunk with a caroling cry of joy.%^RESET%^");
set_smell("default", "%^MAGENTA%^\nThe smell of damp earth, flowers, and pine fills the air.");
set_listen ("default", "Sounds of groans, growling and splitting of a huge tree fills the air");
set_exits (([
"west" : "/d/dagger/Elvanta/forest/room105",
"east" : "/d/dagger/Elvanta/forest/room103"
]));
set_items
(([
