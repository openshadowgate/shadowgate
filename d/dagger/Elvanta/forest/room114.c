...
set ("day long", "%^ORANGE%^You seem to have come to the commercial centre of the town.  <Buildings> stand pushed together, of the trees and by the trees.  More people are passing by you on the <walkway>.  You see a sign, perhpas you should read it.%^RESET%^");
set ("night long", "%^CYAN%^You seem to have come to the commercial centre of the town.  <Buildings> all aglow, stand pushed together, of the trees and by the trees.  More people are passing by you on the <walkway>.  You see a sign, perhaps you should read it.%^RESET%^");
...
set_exits (([
"southwest" : "/d/dagger/Elvanta/forest/room115",
"northeast" : "/d/dagger/Elvanta/forest/room113"
]));
set_items
(([
