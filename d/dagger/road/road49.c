...
void create(){
   ...
   set_travel(DIRT_ROAD);
    ...
    set_long(
      "%^CYAN%^You are traveling the northern extension of the dagger road.  To the east you can make out the trees of the Kilkean forest, and to the west an evil cloud hangs over the Dagger Marsh.  A choked, narrow footpath runs out into the scrubland to the west, though it seems little used.  To the north the mountains of dagger rise above the horizon, you can see them clearer now as you get closer."
    );
	...
	"north" : RPATH "road50",
	"south" : RPATH "road48",
      "west" : "/d/tharis/barrow/rooms/bpath3"
      ]) );
}
