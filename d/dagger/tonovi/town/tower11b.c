...
void create(){
   ...
   set_travel(PAVED_ROAD);
    ...
    set_room_type("walls");
    set_long(
   "You are on top of one of the guard towers, but the placement of this one seems strange to you.  This one sets inside the walls of the city.  Perhaps it's to kill the attackers as they pass through the gates, but something about this place makes you think it may have other uses."
    );
