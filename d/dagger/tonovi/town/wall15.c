...
void create(){
   ...
   set_travel(PAVED_ROAD);
    ...
    set_long(
      ...
      +"   From here the passage under the walls continues to the south, and you can see a guard tower to the northwest.  To the northeast you can see a large gate."
    );
    ...
    set_exits( ([
	"south" : RPATH "wall14",
	"northeast" : RPATH "NWgate",
	"northwest" : RPATH "tower9",
      ]) );
