...
void create(){
   ...
   set_travel(PAVED_ROAD);
    ...
    set_long(
      ...
      +"   The walls here seem to just be a place to connect the towers to.  To the east you can see where they continue to a dead end.  To the northwest and south there are two guard towers, and to the southwest you can see the great northwestern gates, set into the walls to protect the Duke's keep."
    );
    ...
    set_exits( ([
	"south" : RPATH "tower11",
	"northwest" : RPATH "tower10",
	"east" : RPATH "wall17",
	"southwest" : RPATH "NWgate",
      ]) );
