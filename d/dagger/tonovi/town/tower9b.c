...
void create(){
   ...
   set_travel(PAVED_ROAD);
    ...
    set_room_type("walls");
    set_long(
      "This guard tower guards the northwest corner of the town.  Below you to the east is the small yet well used road that travels to the Duke's keep a short distance to the northwest.  You can see another tower on the other side of the road."
    );
