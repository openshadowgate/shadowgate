...
void create(){
    ...
    set_long("%^CYAN%^Bazaar of Tonovi%^RESET%^\n"+
       "This is the southeastern corner of the bazaar of Tonovi, "+
       "bounded on the east and south by the %^BOLD%^%^BLACK%^city walls%^RESET%^."+
       "  Here, the bazaar is darker than in other areas, and "+
       "a few of the merchants seem of the shadier sort.  "
       "The %^CYAN%^bazaar %^RESET%^opens to the north and west, "+
       ...
       "platform %^RESET%^of sorts to the northwest in the center "+
	...
	({"walls","wall","stone","stone walls"}) : "%^BOLD%^%^BLACK%^"+
      ...
      ({"platform","large platform","center"}) : "Directly in "+
         "the center of the bazaar to the northwest, there is "+
