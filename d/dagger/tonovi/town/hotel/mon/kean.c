...
void create() {
    ...
    set_short("%^BOLD%^%^MAGENTA%^Kean%^RESET%^%^MAGENTA%^, %^BOLD%^waiter %^RESET%^"+
        "%^MAGENTA%^for the %^YELLOW%^H%^RESET%^%^ORANGE%^o%^BOLD%^%^BLACK%^t%^RESET%^"+
        "%^ORANGE%^e%^BOLD%^l R%^RESET%^%^ORANGE%^e%^BOLD%^%^BLACK%^staura%^RESET%^"+
        "%^ORANGE%^n%^BOLD%^t%^RESET%^");
    set("aggressive", 0);
    set_level(10);
    set_long("%^RESET%^%^CYAN%^Tall and slender, he is a young man dressed in the "+
        "%^YELLOW%^l%^RESET%^%^ORANGE%^i%^BOLD%^%^BLACK%^ve%^RESET%^%^ORANGE%^r"+
        "%^BOLD%^y %^RESET%^%^CYAN%^of the Tonovi Hotel: a %^BOLD%^%^BLACK%^sharp "+
        "black suit %^RESET%^%^CYAN%^with %^YELLOW%^g%^WHITE%^o%^ORANGE%^ld%^RESET%^"+
        "%^ORANGE%^e%^BOLD%^n e%^WHITE%^m%^ORANGE%^b%^RESET%^%^ORANGE%^e%^BOLD%^l"+
        "%^WHITE%^l%^ORANGE%^is%^RESET%^%^ORANGE%^h%^BOLD%^me%^RESET%^%^ORANGE%^n"+
        "%^BOLD%^ts %^RESET%^%^CYAN%^along the cuffs and seams, with a solid gold "+
        "band running the length of his pants. His long %^BOLD%^%^BLACK%^jet black "+
        "hair %^RESET%^%^CYAN%^has been combed back and bound in a simple bone clasp "+
        "at the nape of his neck. Judgmental %^GREEN%^e%^BOLD%^me%^RESET%^%^GREEN%^r"+
        "%^BOLD%^a%^WHITE%^l%^GREEN%^d ey%^RESET%^%^GREEN%^e%^BOLD%^s %^RESET%^"+
        "%^CYAN%^look down from an aquiline nose, though a painted smile is presented "+
        "to each guest. A thin %^BOLD%^%^BLACK%^s%^RESET%^i%^BOLD%^lv%^RESET%^e"+
        "%^BOLD%^%^BLACK%^r c%^RESET%^h%^BOLD%^ok%^RESET%^e%^BOLD%^%^BLACK%^r "+
        "%^RESET%^%^CYAN%^adorns his throat, adorned with a single beveled %^BOLD%^"+
        "%^RED%^r%^RESET%^%^RED%^u%^BOLD%^by%^RESET%^%^CYAN%^.%^RESET%^");
    set_gender("male");
    set_alignment(6);
    set_race("human");
    set_hd(10,0);
