...
void create(){
    ...
    set_long(
      "This elf has been sold as a slave in the plaza of Tonovi.  Ripped from his home im the Dagger forest, he show the scars of whippings to try to tame this great and strong elf to serve a master."
    );
    set_price(12500);
    set_max_hp(150);
    set_hp(query_max_hp());
