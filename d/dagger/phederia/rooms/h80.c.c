...
void create(){
  ...
  set_pre_exit_functions(({"east","northeast","north","northwest","west","southwest","south","southeast"}),({"stick_em"}));
}
int stick_em(){
  ...
  if (!("daemon/saving_d"->savingthrow(TP,"paralyzation_poision_death"))){
