...
void create(){
  ...
  set_short(
  "%^BOLD%^%^BLACK%^Main path through the Hedge Garden."
  );
  set_long(
  "%^BOLD%^%^BLACK%^Main path through the Hedge Garden.\n"
 "%^RESET%^%^GREEN%^"
  "  You stand on the main path that once lead straight to the rose fortress from the entrance."
  "  To the west you can see the entrence to the fortress but the path to the east to the fortress is blocked by overgrown hedges."
