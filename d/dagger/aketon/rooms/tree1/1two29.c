...
You are on an open area within the barracks of the Aketon military. "
      ...
      "A large sign is hanging over the doorways of that building.");
   set_items( (["area":"This is an open area in the barracks here for the "
      ...
      "sign":"It reads: Headquarters of the infantry"]) );
   set_smell("default","You smell the blood of soldiers who were wounded while "
      "practicing.");
   set_listen("default","You hear the sound of weapons clashing against armour.");
   set_exits( (["northeast":RPATH1+"1two1",
      "southwest":RPATH1+"1two35"]) );
   set_pre_exit_functions( ({"southwest"}),({"southwest_func"}) );
}
