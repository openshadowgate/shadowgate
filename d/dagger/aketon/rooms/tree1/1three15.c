...
This is a wide corridor built around the huge tree trunk. A large window "
      "occupies the whole south wall where you can see far off into the "
      ...
      "and west. Some paintings are hanging on the north wall.");
   set_items( (["trunk":"Size of the huge trunk is beyond imagination.",
       ...
       "paintings":"Paintings of all sorts of wars.",
       "window":"The single large window occupied the whole south wall.",
       "floor":"It is not rottened not well traveled."]) );
   set_smell("default","You are assaulted by the many smells of the "
      "forest.");
   set_listen("default","You hear sounds of the city coming from beneath "
      "you.");
   set_exits( (["east":RPATH1+"1three16",
      "west":RPATH1+"1three14"]) );
}
