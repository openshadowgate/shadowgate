...
void create() {
   ::create();
   set_name("southwest cable");
   set_id( ({"cable","blue cable","southwest_cable"}) );
   set("short","%^RESET%^%^BLUE%^blue long cable");
   set("long","This cable is made of enchanted steel. It extends down to "
       "a huge tree towards the southwest. It is fixed in place on a large "
...
int slide_func(string str) {
   ...
   if(member_array(str,
      ({"southwest cable","sw cable","blue cable","southwest_cable"})) == -1)
   ...
   tell_object(TP,"You wrap the leather around the cable and slide all the "
      "way down to the southwest with extreme speed!");
