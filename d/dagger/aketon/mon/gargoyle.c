...
void create(){
	...
	set_id(({"gargoyle"}));
	set_long(
		"This creature is a grotesque caricture of a demon with a horn in the "+
            "middle of its forehead and a barbed tail.  Winged and with "+
		"exaggerated features, this stone creature looks just like the "+
		"sculptures you have seen sitting idly as waterspouts on the roofs "+
           "of castles.  This beings teeth, claws, and horns look like they "+
...
void init(){
	...
	::init();
	force_me("watch");
	if(avatarp(TP) || mrace == "golem" || mrace == "gargoyle")return;
