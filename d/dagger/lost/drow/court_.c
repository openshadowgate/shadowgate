...
void create() {
	...
	"directly at the center of it's roof. There are no doors or windows visable "
	...
	"pinnacle":"%^MAGENTA%^The roof of the temple is pyramidical in shape and comes to a point at it's apex.%^RESET%^",
    ...
    set_exits(([
	"south":"/d/dagger/drow/rooms/court6.c",
	"north":"/d/dagger/drow/rooms/court2.c"
    ]));
}
