...
" The road continues to the north and to the south here. Further to the north you can see "
"a large white structure.%^RESET%^"
);
set_listen("default",
...
set_exits(([
"north":"/d/dagger/drow/rooms/city37.c",
"south":"/d/dagger/drow/rooms/city39.c"
]));
}
