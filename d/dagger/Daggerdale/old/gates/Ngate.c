...
set_property("light", 2);
  set_short("The Northern Gates of Daggerdale.");
  set("day long",
@GIL
%^ORANGE%^These are the Northern Gates of Daggerdale Village.
...
GIL
  ...
  set("night long",
@GIL
%^YELLOW%^These are the Northern Gates of Daggerdale Village.
...
set_smell("default", "The air smells of the mountains, crisp and clean.");
...
"south" : "/d/dagger/Daggerdale/streets/street38",
     ]));
}
void reset(){
::reset();
...
//new("/d/dagger/Daggerdale/streets/items/objs/lantern_pole.c")->move(TO);
    if(!present("law sign")) {
        new("/d/dagger/Daggerdale/lawsign")->move(TO);
    }
}
