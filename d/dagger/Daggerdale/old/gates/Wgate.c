...
set_property("light", 2);
  set_short("The Western Gates of Daggerdale.");
  set("day long",
@GIL
%^ORANGE%^These are the Western Gates of Daggerdale Village.
...
GIL
  ...
  set("night long",
@GIL
%^YELLOW%^These are the Western Gates of Daggerdale Village.
...
set_smell("default", "The air smells of incense.");
...
"east" : "/d/dagger/Daggerdale/streets/street18",
     ]));
}
void reset(){
::reset();
