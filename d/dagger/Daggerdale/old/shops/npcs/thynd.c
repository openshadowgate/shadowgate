//changed drink messages to not require gender to fix bug reports
//until we get a global fix.  Circe 12/24/03
#include <std.h>
...
void create() {
    ...
    set_name("Thynd");
    set_id( ({ "thynd", "barkeep" }) );
    set_short("Thynd, the barkeep");
    set("aggressive", 0);
    set_long("He waits patiently to take your order.\n");
    set_gender("male");
    set_alignment(6);
    set("race", "human");
    set_level(12);
	...
	"slowly enjoys a mug of thick beer.\n",
