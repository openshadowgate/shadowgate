...
set_property("light", 2);
  ...
  set("day long",
@GIL
%^ORANGE%^You are at the corner of North Woodbury Lane and Justice Avenue.
The street runs South and East from here.
A metal pole holds an unlit lantern aloft here.
The high city wall lies to the North and West of the street.
GIL
);
  set("night long",
@GIL
%^YELLOW%^You are on corner of North Woodbury Lane and Justice Avenue.
The street runs South and East from here.
...
set_listen("default", "You can hear the sounds of horse snorting.");
  set_items(([
...
"wall" : "It's 50 foot tall and made from huge polished granite blocks.",
  ...
  set_exits(([
"east" : "/d/dagger/Daggerdale/streets/street35",
"south" : "/d/dagger/Daggerdale/streets/street31",
     ]));
}
void reset(){
::reset();
