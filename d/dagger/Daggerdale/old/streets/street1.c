...
set_property("light", 2);
  ...
  set("day long",
@GIL
%^ORANGE%^You are at the corner of Bakers Avenue and Woodbury Lane.
The street runs North and East from here.
A metal pole holds an unlit lantern aloft here.
The high city wall lies to the South and West of the street.
GIL
);
  set("night long",
@GIL
%^YELLOW%^You are at the corner of Bakers Avenue and Woodbury Lane.
The street runs North and East from here.
...
"wall" : "It's 50 foot tall and made from huge polished granite blocks.",
  ...
  set_exits(([
"north" : "/d/dagger/Daggerdale/streets/street10",
"east" : "/d/dagger/Daggerdale/streets/street2",
     ]));
}
void reset(){
::reset();
