...
set_property("light", 2);
  ...
  set("day long",
@GIL
%^ORANGE%^You are in the Southern corner of the Market Square.
The street runs South, East and West from here.
A metal pole holds an unlit lantern aloft here.
The city Fountain lies North of here.
...
GIL
  ...
  set("night long",
@GIL
%^YELLOW%^You are in the Southern corner of the Market Square.
The street runs South, East and West from here.
...
"grate" : "It's a metal sewer grate, the rainwater goes down here and you can be sure that nasty, filthy, things live down there.",
  ...
  set_exits(([
"north" : "/d/dagger/Daggerdale/fountain/fountain",
"east" : "/d/dagger/Daggerdale/streets/street16",
"south" : "/d/dagger/Daggerdale/streets/street11",
"west" : "/d/dagger/Daggerdale/streets/street14",
     ]));
}
void reset(){
::reset();
