...
set_property("light", 2);
  ...
  set("day long",
@GIL
%^ORANGE%^You are at the corner of Bakers Avenue and Thorn Lane.
The street runs North and West from here.
A metal pole holds an unlit lantern aloft here.
The high city wall lies to the South and East of the street.
GIL
);
  set("night long",
@GIL
%^YELLOW%^You are at the corner of Bakers Avenue and Thorn Lane.
The street runs North and West from here.
...
"wall" : "It's 50 foot tall and made from huge polished granite blocks.",
  ...
  set_exits(([
"north" : "/d/dagger/Daggerdale/streets/street12",
"west" : "/d/dagger/Daggerdale/streets/street8",
     ]));
}
void reset(){
::reset();
