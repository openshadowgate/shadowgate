...
%^BOLD%^Light from a metal grate above your head lights the area slightly.
GIL
);
...
"bricks" : "Granite bricks...tho theres so much muck and filth on them you couldn't hardly tell!",
  ...
  set_exits(([
     "west" : "/d/dagger/Daggerdale/sewers/level1/sewer9",
     "east" : "/d/dagger/Daggerdale/sewers/level1/sewer7",
]));
}
