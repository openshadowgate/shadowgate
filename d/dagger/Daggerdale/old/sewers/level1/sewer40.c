...
The sewers lead South, East and West from here.
...
"bricks" : "Granite bricks...tho theres so much muck and filth on them you couldn't hardly tell!",
  ...
  set_exits(([
     "west" : "/d/dagger/Daggerdale/sewers/level1/sewer39",
     "east" : "/d/dagger/Daggerdale/sewers/level1/sewer41",
     "south" : "/d/dagger/Daggerdale/sewers/level1/sewer49",
]));
}
