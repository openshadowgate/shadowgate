...
The sewers lead North, South and West from here.
...
"bricks" : "Granite bricks...tho theres so much muck and filth on them you couldn't hardly tell!",
  ...
  set_exits(([
     "north" : "/d/dagger/Daggerdale/sewers/level1/sewer22",
     "west" : "/d/dagger/Daggerdale/sewers/level1/sewer30",
     "south" : "/d/dagger/Daggerdale/sewers/level1/sewer39",
]));
}
