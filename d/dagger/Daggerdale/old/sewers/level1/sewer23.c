...
The sewers lead North, East and West from here.
...
"bricks" : "Granite bricks...tho theres so much muck and filth on them you couldn't hardly tell!",
  ...
  set_exits(([
     "west" : "/d/dagger/Daggerdale/sewers/level1/sewer22",
     "east" : "/d/dagger/Daggerdale/sewers/level1/sewer24",
     "north" : "/d/dagger/Daggerdale/sewers/level1/sewer14",
]));
}
