...
The sewers lead North, South and East from here.
%^BOLD%^Light shines down from a grate above your head lighting the area slightly.
GIL
);
...
"bricks" : "Granite bricks...tho theres so much muck and filth on them you couldn't hardly tell!",
  ...
  set_exits(([
     "north" : "/d/dagger/Daggerdale/sewers/level1/sewer24",
     "east" : "/d/dagger/Daggerdale/sewers/level1/sewer33",
     "south" : "/d/dagger/Daggerdale/sewers/level1/sewer41",
]));
}
