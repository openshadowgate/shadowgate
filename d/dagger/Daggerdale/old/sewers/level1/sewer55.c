...
%^BOLD%^Light from the grate above your head lights up the area here slightly.
GIL
);
...
"bricks" : "Granite bricks...tho theres so much muck and filth on them you couldn't hardly tell!",
  ...
  set_exits(([
     "west" : "/d/dagger/Daggerdale/sewers/level1/sewer54",
     "east" : "/d/dagger/Daggerdale/sewers/level1/sewer56",
]));
}
