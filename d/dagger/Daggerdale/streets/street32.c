...
"been mostly ruined. The damaged remains of buildings lie to the east and west.%^RESET%^");
    set_smell("default","An acrid, burnt smell fills the air.");
    set_listen("default","It is deathly quiet here.");

    set_exits(([
      "north" : STREETS"street38",
      "south" : STREETS"street28",
      "east" : SHOPS"courthouse",
      "west" : SHOPS"jailhouse",
    ]));
}