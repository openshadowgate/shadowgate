...
"been mostly ruined. To the south you see the rema%^RESET%^%^WHITE%^i%^BOLD%^%^BLACK%^ns of a f%^RESET%^"
"%^WHITE%^ou%^BOLD%^%^BLACK%^nt%^RESET%^%^WHITE%^a%^BOLD%^%^BLACK%^in.%^RESET%^\n\n");
    ...
    set_exits(([
      "south" : FOUNTAIN"fountain",
      "east" : STREETS"street29",
      "north" : STREETS"street32",
      "west" : STREETS"street27",
    ]));
}