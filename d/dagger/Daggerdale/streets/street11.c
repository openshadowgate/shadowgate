...
"been mostly ruined. Partly destroyed buildings lie to the east and west of the road.%^RESET%^");
    set_smell("default","An acrid, burnt smell fills the air.");
    set_listen("default","It is deathly quiet here.");

    set_exits(([
      "north" : STREETS"street15",
      "south" : STREETS"street5",
      "east" : SHOPS"bank",
      "west" : SHOPS"equipshop",
    ]));
}