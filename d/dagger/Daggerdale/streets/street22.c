...
"been mostly ruined. To the west you see the rema%^RESET%^%^WHITE%^i%^BOLD%^%^BLACK%^ns of a f%^RESET%^"
"%^WHITE%^ou%^BOLD%^%^BLACK%^nt%^RESET%^%^WHITE%^a%^BOLD%^%^BLACK%^in.%^RESET%^\n\n");
    ...
    set_exits(([
      "north" : STREETS"street29",
      "south" : STREETS"street16",
      "west" : FOUNTAIN"fountain",
      "east" : STREETS"street23",
    ]));
}