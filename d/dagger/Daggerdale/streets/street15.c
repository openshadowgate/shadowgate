...
"been mostly ruined. To the north you see the rema%^RESET%^%^WHITE%^i%^BOLD%^%^BLACK%^ns of a f%^RESET%^"
"%^WHITE%^ou%^BOLD%^%^BLACK%^nt%^RESET%^%^WHITE%^a%^BOLD%^%^BLACK%^in.%^RESET%^\n\n");
    ...
    set_exits(([
      ...
      "east" : STREETS"street16",
      "south" : STREETS"street11",
      "west" : STREETS"street14",
    ]));
}