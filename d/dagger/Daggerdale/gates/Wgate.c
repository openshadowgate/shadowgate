...
void create(){
    ...
    set_name("The western gates of Daggerdale");
    set_short("%^BOLD%^%^BLACK%^The western gates of Daggerdale%^RESET%^");
    set_long("%^BOLD%^%^BLACK%^These were once the western gates of Daggerdale village. The massive %^RESET%^"
