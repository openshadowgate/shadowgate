...
The path is disturbed here by clawed footprints.
You can see drops of blood everywhere.
GIL
);
  set("night long",
@GIL
...
"blood" : "There is a trail of it leading both ways down the path.",
]));

  set_exits(([
     "northwest" : "/d/dagger/marsh/path4",
     "southeast" : "/d/dagger/marsh/path2",
]));
}
