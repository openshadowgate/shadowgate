...
void create() {
   ...
   set_travel(FRESH_BLAZE);
	...
	"To the northwest, the marsh grows much darker and thicker. You are fairly sure "
	"that the Marsh of Fear begins here."      
        "%^RESET%^"
    );
    set_listen("default",
 	"You sense something extremely evil to the northwest."
    );
    set_smell("default",
	"It smells of death, decay and ruin here."
    );
    set_items(([
