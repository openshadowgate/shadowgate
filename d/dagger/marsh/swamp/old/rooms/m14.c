...
void create() {
   ...
   set_travel(FRESH_BLAZE);
	...
	"A boggy lake lies to the east blocking any passage further in that direction. "
	"The lake is large and could be explored only by boat."      
        "%^RESET%^"
    );
    set_listen("default",
	...
	"vegetation is the master of this area.",
        "lake":"The lake is quite slimy and filled with reeds and weeds.",
    ]));
    set_exits(([
	"west": RPATH "m13",
//        "east": RPATH "lake1",
