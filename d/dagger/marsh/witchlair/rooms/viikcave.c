...
"you step out of the cramped tunnel and into a more spacious "
...
"this little cave.";
  if(present("viik", TO)){
     desc += "..but you can worry about all that later. Right "
"now, it would be best to focus on whatever it is that just "
"%^RESET%^%^RED%^attacked you%^BOLD%^%^BLACK%^!%^RESET%^";
   }
   return desc;
}
