...
A large snapping turtle hisses at you from a nearby log.
GIL
);
  set("night long",
@GIL
...
A trail of clawed footprints leads Northwest and Southeast.
A large bullfrog croaks at you from a nearby log.
GIL
);
...
"bullfrog" : "Whoa he's big...must be a lot of insects around.",
  ...
  set_exits(([
     "northwest" : "/d/dagger/marsh/path6",
     "southeast" : "/d/dagger/marsh/path4",
]));
}
