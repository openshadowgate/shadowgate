...
void create() {
   ...
   set_travel(PAVED_ROAD);
	...
	" To the west lies an open doorway leading into the drow soldier "
	"barracks. To the east, towering above you, lies a temple wall."
    );
    set_listen("default",
	"You can hear a strange humming sound coming from behind the "
	"temple wall."
    );
    set_smell("default",
	...
	"hint":"Here is a hint clever one: To enter the temple you enter "
	"the walls from the north gate...the south one is trapped heavily!",
	"barracks":"The barracks are made of simple black obsidian stone "
	"and bear no markings.",
	"doorway":"The doorway hangs open but nothing can be seen "
	"through it.",
    ...
    set_exits(([
	"south":"/d/dagger/drow/rooms/city7",
	"north":"/d/dagger/drow/rooms/city27",
	"west":"/d/dagger/drow/rooms/brk5"
    ]));
}
