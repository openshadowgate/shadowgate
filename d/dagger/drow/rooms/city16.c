...
void create() {
   ...
   set_travel(PAVED_ROAD);
    ...
    set_listen("default",
	"The sound of money being counted is in the air."
    );
    set_smell("default",
	"It smells like fresh gold."
    );
    set_items(([
	...
	"sign":"The sign bears the symbols of the treasury upon it.",
    ...
    set_exits(([
	"north":"/d/dagger/drow/rooms/treasury",
	"west":"/d/dagger/drow/rooms/city15",
	"east":"/d/dagger/drow/rooms/city10"
    ]));
}
