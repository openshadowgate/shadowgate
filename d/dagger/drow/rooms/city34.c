...
void create() {
   ...
   set_travel(PAVED_ROAD);
	...
	" To the east is the %^MAGENTA%^regal building%^BLUE%^ and to "
   ...
   "the %^RED%^red banner%^RESET%^ hanging from its roof.",
	"banner":"%^RED%^The banner bears the dreaded "
	"symbol of Lloth.%^RESET%^",
    ...
    set_exits(([
	"southeast":"/d/dagger/drow/rooms/city35",
	"west":"/d/dagger/drow/rooms/city33"
    ]));
}
