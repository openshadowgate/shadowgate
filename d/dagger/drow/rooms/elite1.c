...
void create() {
   ...
   set_travel(PAVED_ROAD);
	...
	"dishware%^BLUE%^ decorate the table. Inset on the west wall "
	"is a fireplace. Several figurines decorate the "
	"mantelpiece.%^RESET%^"
    );
    set_listen("default",
	...
	"fireplace":"%^RED%^The fireplace contains no fire currently "
	"and is filled with ashes.",
	"chairs":"The chairs are made of hard oaken wood.",
	"mantelpiece":"Several figurines lay scattered about on the "
	"mantelpiece.",
	"figurines":"%^BLUE%^The figurines are made in the likeness "
	"of %^RED%^playing pieces%^BLUE%^ used to play `Azakkrps'. "
	"You remember this is the famous drow game of gambling and "
	"strategy.%^RESET%^"
    ]));
    set_exits(([
	"south": RPATH "city26",
