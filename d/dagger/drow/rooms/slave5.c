...
void create() {
   ...
   set_travel(FOOT_PATH);
	...
	"tunnel. The tunnel leads west and south and is used to "
	...
	"energy":"%^BLUE%^%^BOLD%^As you look upon the energy a voice in "
	"your head speaks: %^BLACK%^Seek the old man for the key of "
	"entrance.%^RESET%^"
    ]));
    set_exits(([
	"south": RPATH "slave4",
