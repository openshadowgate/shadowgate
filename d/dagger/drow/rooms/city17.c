...
void create() {
   ...
   set_travel(PAVED_ROAD);
	...
	"hair as you wander through the city pathways."
 	" To the north the temple walls tower above you. Your skin "
	"crawls just thinking about what lies behind it."
    );
    set_listen("default",
    ...
    set_exits(([
        "west":"/d/dagger/drow/rooms/city7",
        "east":"/d/dagger/drow/rooms/city18"
    ]));
}
