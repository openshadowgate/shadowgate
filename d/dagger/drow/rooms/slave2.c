...
void create() {
   ...
   set_travel(FOOT_PATH);
    ...
    set_long(
	"%^BLACK%^%^BLUE%^You stand within the elven slave compound. The "
	"compound is surrounded by chain link fence. The fence is covered "
	"with barbed wire. Wandering around various areas of the compound "
	"elven men, women and children wander about with sad misery in "
	"their eyes. To the west stands a small wheat shack. The ground "
	"is muddy and a slight drizzle of rain falls down on you."
    );
    set_listen("default",
