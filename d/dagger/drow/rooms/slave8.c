...
void create() {
   ...
   set_travel(FOOT_PATH);
	...
	"leading across the lake to the drow city. Across the bridge "
	"you see a chain tunnel leading into the city. "
	...
	"on you. Here there is a tunnel leading into the cavern "
