...
void create() {
   ...
   set_terrain(CITY);
	...
	" Two large towers made of black obsidian stone stand beside you "
	"to the east and the west. %^CYAN%^Fog%^BLUE%^ swirls around "
	"your feet as you travel along the street."
    );
    set_listen("default",
	...
	"towers":"The two towers are formed of black obsidian stone and "
	"have no apparent entrance from this spot in the city.",
    ...
    set_exits(([
	"south":"/d/dagger/drow/rooms/city1",
	"north":"/d/dagger/drow/rooms/city15"
    ]));
}
