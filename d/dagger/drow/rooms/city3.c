...
void create() {
	...
	"tower. There are many slits in the tower face for archers to use. "
	"A large %^RED%^red banner%^BLUE%^ hangs down the side of the "
	"tower.%^RESET%^"
    );
    set_listen("default",
    ...
    set_exits(([
	"north":"/d/dagger/drow/rooms/twr1",
	"west":"/d/dagger/drow/rooms/city4",
	"east":"/d/dagger/drow/rooms/city1"
    ]));
}
