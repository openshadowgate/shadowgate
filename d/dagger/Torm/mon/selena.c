...
void create(){
   ...
   set_nwp("escape",10,500);
    ...
    set_long("Dark locks of curly hair peek out from behind the black mask this woman wears.  She is the "
"receptionist for the Torm thieves guild, and takes her job very seriously.  She looks to be well conditioned "
"and she probably works hard to keep her body in top shape.  You need to have her <register> you here in "
"order to do business and enjoy the benefits of the guild.");
    set_race("half-elf");
    set_gender("female");
    set_class("thief");
    set_alignment(3);
