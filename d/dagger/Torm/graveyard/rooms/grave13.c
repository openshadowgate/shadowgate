...
"You see paths to the south, and west. To the north, you see "+
"a grand mausoleum...the resting place of someone obviously important.");
set_exits((["west":"/d/dagger/Torm/graveyard/rooms/grave12",
	"south":"/d/dagger/Torm/graveyard/rooms/grave19"]));
