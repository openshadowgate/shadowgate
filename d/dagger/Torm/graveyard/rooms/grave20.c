...
"You see paths to the north, east, and south. To the south, you see "+
"a grand mausoleum...the resting place of someone obviously important.");
set_exits((["east":"/d/dagger/Torm/graveyard/rooms/grave21",
	"north":"/d/dagger/Torm/graveyard/rooms/grave14"]));
