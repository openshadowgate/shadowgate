...
"of large tombs to the west and north-west.");
set_exits((["north":"/d/dagger/Torm/graveyard/rooms/grave12",
	"south":"/d/dagger/Torm/graveyard/rooms/grave25",
	"east":"/d/dagger/Torm/graveyard/rooms/grave19",
	"west":"/d/dagger/Torm/graveyard/rooms/grave17"]));
