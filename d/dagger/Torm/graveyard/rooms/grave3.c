...
"You see paths to the south, west, and east. To the west, you can barely "+
"make out what seems to be a large mausoleum.");
set_exits((["east":"/d/dagger/Torm/graveyard/rooms/grave4",
           "south":"/d/dagger/Torm/graveyard/rooms/grave9",
          "west":"/d/dagger/Torm/graveyard/rooms/grave2"]));
