...
"You see paths to the north, east, south and west. To the north-east, you see the "+
"outlines of a massive tomb.");
set_exits((["north":"/d/dagger/Torm/graveyard/rooms/grave16",
	"south":"/d/dagger/Torm/graveyard/rooms/grave28",
	"east":"/d/dagger/Torm/graveyard/rooms/grave23",
	"west":"/d/dagger/Torm/graveyard/rooms/grave21"]));
...
do_random_encounters(({"/d/dagger/Torm/graveyard/mon/zombie.c"}),100,3);
}
