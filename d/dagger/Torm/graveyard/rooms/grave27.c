...
"You see paths to the north, and east. To the west, you see a grand "+
"mausoleum...the resting place of someone obviously important.");
set_exits((["east":"/d/dagger/Torm/graveyard/rooms/grave28",
  "tomb":"/d/dagger/Torm/graveyard/rooms/tomb4.c",
	"north":"/d/dagger/Torm/graveyard/rooms/grave21"]));
...
set_listen("default","You hear activity all around you...");
  set_door("door","/d/dagger/Torm/graveyard/rooms/tomb4.c","tomb","rusted key");
  set_open("door",0);
  set_locked("door",1);
}
