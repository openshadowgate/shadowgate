...
void create(){
  ...
  set_exits(([
  "out":"/d/dagger/Torm/graveyard/rooms/grave2.c",
  ]));
  set_door("door","/d/dagger/Torm/graveyard/rooms/grave2.c","out","rusted key");
...
void reset(){
  ...
  new("/d/dagger/Torm/graveyard/blackkey.c")->move(present("wight",TO));
  }
}
int GoThroughDoor() {
  if(present("wight")){
