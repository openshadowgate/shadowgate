...
"You see paths to the north, east, south and west. To the north-east, you see a "+
"grand mausoleum...the resting place of someone important.");
set_exits((["north":"/d/dagger/Torm/graveyard/rooms/grave6",
	"south":"/d/dagger/Torm/graveyard/rooms/grave18",
         "west":"/d/dagger/Torm/graveyard/rooms/grave11",
              "east":"/d/dagger/Torm/graveyard/rooms/grave13"]));
