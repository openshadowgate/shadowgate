...
"You see paths to the south, west, and east. To the east, you can barely "+
"make out what seems to be a large mausoleum.");
set_exits((["east":"/d/dagger/Torm/graveyard/rooms/grave6",
           "south":"/d/dagger/Torm/graveyard/rooms/grave11",
          "west":"/d/dagger/Torm/graveyard/rooms/grave4"]));
