...
"You see paths to the north, east, south and west. To the south-east, you see a "+
"grand mausoleum...the resting place of someone important.");
set_exits((["north":"/d/dagger/Torm/graveyard/rooms/grave18",
	"south":"/d/dagger/Torm/graveyard/rooms/grave31",
	"west":"/d/dagger/Torm/graveyard/rooms/grave24",
	"east":"/d/dagger/Torm/graveyard/rooms/grave26"]));
