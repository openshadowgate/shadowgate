...
"You see paths to the north, west, and east. To the east, you can barely "+
"make out what seems to be a large mausoleum.");
set_exits((["east":"/d/dagger/Torm/graveyard/rooms/grave31",
	"north":"/d/dagger/Torm/graveyard/rooms/grave24",
	"west":"/d/dagger/Torm/graveyard/rooms/grave29"]));
