...
"You see paths to the north, east, south and west. To the north-west, you see the "+
"outlines of a massive tomb.");
set_exits((["north":"/d/dagger/Torm/graveyard/rooms/grave17",
	"south":"/d/dagger/Torm/graveyard/rooms/grave30",
	"west":"/d/dagger/Torm/graveyard/rooms/grave23",
	"east":"/d/dagger/Torm/graveyard/rooms/grave25"]));
