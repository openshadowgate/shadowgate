...
"You see paths to the north and west. To the north, you see "+
"the outline of a large tomb...");
set_exits((["west":"/d/dagger/Torm/graveyard/rooms/grave18",
	"south":"/d/dagger/Torm/graveyard/rooms/grave26",
	"north":"/d/dagger/Torm/graveyard/rooms/grave13"]));
