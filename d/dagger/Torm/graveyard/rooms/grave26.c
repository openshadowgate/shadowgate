...
"You see paths to the north, and west. To the south, you see "+
"a grand mausoleum...the resting place of someone obviously important.");
set_exits((["west":"/d/dagger/Torm/graveyard/rooms/grave25",
	"north":"/d/dagger/Torm/graveyard/rooms/grave19"]));
