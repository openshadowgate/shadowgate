...
"You see paths to the north, east, and west. To the south, you see the "+
"outlines of a massive tomb.");
set_exits((["north":"/d/dagger/Torm/graveyard/rooms/grave4",
            "east":"/d/dagger/Torm/graveyard/rooms/grave11",

            "west":"/d/dagger/Torm/graveyard/rooms/grave9"]));
