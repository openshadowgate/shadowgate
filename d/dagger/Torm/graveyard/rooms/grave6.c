...
"gravestones indicate those dead who were rich enough to have a proper funeral. "+
  "You see paths to the south, and west. To the east you see a grand "+
"mausoleum...the resting place of someone obviously important.");
set_exits((["west":"/d/dagger/Torm/graveyard/rooms/grave5",
  "tomb":"/d/dagger/Torm/graveyard/rooms/tomb2.c",
            "south":"/d/dagger/Torm/graveyard/rooms/grave12"]));
set_smell("default","The scent of fresh dirt and rotting corpses fills the air.");
  set_door("door","/d/dagger/Torm/graveyard/rooms/tomb2.c","tomb","rusted key");
  set_open("door",0);
  set_locked("door",1);
