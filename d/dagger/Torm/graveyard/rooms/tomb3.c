...
void create(){
  ...
  set_exits(([
  "out":"/d/dagger/Torm/graveyard/rooms/grave23.c",
  ]));
  set_door("door","/d/dagger/Torm/graveyard/rooms/grave23.c","out","rusted key");
...
void reset(){
  ...
  ::reset();
  if(!present("wight")){
  new("/d/dagger/Torm/graveyard/mon/twight2.c")->move(TO);
  }
}
int GoThroughDoor() {
  if(present("wight")){
