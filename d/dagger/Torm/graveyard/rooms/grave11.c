...
"You see paths to the north, east, south and west. To the south-west, you see the "+
"outlines of a massive tomb.");
set_exits((["north":"/d/dagger/Torm/graveyard/rooms/grave5",
           "west":"/d/dagger/Torm/graveyard/rooms/grave10",
	"south":"/d/dagger/Torm/graveyard/rooms/grave17",
            "east":"/d/dagger/Torm/graveyard/rooms/grave12"]));
