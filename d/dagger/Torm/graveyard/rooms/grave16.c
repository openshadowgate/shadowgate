...
"You see paths to the north, south, and west. To the east, you see the "+
"a grand mausoleum....the resting place of someone important.");
set_exits((["north":"/d/dagger/Torm/graveyard/rooms/grave9",
	"south":"/d/dagger/Torm/graveyard/rooms/grave22",
	"west":"/d/dagger/Torm/graveyard/rooms/grave15"]));
