...
void create(){
  ...
  "%^RED%^"
  "  This mosoleum was once drapped with finery and a stone bier lays in the center of the room"
  ...
  set_exits(([
  "out":"/d/dagger/Torm/graveyard/rooms/grave6.c",
  ]));
  set_door("door","/d/dagger/Torm/graveyard/rooms/grave6.c","out","rusted key");
