...
void create()
  {
  ::create();
  set_short("South lighthouse on the walls of Torm");
  set_long(
  "South lighthouse on the walls of Torm.\n"
  ...
  " would probably be hard to avoid at night.  Far to the north and"+
  " slightly to the east you can see the sister beacon like this one on"+
  " the north wall of the harbor."
  );
  set("night long",
