...
void create(){
   ::create();
   set_long(::query_long()+"%^RESET%^%^ORANGE%^There is a wooden mechanism here extending from holes in the cavern wall.%^RESET%^.\n");
   set_exits(([
      "west" : ROOMS"2_9",
      "south" : ROOMS"2_12",
   ]));
...
"cavern is a heavy wooden mechanism. This is obviously not the design or construction of the ogres, "+
