...
void create(){
	...
	set_lore("Crafted from the tortured souls of the elves that once "+
		"use to live on Argentrock, these cruel blades were first "+
		"crafted by the demons that enslaved the elves.  With the "+
		"revlotution by the fey'ri that overthrew the demons, these "+
		"blades continue to be in use.  Some rare blades are said to "+
		"contain the essence of demons instead of the souls of elves.  "+
		"What ever the case, the fey'ri have come to favor this blade "+
		"above most others.");
