//Pearl Longsword, inspired by Crystal's pearl short sword -- Yves
#include <std.h>
inherit "/d/common/obj/weapon/longsword.c";

void create(){
     ::create();
    set_name("pearl longsword");
    set_short("%^BOLD%^%^WHITE%^Pearl Longsword%^RESET%^");
    set_obvious_short("%^BOLD%^%^WHITE%^A pearl handled longsword%^RESET%^");
    set_id(({
        "sword",
        "longsword",
        "long sword",
        ...
        "pearl longsword",
        "pearl long sword",
        "pearl handled longsword"
        "pearl handled long sword"
    }));
    set_long(
        "%^BOLD%^%^WHITE%^This longsword has a white pearl handle with a hilt that has "
...
int hitme(object targ){
    ...
    case 21..31:
        ...
        ETO->do_damage("torso",-(random(5)+5));
    ...
    case 32..35:
        ...
        targ->do_damage("torso",random(7)+5);
