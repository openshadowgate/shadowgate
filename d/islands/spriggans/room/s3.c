//s3.c - Fishing spot on the ocean for Leilani ~Circe~ 5/27/07
#include <std.h>
#include "../spriggan.h"
inherit "/std/pier";
...
void create(){
   ...
   set_long("%^RESET%^%^ORANGE%^This narrow stretch of %^YELLOW%^sandy "
      ...
      "of path.%^RESET%^\n\n%^ORANGE%^This particular stretch of beach "
      "extends into the ocean in a natural jetty that looks to be a great "
      "spot for %^CYAN%^fishing%^ORANGE%^.%^RESET%^\n");
   set_items(([
