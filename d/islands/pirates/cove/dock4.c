...
void create(){ 
   ...
   set_name("Main dock");
   set_short("Main dock");
   set_long("%^BOLD%^Main dock%^RESET%^\n"
"Here on the main dock, it is regularly active here with pirates and dockworkers.  Beneath your feet, "
...
"held within them.  You can see the %^ORANGE%^wooden boarding %^RESET%^continue east and west, where it "
"meets with several docked boats, and also to the southern, main docking.  A dirt path leads northward, "
"heading away from the water toward what looks like a small settlement.  To the south stretch the %^BLUE%^"
"%^BOLD%^undulating waves%^RESET%^ of the ocean as far as you can see, often passed over by boats of varying "
"description.\n");
   set("night long","%^BOLD%^Main dock%^RESET%^\n"
"Here on the main dock, it is mostly deserted here in the %^BLACK%^%^BOLD%^darkness%^RESET%^ of night.  "
...
"east and west, where it meets with several docked boats, and also to the southern, main docking.  A dirt "
"path leads northward, heading away from the water toward what looks like a small settlement.  To the south "
"stretches the %^BLUE%^dark expanse%^RESET%^ of the ocean as far as you can see.\n");
