...
"This path leads northward away from the docks, toward a small settlement just ahead of you.  The trail "
...
"the sandy soil.  Just a few paces further though, you can see it meet with a simple cobblestone road, that "
"turns to lead through the village.  To the south, you can see a %^ORANGE%^wooden boardwalk%^RESET%^, spaced "
"with several docks, and the great expanse of the %^BLUE%^%^BOLD%^ocean's waves%^RESET%^ past it.\n");
   ...
   set_items(([
     ({"village","settlement"}):"A few paces northward, you can make out the buildings of a small "
"settlement.",
     ({"trail","path","gravel"}):"The %^ORANGE%^dust%^RESET%^ and gravel upon the path crunches beneath your "
"feet.  It leads northward to a cobblestone road that passes through a small village, and southward back "
"toward the docks.",
