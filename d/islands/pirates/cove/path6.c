...
void create(){
   set_monsters(({MON"citizen",MON"rogue"}),({1,1}));
   ::create();
...
"%^RESET%^beneath your feet leads east, further into the village itself, and west to a small crossroads.\n");
...
"east, further into the village itself, and west to a small crossroads.\n");
