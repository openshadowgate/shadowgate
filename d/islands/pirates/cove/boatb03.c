...
void create(){
   set_monsters(({MON"piratecrew",MON"piratecrew2"}),({2,2}));
   ::create();
...
"thoroghfare.  This deck is usually the most active, with pirates going to and fro about their business.  "
"Stairs lead upward toward the boat's aft, to the quarterdeck.\n");
