...
"This is the far western end of the docks, but even this far from the main path it is regularly active with "
"pirates and dockworkers.  Beneath your feet, %^ORANGE%^wooden slats%^RESET%^ form the boardwalk that is "
"held above the water by sturdy wooden stilts.  Along the edges of the dock are stacked numerous boxes and "
"crates, though you have no idea what might be held within them.  You can see the %^ORANGE%^wooden boarding "
"%^RESET%^continue eastward, where it meets with several docked boats, and a dirt path heading away from "
"the water.  To the south stretch the %^BLUE%^%^BOLD%^undulating waves%^RESET%^ of the ocean as far as you "
"can see, often passed over by boats of varying description.\n");
