...
"more menacing.  You have come to an apparent dead end.  The cavern continues on in all directions, but "
"there is no obvious path, the stalagmites would make traveling harsh.\n");
...
void init(){
   ::init();
   do_random_encounters(({MON"piercer"}),30,4);
}
