...
"You have descended further into the huge underground cavern.  The west passage looks like it will take you "
"deeper into the cavern.  And the south leads towards the surface.\n");
...
void init(){
   ::init();
   do_random_encounters(({MON"piercer"}),5,2);
}
