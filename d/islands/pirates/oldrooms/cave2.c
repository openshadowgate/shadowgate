...
"You've descended into a cavern. The darkness closes in "+
"on you.  It is cool down here. "+
...
"You have two choices from here: continue descending "+
"by following the northeast path, or you can climb back to the cavern "+
"entrance.\n"
);
...
void init(){
::init();
do_random_encounters(({MON+"piercer.c"}),40,6);
}
