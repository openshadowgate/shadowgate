...
void create(){
   ...
   set_long(
@OLI
   This is the religious and philosophical leader of this group of
monks. He is stooped and old. His head is bald and wrinkled. He sits
in the middle of the garden and meditates. He is one with nature.
Always at peace understand everything
OLI
   );
   set_race("human");
   set_body_type("human");
