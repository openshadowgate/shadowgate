...
void create(){
   ...
   set_long(
@OLI
   This old man spends his life sitting quitely in meditation or
walking quietly communing with the nature that surrounds him here,
His bald head is shadowed with a slight stubble. His calm eyes look
over you with a a loving embrace.
OLI
   );
   set_race("human");
   set_body_type("human");
