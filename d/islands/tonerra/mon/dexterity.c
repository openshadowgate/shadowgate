...
void create(){
   ...
   set_long(
@OLI
   This is the guardian of dexterity. He stands watch over the dexterity
of the monks. He looks like a middle aged man of average height and
weight. He is a wiry built man, skinny but hard. His eyes dart about much
like the movements of a skilled artist.
OLI
   );
   set_race("guardian");
   set_gender("male");
