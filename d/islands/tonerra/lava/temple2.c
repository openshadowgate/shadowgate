...
two rooms, they stand sealed before with the great symbol of ibrandul.
This room's floor is down right dusty, it looks as if you are the
first to enter in quite some time.
...
DESC
  ...
  set_items(([
   ...
   "symbol":"This is a collect of 4 rings. One on top, one on the bottom, one to the right, one to the left. The ring on the bottom is just a carving, as if the ring itself is missing. Looks as if one needs to be inserted."
   ]));
}
