...
the catacombs. Walkways lead in all directions. The 
entrance to the catacombs is to the north.
DESC
  );
  ...
  set_exits(([
    "north":CATACOMBS+"cat1",
    "south":CATACOMBS+"cat26",
    "east":CATACOMBS+"cat3",
    "west":CATACOMBS+"cat25"
  ]));
  set_items(([
