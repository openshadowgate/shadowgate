...
void create(){
  ...
  set_long(
@DESC
You are in the southeastern corner of the village. There are
tall wooden posts that surround the village making a sort
fence from the jungle. You can see some small huts scattered 
to the northwest, surrounding a much larger hut toward the 
...
DESC
  ...
  set_exits(([
	      "southwest":I_VILLAGE+"vil23",
	      "northwest":I_VILLAGE+"vil21"
  ]));
}
