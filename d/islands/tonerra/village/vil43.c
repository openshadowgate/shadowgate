...
entrance to the village off to the west. You can see some 
small huts scattered to the south and east of you, surrounding 
a much larger hut toward the center of the village.
DESC
  );
  set_indoors(0);
  set_light(2);
  ...
  set_exits(([
	      "west":I_VILLAGE+"vil42",
	      "east":I_VILLAGE+"vil44"
  ]));
}
