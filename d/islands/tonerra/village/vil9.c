...
void create(){
  ...
  set_long(
@DESC
You are in the northeast corner of the village. There are
tall wooden posts that surround the village making a sort
fence from the jungle. You can see some small huts scattered 
to the southwest, surrounding a much larger hut toward the center
of the village.
DESC
  );
  set_indoors(0);
  ...
  set_exits(([
	      "southeast":I_VILLAGE+"vil10",
	      "northwest":I_VILLAGE+"vil8"
  ]));
}
