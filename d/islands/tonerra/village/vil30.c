...
void create(){
  ...
  set_long(
@DESC
You are on the southern side of the village. There are
...
center of the village. The back of a hut is to the north.
DESC
  );
  set_indoors(0);
  set_light(2);
  ...
  set_exits(([
	      "southeast":I_VILLAGE+"vil29",
	      "west":I_VILLAGE+"vil31"
  ]));
}
