...
jungle. You are quite surrounded by large trees and plants and could 
...
VETRI
  ...
  set_exits(([
    "northwest":PATH+"path31",
    "southeast":PATH+"path39",
    "northeast":PATH+"path32",
    "southwest":PATH+"path21"
  ]));
}
