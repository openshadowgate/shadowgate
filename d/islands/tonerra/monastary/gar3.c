...
one to the east, and one to the southeast.%^RESET%^
OLI
   );
   set_items(([
      "column":(:TO,"lookFun":),
   ...
   set_exits(([
      "east":MONASTERY+"gar4",
      "southeast":MONASTERY+"gar5",
      "west":MONASTERY+"hall16",
   ]));
...
void lookFun(){
   ...
   write(
@OLI
   A vision of a library appears before you. Stacks of books mound around
the room you see. An old monk looks up from his studies and almost glances
at you. You see sense and knowledge and experience from him.
OLI
   );
...
int insert(string str){
   ...
   if(!ob = present("wisdom crystal",TP)){
