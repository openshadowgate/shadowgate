...
set_items(([
"path" : "The path is lead by the stone tiles in the form of an ancient dragon. This part of the path is in the shape of the dragon's torso.",
...
set_exits(([
"northwest" : RPATH "g16.c",
"north" : RPATH "g17.c",
"northeast" : RPATH "g18.c",
]));
