...
set_items(([
"path" : "The path is lead by the stone tiles in the form of an ancient dragon. This part of the path is in the shape of the dragon's torso, which leads to the tail.",
...
set_exits(([
"southeast" : RPATH "g4.c",
"southwest" : RPATH "g3.c",
]));
