...
void create(){
    ...
    set_exits( ([
      "west" : "/d/islands/dinosaur/lake/rooms/deep7u.c",
      "south" : "/d/islands/dinosaur/lake/rooms/deep5u.c",
      "east" : "/d/islands/dinosaur/lake/rooms/deep9u.c",
      "north" : "/d/islands/dinosaur/lake/rooms/shallow11.c",
      "down" : "/d/islands/dinosaur/lake/rooms/deep8d.c",
    ]) );
}
