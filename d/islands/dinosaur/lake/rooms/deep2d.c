...
void create(){
    ...
    set_pre_exit_functions( ({"south"}), ({"climb_out"}) );
    set_exits( ([
      "west" : "/d/islands/dinosaur/lake/rooms/deep1d.c",
      "east" : "/d/islands/dinosaur/lake/rooms/deep3d.c",
      "north" : "/d/islands/dinosaur/lake/rooms/deep5d.c",
      "up" : "/d/islands/dinosaur/lake/rooms/deep2u.c",
      "south" : "/d/islands/dinosaur/lake/rooms/shallow3.c",
    ]) );
}
