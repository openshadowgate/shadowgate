...
void create(){
    ...
    set_exits( ([
      ...
      "south" : "/d/islands/dinosaur/lake/rooms/deep1u.c",
      "east" : "/d/islands/dinosaur/lake/rooms/deep5u.c",
      "north" : "/d/islands/dinosaur/lake/rooms/deep7u.c",
      "down" : "/d/islands/dinosaur/lake/rooms/deep4d.c",
    ]) );
}
