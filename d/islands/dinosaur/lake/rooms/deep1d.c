...
void create(){
    ...
    set_pre_exit_functions( ({"south", "west"}), ({"climb_out", "climb_out"}) );
    set_exits( ([
      "east" : "/d/islands/dinosaur/lake/rooms/deep2d.c",
      "north" : "/d/islands/dinosaur/lake/rooms/deep4d.c",
      "up" : "/d/islands/dinosaur/lake/rooms/deep1u.c",
