...
void create(){
    ...
    set_exits( ([
      "west" : "/d/islands/dinosaur/lake/rooms/deep1u.c",
      "south" : "/d/islands/dinosaur/lake/rooms/shallow3.c",
      "east" : "/d/islands/dinosaur/lake/rooms/deep3u.c",
      "north" : "/d/islands/dinosaur/lake/rooms/deep5u.c",
      "down" : "/d/islands/dinosaur/lake/rooms/deep2d.c",
    ]) );
}
