...
void create(){
    ...
    set_exits( ([
      "west" : "/d/islands/dinosaur/lake/rooms/deep5u.c",
      "south" : "/d/islands/dinosaur/lake/rooms/deep3u.c",
      "north" : "/d/islands/dinosaur/lake/rooms/deep9u.c",
      "east" : "/d/islands/dinosaur/lake/rooms/shallow7.c",
      "down" : "/d/islands/dinosaur/lake/rooms/deep6d.c",
    ]) );
}
