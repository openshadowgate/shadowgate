...
int read(string str){
    ...
    write("%^CYAN%^Area Name: %^RESET%^%^BOLD%^yum.\n");
    write("%^CYAN%^Area Type: %^RESET%^island.\n");
    write("%^CYAN%^Climate: %^RESET%^yum.\n");
    write("%^CYAN%^Location: %^RED%^<00'00>.\n\n");
    write("%^CYAN%^Difficulty Ranking: %^RESET%^yum.\n");
    write("%^CYAN%^Monster Frequency: %^RESET%^yum.\n");
    write("%^CYAN%^Suggested Level to Adventure Here: %^GREEN%^yum.\n\n");
