...
");
   set_listen("default", "Sand blows in your eyes forcing you to cover your face!");
       set_exits(([
       "north" : "/d/islands/common/eldebaro/room22",
       "south" : "/d/shadow/virtual/sea/eldebaro.dock",
       "west" : "/d/islands/common/eldebaro/room20",
       "east" : "/d/islands/common/eldebaro/room26",
]));
   set_items(([
...
set_pre_exit_functions( ({"east"}), ({"earwig_pit"}) );
   ...
   where = find_object_or_load("/d/islands/common/eldebaro/room"+(random(30)+5));
   ob->move(where);
}
