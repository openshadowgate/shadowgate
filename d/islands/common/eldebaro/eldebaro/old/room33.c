...
void create(){
	...
	set_travel(FRESH_BLAZE);
       set_short("A desert island");
        set_long("
    The crumbling remains of a fortress are half buried in the sand.  Occasional brick formations rise up around you and, with some imagination, you can make out the shape that the demolished structure once held.
    %^ORANGE%^
...
");
   set_listen("default", "Sand blows in your eyes forcing you to cover your face!");
       set_exits(([
       "north" : "/d/islands/common/eldebaro/room32",
       "south" : "/d/islands/common/eldebaro/room34",
       "west" : "/d/islands/common/eldebaro/room27",
       "east" : "/d/islands/common/eldebaro/room38",
]));
       set_items(([
]));
