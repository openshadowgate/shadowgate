...
void create(){
	...
	set_travel(FRESH_BLAZE);
       set_short("A desert island");
        set_long("
    A tall sandstone wall stands almost completely intact here!  It towers above you, a reminder to the power this fortress once held.
    %^ORANGE%^
...
");
   set_listen("default", "Sand blows in your eyes forcing you to cover your face!");
       set_exits(([
       "north" : "/d/islands/common/eldebaro/room31",
       "south" : "/d/islands/common/eldebaro/room33",
