...
void create(){
	...
	set_travel(FRESH_BLAZE);
       set_short("A desert island");
        set_long("
    The tops of crumbled walls just barely protrude from the sand.  A long stone column leans against one of the walls, covered in sand.
    %^ORANGE%^
...
");
   set_listen("default", "Sand blows in your eyes forcing you to cover your face!");
       set_exits(([
       "north" : "/d/islands/common/eldebaro/room30",
       "south" : "/d/islands/common/eldebaro/room32",
       "west" : "/d/islands/common/eldebaro/room25",
       "east" : "/d/islands/common/eldebaro/room36",
]));
       set_items(([
