...
void create(){
	...
	"slapping of sea upon land echoes around you as the water to the north and east makes "+
	"contact with the beach.  However, the relative peace of this island ends "+
	"directly Southwest of you.  You stand at a threshold, for the beach upon which "+
	"you stand is the end of this tranquility and the beginning of the hardship "+
	"which is Eldebaro.  Southwest here will mean a trek across the sands of this long "+
