...
void create(){
	...
	set_travel(FRESH_BLAZE);
       set_short("A desert island");
        set_long("
    %^ORANGE%^
    You are at the northwest corner of Eldebaro island.  This tiny island is not much more than a spot of sand in the middle of a vast blue ocean.  A few sparse palm trees dot the sandy landscape.
...
");
    set_listen("default", "Sand blows in your eyes forcing you to cover your face!");
       set_exits(([
       "south" : "/d/islands/common/eldebaro/room2",
       "east" : "/d/islands/common/eldebaro/room4",
]));
       set_items(([
]));
