...
");
   set_listen("default", "Sand blows in your eyes forcing you to cover your face!");
       set_exits(([
       "north" : "/d/islands/common/eldebaro/room24",
       "south" : "/d/islands/common/eldebaro/room26",
       "west" : "/d/islands/common/eldebaro/room22",
       "east" : "/d/islands/common/eldebaro/room31",
]));
       set_items(([
]));
