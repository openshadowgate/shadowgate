...
void create(){
	...
	set_travel(FRESH_BLAZE);
       set_short("A desert island");
        set_long("
    %^ORANGE%^
    A dry arid desert stretches out before you.  This tiny island is not much
more than a spot of sand in the middle of a vast blue ocean.  A few sparse palm
trees dot the sandy landscape.
    Your footprints are covered by the winds behind you.
    There are three squarish boulders here, lying in a heap.
    %^BOLD%^%^BLUE%^The ocean meets the land to the south.
");
   set_listen("default", "Sand blows in your eyes forcing you to cover your face!");
       set_exits(([
       "north" : "/d/islands/common/eldebaro/room20",
       "west" : "/d/islands/common/eldebaro/room16",
       "east" : "/d/shadow/virtual/sea/eldebaro.dock",
]));
       set_items((["boulders" : "These massive rocks lay together in a disorganized jumble, partly covered with sand."
]));
