...
void create() 
{
    ...
    set_id(({"block", "ice", "block of ice", "giant ice block"}));
    	
    set_short("%^BOLD%^%^WHITE%^Giant bl%^BOLD%^%^CYAN%^o%^BOLD%^%^WHITE%^"+
    "ck of %^BOLD%^%^CYAN%^I%^BOLD%^%^WHITE%^c%^BOLD%^%^CYAN%^e%^RESET%^");

    set_long("%^BOLD%^%^CYAN%^This giant block of ice is nearly twenty feet long and "+
    "ten feet wide. The outter most edges of it are starting to melt "+
...
void wakey_wakey(int stage)
{
    ...
    switch(stage)
    {
        case 1:
            ...
            "%^BOLD%^%^WHITE%^ giant begins stirring..... and his %^BOLD%^%^MAGENTA%^"+
        ...
        case 2:
            ...
            "%^BOLD%^%^BLACK%^ giant %^BOLD%^%^GREEN%^ROARS%^BOLD%^%^BLACK%^ as he jumps to his feet, his hair flashing wildly "+
            ...
            set_short("%^BOLD%^%^WHITE%^Chipped giant bl%^BOLD%^%^CYAN%^o%^BOLD%^%^WHITE%^"+
            "ck of %^BOLD%^%^CYAN%^I%^BOLD%^%^WHITE%^c%^BOLD%^%^CYAN%^e%^RESET%^");

            set_long("%^BOLD%^%^CYAN%^This giant block of ice is nearly twenty feet long and "+
            "ten feet wide. The upper portion of it has been completely chipped away. Most of the "+
        ...
        case 3:
            ...
            "%^BOLD%^%^BLACK%^ 'Asantra, HEED my Call!'%^RESET%^");
            ...
            "%^BOLD%^%^BLUE%^d%^BOLD%^%^CYAN%^ sword appears in "+
            "one of his outstretched hands and an %^BOLD%^%^BLACK%^ebon shield%^BOLD%^%^CYAN%^"+
            " in the other!%^RESET%^");
            
            mon = new(ELMON+"storm_giant");
            mon->move(ETO);
