...
void create() {
   ...
   set_size(1);
   set_prof_type("rod");
   set_item_bonus("spell penetration",20);
...
object ob;
   ...
   new("/cmds/spells/f/_fireball")->use_spell(TP,ob,25,100,"mage");
...
object ob;
   ...
   new("/cmds/spells/c/_cone_of_cold")->use_spell(TP,ob,35,100,"mage");
   TP->set_paralyzed(2,"You are busy controlling the rod.");
   uses = uses -10;
   return 1;
}
...
object ob;
   ...
   new("/cmds/spells/p/_prismatic_spray")->use_spell(TP,ob,35,100,"mage");
   TP->set_paralyzed(2,"You are busy controlling the rod.");
   uses = uses - 15;
   return 1;
}
