// Updated to match the minor cloak.  Nienne, 11/04. //
#include <std.h>
inherit ARMOUR;
...
void create()
{
    ::create();
    set_name("cape");
    set_id(({ "cape", "shimmering cape", "cape of displacement", "major cape of displacement", "displacement cape", "major cape", }));
    set_short("%^WHITE%^%^BOLD%^Maj%^RESET%^%^WHITE%^o%^BOLD%^r Ca%^RESET%^%^WHITE%^p%^BOLD%^e of %^RESET%^%^WHITE%^D%^BOLD%^isp%^RESET%^%^WHITE%^l%^BOLD%^ace%^RESET%^%^WHITE%^m%^BOLD%^ent%^RESET%^");
...
int wear_it()
{
    ...
    if ((int)ETO->query_level() < 35) {
        tell_object(ETO, "The cape doesn't seem to fit you.");
        return 0;
    }
...
int changeme(string str)
{
    ...
    case "blue":
        ...
        if (!TP->query_invis()) {
            tell_room(ETP, "" + TP->QCN + "'s cloak shimmers and takes on a myriad of %^BLUE%^bl%^BOLD%^u%^RESET%^%^BLUE%^e%^RESET%^ shades.", TP);
        }
        TO->docolour(str);
        break;
    ...
    case "green":
        ...
        if (!TP->query_invis()) {
            tell_room(ETP, "" + TP->QCN + "'s cloak shimmers and takes on a myriad of %^GREEN%^gre%^BOLD%^e%^RESET%^%^GREEN%^n%^RESET%^ shades.", TP);
        }
        TO->docolour(str);
        break;
    ...
    case "red":
        ...
        if (!TP->query_invis()) {
            tell_room(ETP, "" + TP->QCN + "'s cloak shimmers and takes on a myriad of %^RED%^r%^BOLD%^e%^RESET%^%^RED%^d%^RESET%^ shades.", TP);
        }
        TO->docolour(str);
        break;
    ...
    case "azure":
        ...
        if (!TP->query_invis()) {
            tell_room(ETP, "" + TP->QCN + "'s cloak shimmers and takes on a myriad of %^CYAN%^azu%^BOLD%^r%^RESET%^%^CYAN%^e%^RESET%^ shades.", TP);
        }
        TO->docolour(str);
        break;
    ...
    case "violet":
        ...
        if (!TP->query_invis()) {
            tell_room(ETP, "" + TP->QCN + "'s cloak shimmers and takes on a myriad of %^MAGENTA%^vio%^BOLD%^l%^RESET%^%^MAGENTA%^et%^RESET%^ shades.", TP);
        }
        TO->docolour(str);
        break;
    ...
    case "white":
        ...
        if (!TP->query_invis()) {
            tell_room(ETP, "" + TP->QCN + "'s cloak shimmers and takes on a myriad of %^WHITE%^%^BOLD%^wh%^RESET%^%^WHITE%^i%^BOLD%^te%^RESET%^ shades.", TP);
        }
        TO->docolour(str);
        break;
    ...
    case "black":
        ...
        if (!TP->query_invis()) {
            tell_room(ETP, "" + TP->QCN + "'s cloak shimmers and takes on a myriad of %^BLACK%^%^BOLD%^bla%^RESET%^%^WHITE%^c%^BLACK%^%^BOLD%^k%^RESET%^ shades.", TP);
        }
        TO->docolour(str);
        break;
    ...
    case "gold":
        ...
        if (!TP->query_invis()) {
            tell_room(ETP, "" + TP->QCN + "'s cloak shimmers and takes on a myriad of %^ORANGE%^gol%^BOLD%^d%^RESET%^%^ORANGE%^en%^RESET%^ shades.", TP);
        }
        TO->docolour(str);
        break;

    default:
        tell_object(TP, "The cloak shimmers a little, reflecting varied shades of %^BLUE%^bl%^BOLD%^u%^RESET%^%^BLUE%^e%^RESET%^, %^GREEN%^gre%^BOLD%^e%^RESET%^%^GREEN%^n%^RESET%^, %^RED%^r%^BOLD%^e%^RESET%^%^RED%^d%^RESET%^, %^CYAN%^azu%^BOLD%^r%^RESET%^%^CYAN%^e%^RESET%^, "
                    "%^MAGENTA%^vio%^BOLD%^l%^RESET%^%^MAGENTA%^et%^RESET%^, %^WHITE%^%^BOLD%^wh%^RESET%^%^WHITE%^i%^BOLD%^te%^RESET%^, %^BLACK%^%^BOLD%^bla%^RESET%^%^WHITE%^c%^BLACK%^%^BOLD%^k%^RESET%^ and %^ORANGE%^go%^BOLD%^l%^RESET%^%^ORANGE%^d%^RESET%^.  It finally stills again, remaining the same colour as it was.");
        break;
    }
    return 1;
}
...
void docolour(string str)
{
    ...
    case "green":
        TO->set_short("%^RESET%^%^GREEN%^Maj%^BOLD%^o%^RESET%^%^GREEN%^r Ca%^BOLD%^p%^RESET%^%^GREEN%^e of %^BOLD%^D%^RESET%^%^GREEN%^isp%^BOLD%^l%^RESET%^%^GREEN%^ace%^BOLD%^m%^RESET%^%^GREEN%^ent%^RESET%^");
    ...
    case "red":
        TO->set_short("%^RESET%^%^RED%^Maj%^BOLD%^o%^RESET%^%^RED%^r Ca%^BOLD%^p%^RESET%^%^RED%^e of %^BOLD%^D%^RESET%^%^RED%^isp%^BOLD%^l%^RESET%^%^RED%^ace%^BOLD%^m%^RESET%^%^RED%^ent%^RESET%^");
    ...
    case "azure":
        TO->set_short("%^RESET%^%^CYAN%^Maj%^BOLD%^o%^RESET%^%^CYAN%^r Ca%^BOLD%^p%^RESET%^%^CYAN%^e of %^BOLD%^D%^RESET%^%^CYAN%^isp%^BOLD%^l%^RESET%^%^CYAN%^ace%^BOLD%^m%^RESET%^%^CYAN%^ent%^RESET%^");
    ...
    case "violet":
        TO->set_short("%^RESET%^%^MAGENTA%^Maj%^BOLD%^o%^RESET%^%^MAGENTA%^r Ca%^BOLD%^p%^RESET%^%^MAGENTA%^e of %^BOLD%^D%^RESET%^%^MAGENTA%^isp%^BOLD%^l%^RESET%^%^MAGENTA%^ace%^BOLD%^m%^RESET%^%^MAGENTA%^ent%^RESET%^");
    ...
    case "white":
        TO->set_short("%^WHITE%^%^BOLD%^Maj%^RESET%^%^WHITE%^o%^BOLD%^r Ca%^RESET%^%^WHITE%^p%^BOLD%^e of %^RESET%^%^WHITE%^D%^BOLD%^isp%^RESET%^%^WHITE%^l%^BOLD%^ace%^RESET%^%^WHITE%^m%^BOLD%^ent%^RESET%^");
    ...
    case "black":
        TO->set_short("%^BLACK%^%^BOLD%^Maj%^RESET%^%^WHITE%^o%^BLACK%^%^BOLD%^r Ca%^RESET%^%^WHITE%^p%^BLACK%^%^BOLD%^e of %^RESET%^%^WHITE%^D%^BLACK%^%^BOLD%^isp%^RESET%^%^WHITE%^l%^BLACK%^%^BOLD%^ace%^RESET%^%^WHITE%^m%^BLACK%^%^BOLD%^ent%^RESET%^");
    ...
    case "gold":
        TO->set_short("%^RESET%^%^ORANGE%^Maj%^BOLD%^o%^RESET%^%^ORANGE%^r Ca%^BOLD%^p%^RESET%^%^ORANGE%^e of %^BOLD%^D%^RESET%^%^ORANGE%^isp%^BOLD%^l%^RESET%^%^ORANGE%^ace%^BOLD%^m%^RESET%^%^ORANGE%^ent%^RESET%^");
