...
void activate_lewt() { weapons1 = 2; weapons2 = 2; armor1 = 2; armor2 = 2; other1 = 2; other2 = 2; gold = 1; platinum = 1; }
...
"%^YELLOW%^gauntlet%^RESET%^, a %^YELLOW%^small hammer%^RESET%^, a %^YELLOW%^sickle%^RESET%^, an %^YELLOW%^elven curved blade%^RESET%^, a %^YELLOW%^pistol%^RESET%^. Off to the side "
...
"%^RESET%^, a %^YELLOW%^small hammer%^RESET%^, a %^YELLOW%^sickle%^RESET%^, and a %^YELLOW%^pistol%^RESET%^. You could try to %^YELLOW%^take%^RESET%^ "
...
"%^RESET%^, a %^YELLOW%^golden longsword%^RESET%^, a crystal %^YELLOW%^sabre%^RESET%^,  an ominous %^YELLOW%^black "
"bastard sword%^RESET%^, nd an equally ominous %^YELLOW%^black and silver falcata%^RESET%^. You could try to %^YELLOW%^take%^RESET%^ something... Off to the side is another pile, this time of "
...
string other_desc() {
   if(other1 && other2) return "Various other items are strewn about. One pile consists of a medium %^YELLOW%^shield%^RESET%^ and many pairs "
...
int take_fun(string str) {
   ...
   switch(str) {
   case "dagger": case "battleaxe": case "whip": case "gauntlet": case "small hammer": case "sickle": case "elven curved blade":case "pistol"://weapon1
       if(!weapons1) {
     ...
     case "sabre": case "black bastard sword": case "black and silver falcata": //weapon2
       if(!weapons2) {
         tell_object(TP,"You reach out for a weapon and are stung sharply by the crimson ward around it!");
         return 1;
       }
     ...
     case "fine robes": case "ring": case "bag": case "sash": case "rod": case "chemise"://other2
       if(!other2) {
         tell_object(TP,"You reach out for an item and are stung sharply by the crimson ward around it!");
         return 1;
       }
