...
"%^YELLOW%^gauntlet%^RESET%^, a %^YELLOW%^small hammer%^RESET%^ and a %^YELLOW%^sickle%^RESET%^. Off to the side "
...
"%^RESET%^, a %^YELLOW%^small hammer%^RESET%^ and a %^YELLOW%^sickle%^RESET%^. You could try to %^YELLOW%^take%^RESET%^ "
...
int take_fun(string str) {
   ...
   switch(str) {
     case "dagger": case "battleaxe": case "whip": case "gauntlet": case "small hammer": case "sickle"://weapon1
       if(!weapons1) {
     ...
     case "sabre": case "black longsword": case "black and silver scimitar": //weapon2
       ...
       switch(str) {
         ...
         case "black longsword":            ob = new(ITEM+"ragnarok")->move(TO);    break;
         case "black and silver scimitar":  ob = new(ITEM+"tasword")->move(TO);     break;
       }
       weapons2--;
     break;
