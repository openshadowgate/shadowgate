...
%^RED%^Your footing here is very unsure as you climb from jagged boulder to jagged boulder over chasms deep enough to cause you severe agony if you were to slip into one. The entire area is grey from the shale of crumbling formations. Some of the stone structures form arches and spindles far above you giving you the feeling of being inside a natural castle.%^RESET%^
");
  set_listen("default", "The wind whistles somewhere to the southwest.");
       set_exits(([
       "north" : "/d/islands/common/aramanth/room17",
       "south" : "/d/islands/common/aramanth/room19",
      "west" : "/d/islands/common/aramanth/room15",
      "east" : "/d/islands/common/aramanth/room22",
]));
       set_items(([
