...
%^RED%^You are splashed suddenly by seaspray as waves crash against a large stone barrier to your west. This is a small, lonely stretch of beach. Coarse sand at your feet is mixed with gravel-like fragments and large stones alike. %^BOLD%^%^BLUE%^The ocean meets the land to the west.
");
   set_listen("default", "Waves break against the rocky beach with a crash.");
       set_exits(([
   "north" : "/d/islands/common/aramanth/room16",
   "south" : "/d/islands/common/aramanth/room10",
       "east" : "/d/islands/common/aramanth/room18",
]));
       set_items(([
