...
void setStuff(){
   ...
   set_short("A small obsidian statue of "+article(name1)+" "+name1+"");
   set_long("This is a small statue of obsidian, carved in the likeness of a
particular "+name1+".");
}
