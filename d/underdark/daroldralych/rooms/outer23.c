...
"with another street.%^RESET%^\n");
   ...
   add_item(({"houses","buildings"}),"%^BLUE%^Upon the western side of the road rise the buildings of the upper-class.  "
...
"%^BLUE%^floating above the wall.  A solid gate of iron is set within the wall of the enclosure at this point, guarded by "
"what look like particularly well-trained soldiers.%^RESET%^");
...
"central space.%^RESET%^");
   add_item("gate",({"%^BLUE%^A ^solid gate of iron is set within the high stone walls of the western enclosure, guarded "
"by what look like particularly well-trained soldiers.  It is marked with the insignia and name of a drow house"
".%^RESET%^"," %^BOLD%^%^BLACK%^House Moraataan%^RESET%^","drow"}));
   set_exits(([
     "north":ROOMS"outer24",
     "south":ROOMS"outer22",
   ]));
