...
"%^BLUE%^This large street is one of the city's main roads, leading out from the centre square through what appears to be "
...
"%^MAGENTA%^fae%^BOLD%^r%^RESET%^%^MAGENTA%^ie fire%^BLUE%^ that sheds faint light around it.  A door opens west onto a "
"small gathering hall here.  To the north this street meets the city square, while distantly in the south you can see a "
"closed gate.%^RESET%^\n");
