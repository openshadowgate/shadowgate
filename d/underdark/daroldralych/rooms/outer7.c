...
//"The road continues north through what appears to be the middle-class section of the city, while immediately south of you "
//"it opens out into the marketplace.%^RESET%^\n");
"The road continues north through what appears to be the middle-class section of the city, while immediately south of you, "
"blockades have been set up to restrict any further passage.  There is definite activity beyond, but it's hard to tell "
...
"particularly elegant in its design, but far smaller and almost delicate in stature.  An equally elegant gate leads in "
"from the roadside to this house.%^RESET%^");
...
"central space.%^RESET%^");
   add_item("gate",({"%^BLUE%^An elegant gate offers entry into the house to the east.  It is lightly guarded, and is "
"marked with the insignia and name of a drow house.%^RESET%^"," %^BOLD%^%^BLACK%^House Kirrefyrm%^RESET%^","drow"}));
   set_exits(([
     "north":ROOMS"outer6",
//     "south":ROOMS"market2",
   ]));
