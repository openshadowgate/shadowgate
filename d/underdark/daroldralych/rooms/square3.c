...
"faint light around it.  Directly southwest of you is the centre of the square, where stands a particularly %^RED%^ex"
...
"is the imposing outline of the temple.%^RESET%^\n");
   ...
   add_item(({"statue","elaborate statue"}),"%^BLUE%^To the southwest, in the centre of the square, you can see the "
