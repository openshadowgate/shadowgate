...
"carved into the dull surface of the rock itself.  The road continues east and west through what might pass for the "
"city's slums.  Beside the road here is a separate, rather stumpy building, marked with the sign of an eating "
"establishment.%^RESET%^\n");
