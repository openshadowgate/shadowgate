...
"on the eastern side of the road are the walls of the cavern, dotted with the occasional mid- or lower-class drow house "
"carved into the dull surface of the rock itself.  The road continues southwest through what might pass for the city's "
"slums, where it meets another street, and circles away north along the cavern wall.%^RESET%^\n");

   add_item(({"houses","buildings"}),"%^BLUE%^Upon the western side of the road rise enclosed buildings, probably "
