...
"faint light around it.  Directly northeast of you is the centre of the square, where stands a particularly %^RED%^ex"
...
"looms the imposing outline of the temple.%^RESET%^\n");
   ...
   add_item(({"statue","elaborate statue"}),"%^BLUE%^To the northeast, in the centre of the square, you can see the "
...
"marks the city's centre.%^RESET%^");
   set_exits(([
     "east":ROOMS"square8",
     "north":ROOMS"square4",
     "northeast":ROOMS"square5",
     "southwest":ROOMS"southwest1",
   ]));
}
