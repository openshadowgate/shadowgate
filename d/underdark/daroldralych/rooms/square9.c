...
"faint light around it.  Directly northwest of you is the centre of the square, where stands a particularly %^RED%^ex"
...
"looms the imposing outline of the temple.%^RESET%^\n");
   ...
   add_item(({"statue","elaborate statue"}),"%^BLUE%^To the northwest, in the centre of the square, you can see the "
...
"marks the city's centre.%^RESET%^");
   set_exits(([
     "west":ROOMS"square8",
     "north":ROOMS"square6",
     "northwest":ROOMS"square5",
     "southeast":ROOMS"southeast1",
   ]));
}
