...
"carved into the dull surface of the rock itself.  The road continues south through what might pass for the city's slums, "
"while further north it intersects with another street.%^RESET%^\n");
...
"central space.%^RESET%^");
   set_exits(([
     "north":ROOMS"outer20",
     "south":ROOMS"outer18",
// assassin's guild entrance goes here.
   ]));
}
