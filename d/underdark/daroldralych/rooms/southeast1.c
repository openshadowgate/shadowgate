...
"%^BOLD%^r%^RESET%^%^MAGENTA%^ie fire%^BLUE%^ that sheds faint light around it.  A short distance to the northwest this "
...
"town.");
   set_exits(([
     "northwest":ROOMS"square9",
     "southeast":ROOMS"southeast2",
   ]));
}
