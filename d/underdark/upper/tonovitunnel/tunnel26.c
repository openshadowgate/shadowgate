...
"moving %^BOLD%^%^BLACK%^shadows%^RESET%^%^ORANGE%^. To the north you can "
"make out a tracery of %^RESET%^cobwebs %^ORANGE%^coating what looks like "
"a stone-cut passageway, while to the northeast the tunnel narrows and "
"seems to come to a dead end.%^RESET%^\n");
    ...
    set_items(([
      ({"cobweb","cobwebs"}) : "%^RESET%^Ahead there seems to be an "
"exorbitant amount of cobwebs across the hallway.  While you think you "
"could continue that way, you do pause and wonder whether it would be "
"wise to do so.  Whatever made that webbing must either be plentiful or "
"very large.%^RESET%^",
...
"to traverse.  It does look like you could continue that way though, if "
"you were careful.%^RESET%",
...
"their unearthly light casting %^BOLD%^%^BLACK%^shadows%^RESET%^%^ORANGE%^"
" into the passage way.%^RESET%^",
...
"from the globes of glass.%^RESET%^",
    ...
    set_exits(([
      "south" : TUNNEL"tunnel25",
      "north" : "/d/underdark/upper/tunnel27",
      "northeast" : TUNNEL"tonovi01",
    ]));
}
