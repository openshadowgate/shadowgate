...
"that grows in the crevices provide just enough light to see by.  Here "
"the tunnel runs into a large natural cave that continues on toward the "
"northwest, while to the west the rush of an underground %^RESET%^%^BLUE%^"
"river %^BOLD%^%^BLACK%^can be seen and heard.%^RESET%^\n");
...
"river but you can hear it nearby.%^RESET%^",
      ({"cave","cavern"}) : "%^BOLD%^%^BLACK%^To the north you can see "
"that the tunnel opens into a large natural cavern.  From here you can "
"just make out the jutting shapes of rock formations and the occasional "
"sparkle of some natural mineral that catches in the light of the "
"sputtering oil lanterns.%^RESET%^",
...
"floor seems to have received any manner of smoothing.%^RESET%^",
      ({"marks","chisel","pick"}) : "%^BOLD%^%^BLACK%^Biting into the "
...
"sputtering oil lamps in illuminating this tunnel system.",
    ...
    set_exits(([
      "east" : TUNNEL"tunnel15",
      "west" : TUNNEL"river01",
      "northwest" : TUNNEL"cavern01",
    ]));
}
