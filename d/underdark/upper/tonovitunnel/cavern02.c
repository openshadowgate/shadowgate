...
"faint light.%^RESET%^\n");
    ...
    set_items(([
     ({"cavern","cave"}) : "%^BOLD%^%^BLACK%^Naturally formed by time and "
"the forces of nature, this vast cavern stretches away into the darkness, "
"well beyond any form of light you've brought with you.  Thick spires of "
"stalactites and stalagmites rise from the floor and ceiling filling all "
"that you can see with their massive forms.%^RESET%^",
...
"some of the tunnel system leading into this cavern.%^RESET%^",
    ...
    set_exits(([
      "south" : TUNNEL"cavern01",
      "north" : TUNNEL"cavern03",
    ]));
    issearched = 0;
}
