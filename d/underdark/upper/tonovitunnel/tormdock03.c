...
"%^BOLD%^%^BLUE%^. Here, away from the dock, you can see %^RESET%^"
"%^ORANGE%^crates %^BOLD%^%^BLUE%^and %^RESET%^%^ORANGE%^barrels "
...
"but based on their height you doubt it's for keeping "
"animals.%^RESET%^\n");
...
"confines.%^RESET%^",
    ...
    set_exits(([
      "northeast" : TUNNEL"tunnel01",
      "south" : TUNNEL"tormdock02",
    ]));
}
