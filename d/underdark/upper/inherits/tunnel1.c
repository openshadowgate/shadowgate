...
"along with the phosphorescent %^RESET%^%^CYAN%^lichen "
"%^BOLD%^%^BLACK%^that grows in the crevices provide just enough light to "
"see by.%^RESET%^\n");
    set_smell("default","The air is chill and damp, smelling of earth and stone.");
    set_listen("default","The drip of water can be heard somewhere off in the distance.");

    set_items(([
      ({"walls","floor","wall","ceiling"}) : "%^BOLD%^%^BLACK%^The walls, "
"floors and ceilings are made from the hard stone of the "
"%^RESET%^%^CYAN%^Barrier Mountains%^BOLD%^%^BLACK%^.  Chisel and pick "
"marks mar the surfaces, leaving lots of niches for lichen to grow "
"within.  Only the floor seems to have received any manner of "
"smoothing.%^RESET%^",
