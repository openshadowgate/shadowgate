...
#define OKSCROLLS ({ "iron body","transformation","greater invisibility","protection from spells","magic mirror","greater dispel magic","monster summoning ix", "hellball", "fiery body" })
