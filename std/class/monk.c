...
string *restricted_classes() { return ({ "bard", "barbarian", "paladin" }); }

int *restricted_alignments() { return ({4,5,6,7,8,9}); }
...
string old_save_type() { return "monk"; }

string new_save_type() { return "monk"; }
...
string armor_allowed() { return "barbarian"; }
...
varargs int monk_check(object player, string type, mixed extra)
{
    ...
    case "heal":
        ...
        if(!sizeof(player->query_attackers())) { return 1; }
    ...
    case "way of the fist":
        ...
        if(player->query("monk way") == "way of the fist" || FEATS_D->usable_feat(player,"grandmaster of the way")) { return 1; }
        return 0;
        
    case "way of the shadow":
    
        if(player->query("monk way") == "way of the shadow" || FEATS_D->usable_feat(player,"grandmaster of the way")) { return 1; }
        return 0;
    
    
    case "way of the elements":

        if(player->query("monk way") == "way of the elements" || FEATS_D->usable_feat(player,"grandmaster of the way")) { return 1; }
        return 0;
    }
