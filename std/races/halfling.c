...
string *restricted_classes(string subrace) {
    if(!subrace || subrace == "") return ({ "mage", "ranger", "psion", "psywarrior",  "paladin", "monk", "warlock", "druid","inquisitor" });
    switch(subrace) {
    case "ghostwise halfling": return ({ "mage", "bard",  "paladin", "sorcerer", "monk", "warlock", "inquisitor" }); break;
      case "strongheart halfling": return ({ "mage", "ranger", "psion", "psywarrior", "sorcerer", "monk", "warlock", "druid" }); break;
    default: return ({ "mage", "ranger", "psion", "psywarrior",  "paladin", "monk", "warlock", "druid", "inquisitor" }); break;
    }
}
