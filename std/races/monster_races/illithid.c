...
string race_name() { return "illithid"; }
...
string *wielding_limbs() { return ({ "right hand", "left hand", "primary right tentacle", "primary left tentacle", "secondary right tentacle", "secondary left tentacle" }); }
...
{
    return ({  
                "primary right tentacle",
                "secondary right tentacle",
                "primary left tentacle",
                "secondary left tentacle",
                "head",
                "right arm",
                "right hand",
                "left arm",
