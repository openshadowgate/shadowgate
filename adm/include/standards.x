...
#define WEAPONS ([\
    ...
    "awl pike":(["wc#":1,"wcdice":6,"lwc#":1,"lwcdice":12, "size":({2,3,4}),]),\
    "bardiche":(["wc#":2,"wcdice":4,"lwc#":2,"lwcdice":6, "size":({2,3,4}),]),\
    "bec de corbin":(["wc#":1,"wcdice":8,"lwc#":1,"lwcdice":6, "size":({2,3,4}),]),\
    "bill-guisarme":(["wc#":2,"wcdice":4,"lwc#":1,"lwcdice":10, "size":({2,3,4}),]),\
    "fauchard":(["wc#":1,"wcdice":6,"lwc#":1,"lwcdice":8, "size":({2,3,4}),]),\
    "fauchard-fork":(["wc#":1,"wcdice":8,"lwc#":1,"lwcdice":10, "size":({2,3,4}),]),\
    "glaive":(["wc#":1,"wcdice":6,"lwc#":1,"lwcdice":10, "size":({2,3,4}),]),\
    "glaive-guisarme":(["wc#":2,"wcdice":4,"lwc#":2,"lwcdice":6, "size":({2,3,4}),]),\
    "halberd":(["wc#":1,"wcdice":10,"lwc#":2,"lwcdice":6, "size":({2,3,4}),]),\
    "hook fauchard":(["wc#":1,"wcdice":4,"lwc#":1,"lwcdice":4, "size":({2,3,4}),]),\
    "lucern hammer":(["wc#":2,"wcdice":4,"lwc#":1,"lwcdice":6, "size":({2,3,4}),]),\
    "military fork":(["wc#":1,"wcdice":8,"lwc#":2,"lwcdice":4, "size":({2,3,4}),]),\
    "partisan":(["wc#":1,"wcdice":6,"lwc#":1,"lwcdice":7, "size":({2,3,4}),]),\
    "ranseur":(["wc#":2,"wcdice":4,"lwc#":2,"lwcdice":4, "size":({2,3,4}),]),\
    "spetum":(["wc#":1,"wcdice":7,"lwc#":2,"lwcdice":6, "size":({2,3,4}),]),\
    ...
    "two-handed sword":(["wc#":1,"wcdice":10,"lwc#":3,"lwcdice":6, "size":({3,4}),]),\
...
///    "voulge":(["wc#":2,"wcdice":4,"lwc#":2,"lwcdice":4, "size":({2,3,4}),]),\
...
#define WEAPON_BASICS ([\
    ...
    "awl pike":(["price":7,"weight":12, "type":"piercing","prof":"polearm",]),\
    "bardiche":(["price":8,"weight":10, "type":"slashing","prof":"axe",]),\
    "bec de corbin":(["price":7,"weight":10, "type":"slashing","prof":"polearm",]),\
    "bill-guisarme":(["price":6,"weight":15, "type":"slashing","prof":"polearm",]),\
    "fauchard":(["price":6,"weight":7, "type":"slashing","prof":"polearm",]),\
    "fauchard-fork":(["price":7,"weight":12, "type":"piercing","prof":"polearm",]),\
    "glaive":(["price":8,"weight":12, "type":"slashing","prof":"polearm",]),\
    "glaive-guisarme":(["price":6,"weight":10, "type":"slashing","prof":"polearm",]),\
    "halberd":(["price":7,"weight":10, "type":"slashing","prof":"polearm",]),\
    "hook fauchard":(["price":7,"weight":10, "type":"slashing","prof":"polearm",]),\
    "lucern hammer":(["price":5,"weight":10, "type":"bludgeon","prof":"hammer",]),\
    "military fork":(["price":4,"weight":7, "type":"piercing","prof":"polearm",]),\
    "partisan":(["price":5,"weight":10, "type":"piercing","prof":"polearm",]),\
    "ranseur":(["price":5,"weight":12, "type":"piercing","prof":"polearm",]),\
    "spetum":(["price":5,"weight":10, "type":"piercing","prof":"polearm",]),\
...
///     "voulge":(["price":4,"weight":12, "type":"slashing","prof":"polearm",]),\
...
#define WEAPON_MATERIALS ([\
  ...
  "awl pike":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "bardiche":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "bec de corbin":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "bill-guisarme":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "fauchard":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "fauchard-fork":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "glaive":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "glaive-guisarme":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "halberd":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "hook fauchard":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "lucern hammer":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "military fork":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "partisan":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "rapier" : (["materials":({"metal"}), "units":({2}),]),\
  "ranseur":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "spetum":(["materials":({"wood","metal"}), "units":({3,1}),]),\
  "voulge":(["materials":({"wood","metal"}), "units":({3,1}),]),\
