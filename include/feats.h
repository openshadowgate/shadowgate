...
#define SPELLFEATS ({"MagicDamage","MagicAccuracy","MagicProtection","ArcaneSpellcraft","DivineSpellcraft","WildernessLore","Psionics","Inquisition","MagicResistance","MagusArcana"})
#define GENERALFEATS ({"MagicResistance","DamageResistance","NonCombat","Performance","Presence", "Racial"})
#define PRESTIGE_FEATS ({"ArcaneArcher","ArcaneTrickster","Archdruid","Archmage","Archpsion","Assassin","Bladeweaver","Chronicler", "CryptStalker", "EldritchKnight", "PrestigeDuelist", "GrandmasterOfTheWay", "HellfireWarlock", "Hierophant", "ImmortalDefender", "Metamind", "Mindblade", "PaleLord", "PrimevalChampion","RadiantServant", "RageProphet", "ShadowAdept", "Shadowdancer", "TomeBoundMaster", "VersatileArcanist", "Warmaster", "Warmind","Gravecaller", "Cypher"})
#define PRESTIGE_MAP (["RadiantServant" : "radiant_servant", "Archmage" : "archmage", "Chronicler" : "chronicler", "CryptStalker" : "crypt_stalker", "PrestigeDuelist" : "duelist", "ShadowAdept" : "shadow_adept", "Shadowdancer" : "shadowdancer", "VersatileArcanist" : "versatile_arcanist", "Archdruid" : "archdruid", "PrimevalChampion" : "primeval_champion", "Metamind" : "metamind", "Warmind" : "warmind", "Archpsion" : "archpsion", "ImmortalDefender" : "immortal_defender", "GrandmasterOfTheWay" : "grandmaster_of_the_way", "HellfireWarlock" : "hellfire_warlock", "Bladeweaver" : "bladeweaver", "Warmaster" : "warmaster", "Mindblade" : "mindblade", "Hierophant" : "hierophant", "EldritchKnight" : "eldritch_knight", "ArcaneArcher": "arcane_archer", "RageProphet" : "rage_prophet", "ArcaneTrickster" : "arcane_trickster", "Gravecaller":"gravecaller", "Assassin":"assassin", "Cypher":"cypher", "TomeBoundMaster" : "tome_bound_master", ])
