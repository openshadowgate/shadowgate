...
#define FEAT_TYPES ({ "racial", "martial", "spellcraft", "hybrid", "arcana", "rage", "divinebond", })

#define FEAT_CLASSES ({ "class","racial","martial","magic","other","hybrid","arcana", "rage", "divinebond" })
