...
"chaos" : ({ "protection from alignment", "align weapon", "garble", "chaos hammer", "dispel law", "animate object", "word of chaos", "cloak of chaos", "prismatic sphere" }),
...
"sun" : ({ "faerie fire", "detect invisibility", "searing light", "nimbus of light", "flame strike", "fire seeds", "sunbeam", "sunburst", "prismatic sphere" }),
